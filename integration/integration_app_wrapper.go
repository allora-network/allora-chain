...
func NewIntegrationApp(
	...
	moduleBeginBlockOrder []string,
	moduleEndBlockOrder []string,
) *App {
	db := dbm.NewMemDB()
...
func (app *App) RunMsg(msg sdk.Msg, option ...cosmosintegration.Option) (*codectypes.Any, error) {
	// set options
	cfg := &cosmosintegration.Config{}
