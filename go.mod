...
replace (
	...
	github.com/upshot-tech/protocol-state-machine-module => ./x/emissions
...
require (
	...
	github.com/upshot-tech/protocol-state-machine-module v0.0.0-20240124190429-5bf0f96148a3
)
