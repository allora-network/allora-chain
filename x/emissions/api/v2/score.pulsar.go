...
func init() {
	...
	md_Score = File_emissions_v2_score_proto.Messages().ByName("Score")
...
func (x *Score) slowProtoReflect() protoreflect.Message {
	mi := &file_emissions_v2_score_proto_msgTypes[0]
...
func (x *fastReflection_Score) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "emissions.v2.Score.topic_id":
		return x.TopicId != uint64(0)
	case "emissions.v2.Score.block_height":
		return x.BlockHeight != int64(0)
	case "emissions.v2.Score.address":
		return x.Address != ""
	case "emissions.v2.Score.score":
		return x.Score != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: emissions.v2.Score"))
		}
		panic(fmt.Errorf("message emissions.v2.Score does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Score) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message emissions.v2.Score does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Score) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "emissions.v2.Score.topic_id":
		panic(fmt.Errorf("field topic_id of message emissions.v2.Score is not mutable"))
	case "emissions.v2.Score.block_height":
		panic(fmt.Errorf("field block_height of message emissions.v2.Score is not mutable"))
	case "emissions.v2.Score.address":
		panic(fmt.Errorf("field address of message emissions.v2.Score is not mutable"))
	case "emissions.v2.Score.score":
		panic(fmt.Errorf("field score of message emissions.v2.Score is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: emissions.v2.Score"))
		}
...
func (x *fastReflection_Score) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in emissions.v2.Score", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_emissions_v2_score_proto_init()
	md_Scores = File_emissions_v2_score_proto.Messages().ByName("Scores")
...
func (x *Scores) slowProtoReflect() protoreflect.Message {
	mi := &file_emissions_v2_score_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_Scores) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "emissions.v2.Scores.scores":
		return len(x.Scores) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: emissions.v2.Scores"))
		}
		panic(fmt.Errorf("message emissions.v2.Scores does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Scores) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message emissions.v2.Scores does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Scores) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in emissions.v2.Scores", d.FullName()))
	}
	panic("unreachable")
}
...
func (*Score) Descriptor() ([]byte, []int) {
	return file_emissions_v2_score_proto_rawDescGZIP(), []int{0}
}
...
func (*Scores) Descriptor() ([]byte, []int) {
	return file_emissions_v2_score_proto_rawDescGZIP(), []int{1}
}
...
var File_emissions_v2_score_proto protoreflect.FileDescriptor

var file_emissions_v2_score_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x73, 0x2e, 0x76, 0x32, 0x2e, 0x53, 0x63, 0x6f, 0x72, 0x65, 0x52, 0x06, 0x73, 0x63,
	0x6f, 0x72, 0x65, 0x73, 0x42, 0xc0, 0x01, 0x0a, 0x10, 0x63, 0x6f, 0x6d, 0x2e, 0x65, 0x6d, 0x69,
	0x73, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x76, 0x32, 0x42, 0x0a, 0x53, 0x63, 0x6f, 0x72, 0x65,
...
var (
	file_emissions_v2_score_proto_rawDescOnce sync.Once
	file_emissions_v2_score_proto_rawDescData = file_emissions_v2_score_proto_rawDesc
)

func file_emissions_v2_score_proto_rawDescGZIP() []byte {
	file_emissions_v2_score_proto_rawDescOnce.Do(func() {
		file_emissions_v2_score_proto_rawDescData = protoimpl.X.CompressGZIP(file_emissions_v2_score_proto_rawDescData)
	})
	return file_emissions_v2_score_proto_rawDescData
}

var file_emissions_v2_score_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_emissions_v2_score_proto_goTypes = []interface{}{
	(*Score)(nil),  // 0: emissions.v2.Score
	(*Scores)(nil), // 1: emissions.v2.Scores
}
var file_emissions_v2_score_proto_depIdxs = []int32{
	0, // 0: emissions.v2.Scores.scores:type_name -> emissions.v2.Score
...
func init() { file_emissions_v2_score_proto_init() }
func file_emissions_v2_score_proto_init() {
	if File_emissions_v2_score_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_emissions_v2_score_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Score); i {
			case 0:
				return &v.state
			case 1:
		...
		file_emissions_v2_score_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Scores); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_emissions_v2_score_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		...
		DependencyIndexes: file_emissions_v2_score_proto_depIdxs,
		MessageInfos:      file_emissions_v2_score_proto_msgTypes,
	}.Build()
	File_emissions_v2_score_proto = out.File
	file_emissions_v2_score_proto_rawDesc = nil
	file_emissions_v2_score_proto_goTypes = nil
	file_emissions_v2_score_proto_depIdxs = nil
}
