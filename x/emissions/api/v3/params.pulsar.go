...
func (x *fastReflection_Params) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "emissions.v3.Params.max_topics_per_block":
	...
	case "emissions.v3.Params.max_retries_to_fulfil_nonces_worker":
		return x.MaxRetriesToFulfilNoncesWorker != int64(0)
	case "emissions.v3.Params.max_retries_to_fulfil_nonces_reputer":
	...
	case "emissions.v3.Params.min_effective_topic_revenue":
...
func (x *fastReflection_Params) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "emissions.v3.Params.max_topics_per_block":
		panic(fmt.Errorf("field max_topics_per_block of message emissions.v3.Params is not mutable"))
	case "emissions.v3.Params.required_minimum_stake":
	...
	case "emissions.v3.Params.max_retries_to_fulfil_nonces_worker":
		panic(fmt.Errorf("field max_retries_to_fulfil_nonces_worker of message emissions.v3.Params is not mutable"))
	case "emissions.v3.Params.max_retries_to_fulfil_nonces_reputer":
		panic(fmt.Errorf("field max_retries_to_fulfil_nonces_reputer of message emissions.v3.Params is not mutable"))
	case "emissions.v3.Params.registration_fee":
	...
	case "emissions.v3.Params.topic_fee_revenue_decay_rate":
		panic(fmt.Errorf("field topic_fee_revenue_decay_rate of message emissions.v3.Params is not mutable"))
	case "emissions.v3.Params.epsilon_reputer":
		panic(fmt.Errorf("field epsilon_reputer of message emissions.v3.Params is not mutable"))
	case "emissions.v3.Params.min_effective_topic_revenue":
		panic(fmt.Errorf("field min_effective_topic_revenue of message emissions.v3.Params is not mutable"))
	case "emissions.v3.Params.half_max_process_stake_removals_end_block":
...
var file_emissions_v3_params_proto_rawDesc = []byte{
	...
	0x73, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x76, 0x33, 0x1a, 0x19, 0x63, 0x6f, 0x73, 0x6d, 0x6f,
	...
	0x6e, 0x73, 0x2e, 0x76, 0x33, 0x42, 0x0b, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x50, 0x72, 0x6f,
