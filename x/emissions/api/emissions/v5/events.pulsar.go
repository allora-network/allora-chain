...
var _ protoreflect.List = (*_EventScoresSet_6_list)(nil)

type _EventScoresSet_6_list struct {
	list *[]string
}

func (x *_EventScoresSet_6_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_EventScoresSet_6_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfString((*x.list)[i])
}

func (x *_EventScoresSet_6_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.String()
	concreteValue := valueUnwrapped
	(*x.list)[i] = concreteValue
}

func (x *_EventScoresSet_6_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.String()
	concreteValue := valueUnwrapped
	*x.list = append(*x.list, concreteValue)
}

func (x *_EventScoresSet_6_list) AppendMutable() protoreflect.Value {
	panic(fmt.Errorf("AppendMutable can not be called on message EventScoresSet at list field ListeningCoefficients as it is not of Message kind"))
}

func (x *_EventScoresSet_6_list) Truncate(n int) {
	*x.list = (*x.list)[:n]
}

func (x *_EventScoresSet_6_list) NewElement() protoreflect.Value {
	v := ""
	return protoreflect.ValueOfString(v)
}

func (x *_EventScoresSet_6_list) IsValid() bool {
	return x.list != nil
}
...
var (
	...
	fd_EventScoresSet_listening_coefficients protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_EventScoresSet_listening_coefficients = md_EventScoresSet.Fields().ByName("listening_coefficients")
}
...
func (x *fastReflection_EventScoresSet) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if len(x.ListeningCoefficients) != 0 {
		value := protoreflect.ValueOfList(&_EventScoresSet_6_list{list: &x.ListeningCoefficients})
		if !f(fd_EventScoresSet_listening_coefficients, value) {
			return
		}
	}
}
...
func (x *fastReflection_EventScoresSet) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "emissions.v5.EventScoresSet.listening_coefficients":
		return len(x.ListeningCoefficients) != 0
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_EventScoresSet) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "emissions.v5.EventScoresSet.listening_coefficients":
		if len(x.ListeningCoefficients) == 0 {
			return protoreflect.ValueOfList(&_EventScoresSet_6_list{})
		}
		listValue := &_EventScoresSet_6_list{list: &x.ListeningCoefficients}
		return protoreflect.ValueOfList(listValue)
	default:
...
func (x *fastReflection_EventScoresSet) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "emissions.v5.EventScoresSet.listening_coefficients":
		lv := value.List()
		clv := lv.(*_EventScoresSet_6_list)
		x.ListeningCoefficients = *clv.list
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: emissions.v5.EventScoresSet"))
		}
...
func (x *fastReflection_EventScoresSet) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "emissions.v5.EventScoresSet.scores":
		...
		return protoreflect.ValueOfList(value)
	case "emissions.v5.EventScoresSet.listening_coefficients":
		if x.ListeningCoefficients == nil {
			x.ListeningCoefficients = []string{}
		}
		value := &_EventScoresSet_6_list{list: &x.ListeningCoefficients}
		return protoreflect.ValueOfList(value)
	case "emissions.v5.EventScoresSet.actor_type":
...
func (x *fastReflection_EventScoresSet) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "emissions.v5.EventScoresSet.listening_coefficients":
		list := []string{}
		return protoreflect.ValueOfList(&_EventScoresSet_6_list{list: &list})
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: emissions.v5.EventScoresSet"))
		}
...
func (x *fastReflection_EventScoresSet) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		if len(x.ListeningCoefficients) > 0 {
			for _, s := range x.ListeningCoefficients {
				l = len(s)
				n += 1 + l + runtime.Sov(uint64(l))
			}
		}
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.ListeningCoefficients) > 0 {
			for iNdEx := len(x.ListeningCoefficients) - 1; iNdEx >= 0; iNdEx-- {
				i -= len(x.ListeningCoefficients[iNdEx])
				copy(dAtA[i:], x.ListeningCoefficients[iNdEx])
				i = runtime.EncodeVarint(dAtA, i, uint64(len(x.ListeningCoefficients[iNdEx])))
				i--
				dAtA[i] = 0x32
			}
		}
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 6:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field ListeningCoefficients", wireType)
				}
				var stringLen uint64
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.ListeningCoefficients = append(x.ListeningCoefficients, string(dAtA[iNdEx:postIndex]))
				iNdEx = postIndex
			default:
				iNdEx = preIndex
...
type EventScoresSet struct {
	...
	ListeningCoefficients []string  `protobuf:"bytes,6,rep,name=listening_coefficients,json=listeningCoefficients,proto3" json:"listening_coefficients,omitempty"`
}
...
func (x *EventScoresSet) GetListeningCoefficients() []string {
	if x != nil {
		return x.ListeningCoefficients
	}
	return nil
}
...
var file_emissions_v5_events_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xe5, 0x02, 0x0a, 0x0e, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x53,
	...
	0x68, 0x2e, 0x44, 0x65, 0x63, 0x52, 0x06, 0x73, 0x63, 0x6f, 0x72, 0x65, 0x73, 0x12, 0x6e, 0x0a,
	0x16, 0x6c, 0x69, 0x73, 0x74, 0x65, 0x6e, 0x69, 0x6e, 0x67, 0x5f, 0x63, 0x6f, 0x65, 0x66, 0x66,
	0x69, 0x63, 0x69, 0x65, 0x6e, 0x74, 0x73, 0x18, 0x06, 0x20, 0x03, 0x28, 0x09, 0x42, 0x37, 0xc8,
	...
	0x74, 0x68, 0x2e, 0x44, 0x65, 0x63, 0x52, 0x15, 0x6c, 0x69, 0x73, 0x74, 0x65, 0x6e, 0x69, 0x6e,
	0x67, 0x43, 0x6f, 0x65, 0x66, 0x66, 0x69, 0x63, 0x69, 0x65, 0x6e, 0x74, 0x73, 0x22, 0xfc, 0x01,
	...
	0x76, 0x35, 0x42, 0x0b, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x73, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50,
	...
	0x6f, 0x6e, 0x73, 0x2f, 0x76, 0x35, 0x3b, 0x65, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x73,
	0x76, 0x35, 0xa2, 0x02, 0x03, 0x45, 0x58, 0x58, 0xaa, 0x02, 0x0c, 0x45, 0x6d, 0x69, 0x73, 0x73,
	0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x56, 0x35, 0xca, 0x02, 0x0c, 0x45, 0x6d, 0x69, 0x73, 0x73, 0x69,
	0x6f, 0x6e, 0x73, 0x5c, 0x56, 0x35, 0xe2, 0x02, 0x18, 0x45, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f,
	0x6e, 0x73, 0x5c, 0x56, 0x35, 0x5c, 0x47, 0x50, 0x42, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74,
...
var file_emissions_v5_events_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
...
var file_emissions_v5_events_proto_depIdxs = []int32{
	...
	9,  // 2: emissions.v5.EventNetworkLossSet.value_bundle:type_name -> emissions.v3.ValueBundle
	10, // 3: emissions.v5.EventWorkerLastCommitSet.nonce:type_name -> emissions.v3.Nonce
	10, // 4: emissions.v5.EventReputerLastCommitSet.nonce:type_name -> emissions.v3.Nonce
