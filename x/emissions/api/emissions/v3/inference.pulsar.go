...
func init() {
	...
	md_Inference = File_emissions_v3_inference_proto.Messages().ByName("Inference")
...
func init() {
	file_emissions_v3_inference_proto_init()
	md_Inferences = File_emissions_v3_inference_proto.Messages().ByName("Inferences")
...
func (x *Inferences) slowProtoReflect() protoreflect.Message {
	mi := &file_emissions_v3_inference_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (*Inferences) Descriptor() ([]byte, []int) {
	return file_emissions_v3_inference_proto_rawDescGZIP(), []int{1}
}
...
var file_emissions_v3_inference_proto_rawDesc = []byte{
	...
	0x65, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x76, 0x33, 0x1a, 0x18, 0x65, 0x6d,
	...
	0x67, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xed, 0x01, 0x0a, 0x09, 0x49, 0x6e, 0x66,
	...
	0x6e, 0x63, 0x65, 0x52, 0x0a, 0x69, 0x6e, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x73, 0x42,
	0xc4, 0x01, 0x0a, 0x10, 0x63, 0x6f, 0x6d, 0x2e, 0x65, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e,
	0x73, 0x2e, 0x76, 0x33, 0x42, 0x0e, 0x49, 0x6e, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x50,
...
var file_emissions_v3_inference_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_emissions_v3_inference_proto_goTypes = []interface{}{
	(*Inference)(nil),  // 0: emissions.v3.Inference
	(*Inferences)(nil), // 1: emissions.v3.Inferences
}
var file_emissions_v3_inference_proto_depIdxs = []int32{
	0, // 0: emissions.v3.Inferences.inferences:type_name -> emissions.v3.Inference
...
func file_emissions_v3_inference_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_emissions_v3_inference_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
