...
func init() {
	...
	md_OffchainNode = File_emissions_v3_node_proto.Messages().ByName("OffchainNode")
...
func (x *OffchainNode) slowProtoReflect() protoreflect.Message {
	mi := &file_emissions_v3_node_proto_msgTypes[0]
...
func (x *fastReflection_OffchainNode) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "emissions.v3.OffchainNode.owner":
		return x.Owner != ""
	case "emissions.v3.OffchainNode.node_address":
		return x.NodeAddress != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: emissions.v3.OffchainNode"))
		}
		panic(fmt.Errorf("message emissions.v3.OffchainNode does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_OffchainNode) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message emissions.v3.OffchainNode does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_OffchainNode) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "emissions.v3.OffchainNode.owner":
		panic(fmt.Errorf("field owner of message emissions.v3.OffchainNode is not mutable"))
	case "emissions.v3.OffchainNode.node_address":
		panic(fmt.Errorf("field node_address of message emissions.v3.OffchainNode is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: emissions.v3.OffchainNode"))
		}
...
func (x *fastReflection_OffchainNode) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in emissions.v3.OffchainNode", d.FullName()))
	}
	panic("unreachable")
}
...
func (*OffchainNode) Descriptor() ([]byte, []int) {
	return file_emissions_v3_node_proto_rawDescGZIP(), []int{0}
}
...
var file_emissions_v3_node_proto_rawDesc = []byte{
	0x0a, 0x17, 0x65, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x2f, 0x76, 0x33, 0x2f, 0x6e,
	0x6f, 0x64, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0c, 0x65, 0x6d, 0x69, 0x73, 0x73,
	0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x76, 0x33, 0x22, 0x7e, 0x0a, 0x0c, 0x4f, 0x66, 0x66, 0x63, 0x68,
	...
	0x65, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x76, 0x33, 0x42, 0x09, 0x4e, 0x6f,
...
var (
	file_emissions_v3_node_proto_rawDescOnce sync.Once
	file_emissions_v3_node_proto_rawDescData = file_emissions_v3_node_proto_rawDesc
)

func file_emissions_v3_node_proto_rawDescGZIP() []byte {
	file_emissions_v3_node_proto_rawDescOnce.Do(func() {
		file_emissions_v3_node_proto_rawDescData = protoimpl.X.CompressGZIP(file_emissions_v3_node_proto_rawDescData)
	})
	return file_emissions_v3_node_proto_rawDescData
}

var file_emissions_v3_node_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_emissions_v3_node_proto_goTypes = []interface{}{
	(*OffchainNode)(nil), // 0: emissions.v3.OffchainNode
}
var file_emissions_v3_node_proto_depIdxs = []int32{
...
func init() { file_emissions_v3_node_proto_init() }
func file_emissions_v3_node_proto_init() {
	if File_emissions_v3_node_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_emissions_v3_node_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_emissions_v3_node_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_emissions_v3_node_proto_goTypes,
		DependencyIndexes: file_emissions_v3_node_proto_depIdxs,
		MessageInfos:      file_emissions_v3_node_proto_msgTypes,
	}.Build()
	File_emissions_v3_node_proto = out.File
	file_emissions_v3_node_proto_rawDesc = nil
	file_emissions_v3_node_proto_goTypes = nil
	file_emissions_v3_node_proto_depIdxs = nil
}
