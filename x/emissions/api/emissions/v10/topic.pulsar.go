...
type Topic struct {
	...
	// Topic-level limit for labels accepted in a single MULTI submission.
	// Must be <= module params max_labels_per_submission cap.
	...
	// Optional fixed label set for this topic.
