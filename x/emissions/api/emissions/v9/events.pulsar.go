...
var file_emissions_v9_events_proto_rawDesc = []byte{
	...
	0x6f, 0x70, 0x69, 0x63, 0x49, 0x64, 0x2a, 0x62, 0x0a, 0x09, 0x41, 0x63, 0x74, 0x6f, 0x72, 0x54,
...
var file_emissions_v9_events_proto_msgTypes = make([]protoimpl.MessageInfo, 21)
var file_emissions_v9_events_proto_goTypes = []interface{}{
	...
	(*EventPruneRecords)(nil),                                // 21: emissions.v9.EventPruneRecords
	(*v3.ValueBundle)(nil),                                   // 22: emissions.v3.ValueBundle
	(*v3.Nonce)(nil),                                         // 23: emissions.v3.Nonce
}
var file_emissions_v9_events_proto_depIdxs = []int32{
	...
	22, // 2: emissions.v9.EventNetworkLossSet.value_bundle:type_name -> emissions.v3.ValueBundle
	22, // 3: emissions.v9.EventNetworkInferences.value_bundle:type_name -> emissions.v3.ValueBundle
	22, // 4: emissions.v9.EventOutlierResistantNetworkInferences.value_bundle:type_name -> emissions.v3.ValueBundle
	23, // 5: emissions.v9.EventWorkerLastCommitSet.nonce:type_name -> emissions.v3.Nonce
	23, // 6: emissions.v9.EventReputerLastCommitSet.nonce:type_name -> emissions.v3.Nonce
