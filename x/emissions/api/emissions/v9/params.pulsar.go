...
var (
	...
	fd_Params_max_canonical_label_byte_length           protoreflect.FieldDescriptor
	fd_Params_max_topic_label_whitelist_size            protoreflect.FieldDescriptor
	fd_Params_max_epoch_label_registry_size             protoreflect.FieldDescriptor
	fd_Params_min_top_inferers_to_reward                protoreflect.FieldDescriptor
)

func init() {
	file_emissions_v9_params_proto_init()
	md_Params = File_emissions_v9_params_proto.Messages().ByName("Params")
	...
	fd_Params_max_canonical_label_byte_length = md_Params.Fields().ByName("max_canonical_label_byte_length")
	fd_Params_max_topic_label_whitelist_size = md_Params.Fields().ByName("max_topic_label_whitelist_size")
	fd_Params_max_epoch_label_registry_size = md_Params.Fields().ByName("max_epoch_label_registry_size")
	fd_Params_min_top_inferers_to_reward = md_Params.Fields().ByName("min_top_inferers_to_reward")
}
...
func (x *Params) slowProtoReflect() protoreflect.Message {
	mi := &file_emissions_v9_params_proto_msgTypes[0]
...
func (x *fastReflection_Params) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.GlobalAdminWhitelistAppended != false {
		value := protoreflect.ValueOfBool(x.GlobalAdminWhitelistAppended)
		if !f(fd_Params_global_admin_whitelist_appended, value) {
			return
		}
	}
	...
	if x.MinWeightThresholdForStdnorm != "" {
		value := protoreflect.ValueOfString(x.MinWeightThresholdForStdnorm)
		if !f(fd_Params_min_weight_threshold_for_stdnorm, value) {
			return
		}
	}
	if x.MaxCanonicalLabelByteLength != uint64(0) {
		value := protoreflect.ValueOfUint64(x.MaxCanonicalLabelByteLength)
		if !f(fd_Params_max_canonical_label_byte_length, value) {
			return
		}
	}
	if x.MaxTopicLabelWhitelistSize != uint64(0) {
		value := protoreflect.ValueOfUint64(x.MaxTopicLabelWhitelistSize)
		if !f(fd_Params_max_topic_label_whitelist_size, value) {
			return
		}
	}
	if x.MaxEpochLabelRegistrySize != uint64(0) {
		value := protoreflect.ValueOfUint64(x.MaxEpochLabelRegistrySize)
		if !f(fd_Params_max_epoch_label_registry_size, value) {
			return
		}
	}
	if x.MinTopInferersToReward != uint64(0) {
		value := protoreflect.ValueOfUint64(x.MinTopInferersToReward)
		if !f(fd_Params_min_top_inferers_to_reward, value) {
			return
		}
	}
}
...
func (x *fastReflection_Params) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "emissions.v9.Params.version":
		return x.Version != ""
	case "emissions.v9.Params.max_serialized_msg_length":
		return x.MaxSerializedMsgLength != int64(0)
	case "emissions.v9.Params.min_topic_weight":
		return x.MinTopicWeight != ""
	case "emissions.v9.Params.required_minimum_stake":
		return x.RequiredMinimumStake != ""
	case "emissions.v9.Params.remove_stake_delay_window":
		return x.RemoveStakeDelayWindow != int64(0)
	case "emissions.v9.Params.min_epoch_length":
		return x.MinEpochLength != int64(0)
	case "emissions.v9.Params.beta_entropy":
		return x.BetaEntropy != ""
	case "emissions.v9.Params.learning_rate":
		return x.LearningRate != ""
	case "emissions.v9.Params.max_gradient_threshold":
		return x.MaxGradientThreshold != ""
	case "emissions.v9.Params.min_stake_fraction":
		return x.MinStakeFraction != ""
	case "emissions.v9.Params.max_unfulfilled_worker_requests":
		return x.MaxUnfulfilledWorkerRequests != uint64(0)
	case "emissions.v9.Params.max_unfulfilled_reputer_requests":
		return x.MaxUnfulfilledReputerRequests != uint64(0)
	case "emissions.v9.Params.topic_reward_stake_importance":
		return x.TopicRewardStakeImportance != ""
	case "emissions.v9.Params.topic_reward_fee_revenue_importance":
		return x.TopicRewardFeeRevenueImportance != ""
	case "emissions.v9.Params.topic_reward_alpha":
		return x.TopicRewardAlpha != ""
	case "emissions.v9.Params.task_reward_alpha":
		return x.TaskRewardAlpha != ""
	case "emissions.v9.Params.validators_vs_allora_percent_reward":
		return x.ValidatorsVsAlloraPercentReward != ""
	case "emissions.v9.Params.max_samples_to_scale_scores":
		return x.MaxSamplesToScaleScores != uint64(0)
	case "emissions.v9.Params.max_top_inferers_to_reward":
		return x.MaxTopInferersToReward != uint64(0)
	case "emissions.v9.Params.max_top_forecasters_to_reward":
		return x.MaxTopForecastersToReward != uint64(0)
	case "emissions.v9.Params.max_top_reputers_to_reward":
		return x.MaxTopReputersToReward != uint64(0)
	case "emissions.v9.Params.create_topic_fee":
		return x.CreateTopicFee != ""
	case "emissions.v9.Params.gradient_descent_max_iters":
		return x.GradientDescentMaxIters != uint64(0)
	case "emissions.v9.Params.registration_fee":
		return x.RegistrationFee != ""
	case "emissions.v9.Params.default_page_limit":
		return x.DefaultPageLimit != uint64(0)
	case "emissions.v9.Params.max_page_limit":
		return x.MaxPageLimit != uint64(0)
	case "emissions.v9.Params.min_epoch_length_record_limit":
		return x.MinEpochLengthRecordLimit != int64(0)
	case "emissions.v9.Params.blocks_per_month":
		return x.BlocksPerMonth != uint64(0)
	case "emissions.v9.Params.p_reward_inference":
		return x.PRewardInference != ""
	case "emissions.v9.Params.p_reward_forecast":
		return x.PRewardForecast != ""
	case "emissions.v9.Params.p_reward_reputer":
		return x.PRewardReputer != ""
	case "emissions.v9.Params.c_reward_inference":
		return x.CRewardInference != ""
	case "emissions.v9.Params.c_reward_forecast":
		return x.CRewardForecast != ""
	case "emissions.v9.Params.c_norm":
		return x.CNorm != ""
	case "emissions.v9.Params.epsilon_reputer":
		return x.EpsilonReputer != ""
	case "emissions.v9.Params.half_max_process_stake_removals_end_block":
		return x.HalfMaxProcessStakeRemovalsEndBlock != uint64(0)
	case "emissions.v9.Params.epsilon_safe_div":
		return x.EpsilonSafeDiv != ""
	case "emissions.v9.Params.data_sending_fee":
		return x.DataSendingFee != ""
	case "emissions.v9.Params.max_elements_per_forecast":
		return x.MaxElementsPerForecast != uint64(0)
	case "emissions.v9.Params.max_active_topics_per_block":
		return x.MaxActiveTopicsPerBlock != uint64(0)
	case "emissions.v9.Params.max_string_length":
		return x.MaxStringLength != uint64(0)
	case "emissions.v9.Params.initial_regret_quantile":
		return x.InitialRegretQuantile != ""
	case "emissions.v9.Params.p_norm_safe_div":
		return x.PNormSafeDiv != ""
	case "emissions.v9.Params.global_whitelist_enabled":
		return x.GlobalWhitelistEnabled != false
	case "emissions.v9.Params.topic_creator_whitelist_enabled":
		return x.TopicCreatorWhitelistEnabled != false
	case "emissions.v9.Params.min_experienced_worker_regrets":
		return x.MinExperiencedWorkerRegrets != uint64(0)
	case "emissions.v9.Params.inference_outlier_detection_threshold":
		return x.InferenceOutlierDetectionThreshold != ""
	case "emissions.v9.Params.inference_outlier_detection_alpha":
		return x.InferenceOutlierDetectionAlpha != ""
	case "emissions.v9.Params.lambda_initial_score":
		return x.LambdaInitialScore != ""
	case "emissions.v9.Params.global_worker_whitelist_enabled":
		return x.GlobalWorkerWhitelistEnabled != false
	case "emissions.v9.Params.global_reputer_whitelist_enabled":
		return x.GlobalReputerWhitelistEnabled != false
	case "emissions.v9.Params.global_admin_whitelist_appended":
		return x.GlobalAdminWhitelistAppended != false
	case "emissions.v9.Params.max_whitelist_input_array_length":
	...
	case "emissions.v9.Params.max_canonical_label_byte_length":
		return x.MaxCanonicalLabelByteLength != uint64(0)
	case "emissions.v9.Params.max_topic_label_whitelist_size":
		return x.MaxTopicLabelWhitelistSize != uint64(0)
	case "emissions.v9.Params.max_epoch_label_registry_size":
		return x.MaxEpochLabelRegistrySize != uint64(0)
	case "emissions.v9.Params.min_top_inferers_to_reward":
		return x.MinTopInferersToReward != uint64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: emissions.v9.Params"))
		}
		panic(fmt.Errorf("message emissions.v9.Params does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Params) Clear(fd protoreflect.FieldDescriptor) {
	...
	case "emissions.v9.Params.global_admin_whitelist_appended":
		x.GlobalAdminWhitelistAppended = false
	case "emissions.v9.Params.max_whitelist_input_array_length":
		x.MaxWhitelistInputArrayLength = uint64(0)
	case "emissions.v9.Params.min_weight_threshold_for_stdnorm":
		x.MinWeightThresholdForStdnorm = ""
	case "emissions.v9.Params.max_canonical_label_byte_length":
		x.MaxCanonicalLabelByteLength = uint64(0)
	case "emissions.v9.Params.max_topic_label_whitelist_size":
		x.MaxTopicLabelWhitelistSize = uint64(0)
	case "emissions.v9.Params.max_epoch_label_registry_size":
		x.MaxEpochLabelRegistrySize = uint64(0)
	case "emissions.v9.Params.min_top_inferers_to_reward":
		x.MinTopInferersToReward = uint64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: emissions.v9.Params"))
		}
...
func (x *fastReflection_Params) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "emissions.v9.Params.global_reputer_whitelist_enabled":
		...
		return protoreflect.ValueOfBool(value)
	case "emissions.v9.Params.global_admin_whitelist_appended":
		value := x.GlobalAdminWhitelistAppended
		return protoreflect.ValueOfBool(value)
	case "emissions.v9.Params.max_whitelist_input_array_length":
	...
	case "emissions.v9.Params.min_weight_threshold_for_stdnorm":
		...
		return protoreflect.ValueOfString(value)
	case "emissions.v9.Params.max_canonical_label_byte_length":
		value := x.MaxCanonicalLabelByteLength
		return protoreflect.ValueOfUint64(value)
	case "emissions.v9.Params.max_topic_label_whitelist_size":
		value := x.MaxTopicLabelWhitelistSize
		return protoreflect.ValueOfUint64(value)
	case "emissions.v9.Params.max_epoch_label_registry_size":
		value := x.MaxEpochLabelRegistrySize
		return protoreflect.ValueOfUint64(value)
	case "emissions.v9.Params.min_top_inferers_to_reward":
		value := x.MinTopInferersToReward
		return protoreflect.ValueOfUint64(value)
	default:
		if descriptor.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: emissions.v9.Params"))
		}
		panic(fmt.Errorf("message emissions.v9.Params does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Params) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "emissions.v9.Params.global_admin_whitelist_appended":
		x.GlobalAdminWhitelistAppended = value.Bool()
	case "emissions.v9.Params.max_whitelist_input_array_length":
		x.MaxWhitelistInputArrayLength = value.Uint()
	case "emissions.v9.Params.min_weight_threshold_for_stdnorm":
		x.MinWeightThresholdForStdnorm = value.Interface().(string)
	case "emissions.v9.Params.max_canonical_label_byte_length":
		x.MaxCanonicalLabelByteLength = value.Uint()
	case "emissions.v9.Params.max_topic_label_whitelist_size":
		x.MaxTopicLabelWhitelistSize = value.Uint()
	case "emissions.v9.Params.max_epoch_label_registry_size":
		x.MaxEpochLabelRegistrySize = value.Uint()
	case "emissions.v9.Params.min_top_inferers_to_reward":
		x.MinTopInferersToReward = value.Uint()
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: emissions.v9.Params"))
		}
...
func (x *fastReflection_Params) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "emissions.v9.Params.version":
		panic(fmt.Errorf("field version of message emissions.v9.Params is not mutable"))
	case "emissions.v9.Params.max_serialized_msg_length":
		panic(fmt.Errorf("field max_serialized_msg_length of message emissions.v9.Params is not mutable"))
	case "emissions.v9.Params.min_topic_weight":
		panic(fmt.Errorf("field min_topic_weight of message emissions.v9.Params is not mutable"))
	case "emissions.v9.Params.required_minimum_stake":
		panic(fmt.Errorf("field required_minimum_stake of message emissions.v9.Params is not mutable"))
	case "emissions.v9.Params.remove_stake_delay_window":
		panic(fmt.Errorf("field remove_stake_delay_window of message emissions.v9.Params is not mutable"))
	case "emissions.v9.Params.min_epoch_length":
		panic(fmt.Errorf("field min_epoch_length of message emissions.v9.Params is not mutable"))
	case "emissions.v9.Params.beta_entropy":
		panic(fmt.Errorf("field beta_entropy of message emissions.v9.Params is not mutable"))
	case "emissions.v9.Params.learning_rate":
		panic(fmt.Errorf("field learning_rate of message emissions.v9.Params is not mutable"))
	case "emissions.v9.Params.max_gradient_threshold":
		panic(fmt.Errorf("field max_gradient_threshold of message emissions.v9.Params is not mutable"))
	case "emissions.v9.Params.min_stake_fraction":
		panic(fmt.Errorf("field min_stake_fraction of message emissions.v9.Params is not mutable"))
	case "emissions.v9.Params.max_unfulfilled_worker_requests":
		panic(fmt.Errorf("field max_unfulfilled_worker_requests of message emissions.v9.Params is not mutable"))
	case "emissions.v9.Params.max_unfulfilled_reputer_requests":
		panic(fmt.Errorf("field max_unfulfilled_reputer_requests of message emissions.v9.Params is not mutable"))
	case "emissions.v9.Params.topic_reward_stake_importance":
		panic(fmt.Errorf("field topic_reward_stake_importance of message emissions.v9.Params is not mutable"))
	case "emissions.v9.Params.topic_reward_fee_revenue_importance":
		panic(fmt.Errorf("field topic_reward_fee_revenue_importance of message emissions.v9.Params is not mutable"))
	case "emissions.v9.Params.topic_reward_alpha":
		panic(fmt.Errorf("field topic_reward_alpha of message emissions.v9.Params is not mutable"))
	case "emissions.v9.Params.task_reward_alpha":
		panic(fmt.Errorf("field task_reward_alpha of message emissions.v9.Params is not mutable"))
	case "emissions.v9.Params.validators_vs_allora_percent_reward":
		panic(fmt.Errorf("field validators_vs_allora_percent_reward of message emissions.v9.Params is not mutable"))
	case "emissions.v9.Params.max_samples_to_scale_scores":
		panic(fmt.Errorf("field max_samples_to_scale_scores of message emissions.v9.Params is not mutable"))
	case "emissions.v9.Params.max_top_inferers_to_reward":
		panic(fmt.Errorf("field max_top_inferers_to_reward of message emissions.v9.Params is not mutable"))
	case "emissions.v9.Params.max_top_forecasters_to_reward":
		panic(fmt.Errorf("field max_top_forecasters_to_reward of message emissions.v9.Params is not mutable"))
	case "emissions.v9.Params.max_top_reputers_to_reward":
		panic(fmt.Errorf("field max_top_reputers_to_reward of message emissions.v9.Params is not mutable"))
	case "emissions.v9.Params.create_topic_fee":
		panic(fmt.Errorf("field create_topic_fee of message emissions.v9.Params is not mutable"))
	case "emissions.v9.Params.gradient_descent_max_iters":
		panic(fmt.Errorf("field gradient_descent_max_iters of message emissions.v9.Params is not mutable"))
	case "emissions.v9.Params.registration_fee":
		panic(fmt.Errorf("field registration_fee of message emissions.v9.Params is not mutable"))
	case "emissions.v9.Params.default_page_limit":
		panic(fmt.Errorf("field default_page_limit of message emissions.v9.Params is not mutable"))
	case "emissions.v9.Params.max_page_limit":
		panic(fmt.Errorf("field max_page_limit of message emissions.v9.Params is not mutable"))
	case "emissions.v9.Params.min_epoch_length_record_limit":
		panic(fmt.Errorf("field min_epoch_length_record_limit of message emissions.v9.Params is not mutable"))
	case "emissions.v9.Params.blocks_per_month":
		panic(fmt.Errorf("field blocks_per_month of message emissions.v9.Params is not mutable"))
	case "emissions.v9.Params.p_reward_inference":
		panic(fmt.Errorf("field p_reward_inference of message emissions.v9.Params is not mutable"))
	case "emissions.v9.Params.p_reward_forecast":
		panic(fmt.Errorf("field p_reward_forecast of message emissions.v9.Params is not mutable"))
	case "emissions.v9.Params.p_reward_reputer":
		panic(fmt.Errorf("field p_reward_reputer of message emissions.v9.Params is not mutable"))
	case "emissions.v9.Params.c_reward_inference":
		panic(fmt.Errorf("field c_reward_inference of message emissions.v9.Params is not mutable"))
	case "emissions.v9.Params.c_reward_forecast":
		panic(fmt.Errorf("field c_reward_forecast of message emissions.v9.Params is not mutable"))
	case "emissions.v9.Params.c_norm":
		panic(fmt.Errorf("field c_norm of message emissions.v9.Params is not mutable"))
	case "emissions.v9.Params.epsilon_reputer":
		panic(fmt.Errorf("field epsilon_reputer of message emissions.v9.Params is not mutable"))
	case "emissions.v9.Params.half_max_process_stake_removals_end_block":
		panic(fmt.Errorf("field half_max_process_stake_removals_end_block of message emissions.v9.Params is not mutable"))
	case "emissions.v9.Params.epsilon_safe_div":
		panic(fmt.Errorf("field epsilon_safe_div of message emissions.v9.Params is not mutable"))
	case "emissions.v9.Params.data_sending_fee":
		panic(fmt.Errorf("field data_sending_fee of message emissions.v9.Params is not mutable"))
	case "emissions.v9.Params.max_elements_per_forecast":
		panic(fmt.Errorf("field max_elements_per_forecast of message emissions.v9.Params is not mutable"))
	case "emissions.v9.Params.max_active_topics_per_block":
		panic(fmt.Errorf("field max_active_topics_per_block of message emissions.v9.Params is not mutable"))
	case "emissions.v9.Params.max_string_length":
		panic(fmt.Errorf("field max_string_length of message emissions.v9.Params is not mutable"))
	case "emissions.v9.Params.initial_regret_quantile":
		panic(fmt.Errorf("field initial_regret_quantile of message emissions.v9.Params is not mutable"))
	case "emissions.v9.Params.p_norm_safe_div":
		panic(fmt.Errorf("field p_norm_safe_div of message emissions.v9.Params is not mutable"))
	case "emissions.v9.Params.global_whitelist_enabled":
		panic(fmt.Errorf("field global_whitelist_enabled of message emissions.v9.Params is not mutable"))
	case "emissions.v9.Params.topic_creator_whitelist_enabled":
		panic(fmt.Errorf("field topic_creator_whitelist_enabled of message emissions.v9.Params is not mutable"))
	case "emissions.v9.Params.min_experienced_worker_regrets":
		panic(fmt.Errorf("field min_experienced_worker_regrets of message emissions.v9.Params is not mutable"))
	case "emissions.v9.Params.inference_outlier_detection_threshold":
		panic(fmt.Errorf("field inference_outlier_detection_threshold of message emissions.v9.Params is not mutable"))
	case "emissions.v9.Params.inference_outlier_detection_alpha":
		panic(fmt.Errorf("field inference_outlier_detection_alpha of message emissions.v9.Params is not mutable"))
	case "emissions.v9.Params.lambda_initial_score":
		panic(fmt.Errorf("field lambda_initial_score of message emissions.v9.Params is not mutable"))
	case "emissions.v9.Params.global_worker_whitelist_enabled":
		panic(fmt.Errorf("field global_worker_whitelist_enabled of message emissions.v9.Params is not mutable"))
	case "emissions.v9.Params.global_reputer_whitelist_enabled":
		panic(fmt.Errorf("field global_reputer_whitelist_enabled of message emissions.v9.Params is not mutable"))
	case "emissions.v9.Params.global_admin_whitelist_appended":
		panic(fmt.Errorf("field global_admin_whitelist_appended of message emissions.v9.Params is not mutable"))
	case "emissions.v9.Params.max_whitelist_input_array_length":
	...
	case "emissions.v9.Params.max_canonical_label_byte_length":
		panic(fmt.Errorf("field max_canonical_label_byte_length of message emissions.v9.Params is not mutable"))
	case "emissions.v9.Params.max_topic_label_whitelist_size":
		panic(fmt.Errorf("field max_topic_label_whitelist_size of message emissions.v9.Params is not mutable"))
	case "emissions.v9.Params.max_epoch_label_registry_size":
		panic(fmt.Errorf("field max_epoch_label_registry_size of message emissions.v9.Params is not mutable"))
	case "emissions.v9.Params.min_top_inferers_to_reward":
		panic(fmt.Errorf("field min_top_inferers_to_reward of message emissions.v9.Params is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: emissions.v9.Params"))
		}
...
func (x *fastReflection_Params) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in emissions.v9.Params", d.FullName()))
	}
	panic("unreachable")
}
...
func (x *fastReflection_Params) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		if x.GlobalAdminWhitelistAppended {
			n += 3
		}
		if x.MaxWhitelistInputArrayLength != 0 {
			n += 2 + runtime.Sov(uint64(x.MaxWhitelistInputArrayLength))
		}
		l = len(x.MinWeightThresholdForStdnorm)
		if l > 0 {
			n += 2 + l + runtime.Sov(uint64(l))
		}
		if x.MaxCanonicalLabelByteLength != 0 {
			n += 2 + runtime.Sov(uint64(x.MaxCanonicalLabelByteLength))
		}
		if x.MaxTopicLabelWhitelistSize != 0 {
			n += 2 + runtime.Sov(uint64(x.MaxTopicLabelWhitelistSize))
		}
		if x.MaxEpochLabelRegistrySize != 0 {
			n += 2 + runtime.Sov(uint64(x.MaxEpochLabelRegistrySize))
		}
		if x.MinTopInferersToReward != 0 {
			n += 2 + runtime.Sov(uint64(x.MinTopInferersToReward))
		}
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if x.MinTopInferersToReward != 0 {
			i = runtime.EncodeVarint(dAtA, i, uint64(x.MinTopInferersToReward))
			i--
			dAtA[i] = 0x4
			i--
			dAtA[i] = 0x80
		...
		if x.MaxEpochLabelRegistrySize != 0 {
			i = runtime.EncodeVarint(dAtA, i, uint64(x.MaxEpochLabelRegistrySize))
			i--
			dAtA[i] = 0x3
			i--
			dAtA[i] = 0xf8
		...
		if x.MaxTopicLabelWhitelistSize != 0 {
			i = runtime.EncodeVarint(dAtA, i, uint64(x.MaxTopicLabelWhitelistSize))
			i--
			dAtA[i] = 0x3
			i--
			dAtA[i] = 0xf0
		...
		if x.MaxCanonicalLabelByteLength != 0 {
			i = runtime.EncodeVarint(dAtA, i, uint64(x.MaxCanonicalLabelByteLength))
			i--
			dAtA[i] = 0x3
			i--
			dAtA[i] = 0xe8
		...
		if len(x.MinWeightThresholdForStdnorm) > 0 {
			...
			copy(dAtA[i:], x.MinWeightThresholdForStdnorm)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.MinWeightThresholdForStdnorm)))
			i--
			dAtA[i] = 0x3
			i--
			dAtA[i] = 0xe2
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 58:
				...
				x.GlobalAdminWhitelistAppended = bool(v != 0)
			case 59:
				if wireType != 0 {
			...
			case 60:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field MinWeightThresholdForStdnorm", wireType)
				}
				var stringLen uint64
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
			...
			case 61:
				if wireType != 0 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field MaxCanonicalLabelByteLength", wireType)
				}
				x.MaxCanonicalLabelByteLength = 0
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
						return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, runtime.ErrIntOverflow
					}
					...
					b := dAtA[iNdEx]
					iNdEx++
					x.MaxCanonicalLabelByteLength |= uint64(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
			case 62:
				if wireType != 0 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field MaxTopicLabelWhitelistSize", wireType)
				}
				x.MaxTopicLabelWhitelistSize = 0
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
						return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, runtime.ErrIntOverflow
					}
					...
					b := dAtA[iNdEx]
					iNdEx++
					x.MaxTopicLabelWhitelistSize |= uint64(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
			case 63:
				if wireType != 0 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field MaxEpochLabelRegistrySize", wireType)
				}
				x.MaxEpochLabelRegistrySize = 0
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
						return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, runtime.ErrIntOverflow
					}
					...
					b := dAtA[iNdEx]
					iNdEx++
					x.MaxEpochLabelRegistrySize |= uint64(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
			case 64:
				if wireType != 0 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field MinTopInferersToReward", wireType)
				}
				x.MinTopInferersToReward = 0
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
						return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, runtime.ErrIntOverflow
					}
					...
					b := dAtA[iNdEx]
					iNdEx++
					x.MinTopInferersToReward |= uint64(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
...
func (*Params) Descriptor() ([]byte, []int) {
	return file_emissions_v9_params_proto_rawDescGZIP(), []int{0}
}
...
func (x *Params) GetGlobalAdminWhitelistAppended() bool {
	if x != nil {
...
func (x *Params) GetMaxCanonicalLabelByteLength() uint64 {
	if x != nil {
		return x.MaxCanonicalLabelByteLength
	}
	return 0
}

func (x *Params) GetMaxTopicLabelWhitelistSize() uint64 {
	if x != nil {
		return x.MaxTopicLabelWhitelistSize
	}
	return 0
}

func (x *Params) GetMaxEpochLabelRegistrySize() uint64 {
	if x != nil {
		return x.MaxEpochLabelRegistrySize
	}
	return 0
}

func (x *Params) GetMinTopInferersToReward() uint64 {
	if x != nil {
		return x.MinTopInferersToReward
	}
	return 0
}
...
var file_emissions_v9_params_proto_rawDesc = []byte{
	0x0a, 0x19, 0x65, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x2f, 0x76, 0x39, 0x2f, 0x70,
	...
	0x74, 0x6f, 0x2f, 0x67, 0x6f, 0x67, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xbe, 0x27,
	...
	,
	...
	,
	...
	,
	...
	0x6e, 0x6f, 0x6e, 0x63, 0x65, 0x73, 0x5f, 0x72, 0x65, 0x70, 0x75, 0x74, 0x65, 0x72, 0x42, 0xc1,
	0x01, 0x0a, 0x10, 0x63, 0x6f, 0x6d, 0x2e, 0x65, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x73,
	0x2e, 0x76, 0x39, 0x42, 0x0b, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x50, 0x72, 0x6f, 0x74, 0x6f,
...
var (
	file_emissions_v9_params_proto_rawDescOnce sync.Once
	file_emissions_v9_params_proto_rawDescData = file_emissions_v9_params_proto_rawDesc
)

func file_emissions_v9_params_proto_rawDescGZIP() []byte {
	file_emissions_v9_params_proto_rawDescOnce.Do(func() {
		file_emissions_v9_params_proto_rawDescData = protoimpl.X.CompressGZIP(file_emissions_v9_params_proto_rawDescData)
	})
	return file_emissions_v9_params_proto_rawDescData
}

var file_emissions_v9_params_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_emissions_v9_params_proto_goTypes = []interface{}{
	(*Params)(nil), // 0: emissions.v9.Params
}
var file_emissions_v9_params_proto_depIdxs = []int32{
...
func init() { file_emissions_v9_params_proto_init() }
func file_emissions_v9_params_proto_init() {
	if File_emissions_v9_params_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_emissions_v9_params_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Params); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_emissions_v9_params_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_emissions_v9_params_proto_goTypes,
		DependencyIndexes: file_emissions_v9_params_proto_depIdxs,
		MessageInfos:      file_emissions_v9_params_proto_msgTypes,
	}.Build()
	File_emissions_v9_params_proto = out.File
	file_emissions_v9_params_proto_rawDesc = nil
	file_emissions_v9_params_proto_goTypes = nil
	file_emissions_v9_params_proto_depIdxs = nil
}
