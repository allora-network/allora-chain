...
var (
	...
	fd_Topic_tolerance        protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_Topic_tolerance = md_Topic.Fields().ByName("tolerance")
}
...
func (x *fastReflection_Topic) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "emissions.v1.Topic.tolerance":
		return x.Tolerance != ""
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_Topic) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "emissions.v1.Topic.tolerance":
		panic(fmt.Errorf("field tolerance of message emissions.v1.Topic is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: emissions.v1.Topic"))
		}
...
func (x *Topic) GetTolerance() string {
	if x != nil {
		return x.Tolerance
	}
	return ""
...
var file_emissions_v1_topic_proto_rawDesc = []byte{
	...
	0x6f, 0x2f, 0x67, 0x6f, 0x67, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa3, 0x05, 0x0a,
	...
	0x6c, 0x6f, 0x77, 0x4e, 0x65, 0x67, 0x61, 0x74, 0x69, 0x76, 0x65, 0x12, 0x55, 0x0a, 0x09, 0x74,
	0x6f, 0x6c, 0x65, 0x72, 0x61, 0x6e, 0x63, 0x65, 0x18, 0x0f, 0x20, 0x01, 0x28, 0x09, 0x42, 0x37,
	0xc8, 0xde, 0x1f, 0x00, 0xda, 0xde, 0x1f, 0x2f, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63,
	0x6f, 0x6d, 0x2f, 0x61, 0x6c, 0x6c, 0x6f, 0x72, 0x61, 0x2d, 0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72,
	0x6b, 0x2f, 0x61, 0x6c, 0x6c, 0x6f, 0x72, 0x61, 0x2d, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x2f, 0x6d,
	0x61, 0x74, 0x68, 0x2e, 0x44, 0x65, 0x63, 0x52, 0x09, 0x74, 0x6f, 0x6c, 0x65, 0x72, 0x61, 0x6e,
	...
	0x6f, 0x70, 0x69, 0x63, 0x52, 0x06, 0x74, 0x6f, 0x70, 0x69, 0x63, 0x73, 0x42, 0xc0, 0x01, 0x0a,
...
var file_emissions_v1_topic_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
