...
var (
	...
	fd_Topic_is_never_negative protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_Topic_is_never_negative = md_Topic.Fields().ByName("is_never_negative")
}
...
func (x *fastReflection_Topic) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.IsNeverNegative != false {
		...
		if !f(fd_Topic_is_never_negative, value) {
			return
		}
	}
}
...
func (x *fastReflection_Topic) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "emissions.v1.Topic.f_tolerance":
		return x.FTolerance != ""
	case "emissions.v1.Topic.is_never_negative":
...
func (x *fastReflection_Topic) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "emissions.v1.Topic.is_never_negative":
		panic(fmt.Errorf("field is_never_negative of message emissions.v1.Topic is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: emissions.v1.Topic"))
		}
...
func init() {
	file_emissions_v1_topic_proto_init()
	md_TopicFeeRevenue = File_emissions_v1_topic_proto.Messages().ByName("TopicFeeRevenue")
...
func (x *Topic) GetIsNeverNegative() bool {
	if x != nil {
...
var file_emissions_v1_topic_proto_rawDesc = []byte{
	...
	0x6f, 0x2f, 0x67, 0x6f, 0x67, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x9d, 0x07, 0x0a,
	...
	0x61, 0x74, 0x69, 0x76, 0x65, 0x18, 0x12, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0f, 0x69, 0x73, 0x4e,
	0x65, 0x76, 0x65, 0x72, 0x4e, 0x65, 0x67, 0x61, 0x74, 0x69, 0x76, 0x65, 0x22, 0x38, 0x0a, 0x09,
	...
	0x74, 0x6f, 0x70, 0x69, 0x63, 0x73, 0x22, 0x73, 0x0a, 0x0f, 0x54, 0x6f, 0x70, 0x69, 0x63, 0x46,
	...
	0x2a, 0x01, 0x52, 0x07, 0x72, 0x65, 0x76, 0x65, 0x6e, 0x75, 0x65, 0x42, 0xc0, 0x01, 0x0a, 0x10,
	0x63, 0x6f, 0x6d, 0x2e, 0x65, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x76, 0x31,
	0x42, 0x0a, 0x54, 0x6f, 0x70, 0x69, 0x63, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x4f,
...
var file_emissions_v1_topic_proto_goTypes = []interface{}{
	...
	(*TopicFeeRevenue)(nil), // 2: emissions.v1.TopicFeeRevenue
}
