...
func (x *Score) slowProtoReflect() protoreflect.Message {
	mi := &file_emissions_v1_score_proto_msgTypes[0]
...
func init() {
	file_emissions_v1_score_proto_init()
	md_Scores = File_emissions_v1_score_proto.Messages().ByName("Scores")
...
func (x *Scores) slowProtoReflect() protoreflect.Message {
	mi := &file_emissions_v1_score_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (*Score) Descriptor() ([]byte, []int) {
	return file_emissions_v1_score_proto_rawDescGZIP(), []int{0}
}
...
func (*Scores) Descriptor() ([]byte, []int) {
	return file_emissions_v1_score_proto_rawDescGZIP(), []int{1}
}
...
var file_emissions_v1_score_proto_rawDesc = []byte{
	...
	0x73, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x76, 0x31, 0x42, 0x0a, 0x53, 0x63, 0x6f, 0x72, 0x65,
...
var (
	file_emissions_v1_score_proto_rawDescOnce sync.Once
	file_emissions_v1_score_proto_rawDescData = file_emissions_v1_score_proto_rawDesc
)

func file_emissions_v1_score_proto_rawDescGZIP() []byte {
	file_emissions_v1_score_proto_rawDescOnce.Do(func() {
		file_emissions_v1_score_proto_rawDescData = protoimpl.X.CompressGZIP(file_emissions_v1_score_proto_rawDescData)
	})
	return file_emissions_v1_score_proto_rawDescData
}

var file_emissions_v1_score_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_emissions_v1_score_proto_goTypes = []interface{}{
	(*Score)(nil),  // 0: emissions.v1.Score
	(*Scores)(nil), // 1: emissions.v1.Scores
}
var file_emissions_v1_score_proto_depIdxs = []int32{
	0, // 0: emissions.v1.Scores.scores:type_name -> emissions.v1.Score
...
func init() { file_emissions_v1_score_proto_init() }
func file_emissions_v1_score_proto_init() {
	if File_emissions_v1_score_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_emissions_v1_score_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Score); i {
			case 0:
				return &v.state
			case 1:
		...
		file_emissions_v1_score_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Scores); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_emissions_v1_score_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_emissions_v1_score_proto_goTypes,
		DependencyIndexes: file_emissions_v1_score_proto_depIdxs,
		MessageInfos:      file_emissions_v1_score_proto_msgTypes,
	}.Build()
	File_emissions_v1_score_proto = out.File
	file_emissions_v1_score_proto_rawDesc = nil
	file_emissions_v1_score_proto_goTypes = nil
	file_emissions_v1_score_proto_depIdxs = nil
}
