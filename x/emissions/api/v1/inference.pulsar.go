...
func init() {
	...
	md_RegretInformedWeight = File_emissions_v1_inference_proto.Messages().ByName("RegretInformedWeight")
...
func (x *RegretInformedWeight) slowProtoReflect() protoreflect.Message {
	mi := &file_emissions_v1_inference_proto_msgTypes[0]
...
func (x *fastReflection_RegretInformedWeight) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "emissions.v1.RegretInformedWeight.worker":
		return x.Worker != ""
	case "emissions.v1.RegretInformedWeight.weight":
		return x.Weight != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: emissions.v1.RegretInformedWeight"))
		}
		panic(fmt.Errorf("message emissions.v1.RegretInformedWeight does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_RegretInformedWeight) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message emissions.v1.RegretInformedWeight does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_RegretInformedWeight) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "emissions.v1.RegretInformedWeight.worker":
		panic(fmt.Errorf("field worker of message emissions.v1.RegretInformedWeight is not mutable"))
	case "emissions.v1.RegretInformedWeight.weight":
		panic(fmt.Errorf("field weight of message emissions.v1.RegretInformedWeight is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: emissions.v1.RegretInformedWeight"))
		}
...
func (x *fastReflection_RegretInformedWeight) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in emissions.v1.RegretInformedWeight", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: emissions/v1/inference.proto
...
func (*RegretInformedWeight) Descriptor() ([]byte, []int) {
	return file_emissions_v1_inference_proto_rawDescGZIP(), []int{0}
}
...
var File_emissions_v1_inference_proto protoreflect.FileDescriptor

var file_emissions_v1_inference_proto_rawDesc = []byte{
	0x0a, 0x1c, 0x65, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x2f, 0x76, 0x31, 0x2f, 0x69,
	0x6e, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0c,
	0x65, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x76, 0x31, 0x1a, 0x14, 0x67, 0x6f,
	...
	0x73, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x76, 0x31, 0x42, 0x0e, 0x49, 0x6e, 0x66, 0x65, 0x72,
...
var (
	file_emissions_v1_inference_proto_rawDescOnce sync.Once
	file_emissions_v1_inference_proto_rawDescData = file_emissions_v1_inference_proto_rawDesc
)

func file_emissions_v1_inference_proto_rawDescGZIP() []byte {
	file_emissions_v1_inference_proto_rawDescOnce.Do(func() {
		file_emissions_v1_inference_proto_rawDescData = protoimpl.X.CompressGZIP(file_emissions_v1_inference_proto_rawDescData)
	})
	return file_emissions_v1_inference_proto_rawDescData
}

var file_emissions_v1_inference_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_emissions_v1_inference_proto_goTypes = []interface{}{
	(*RegretInformedWeight)(nil), // 0: emissions.v1.RegretInformedWeight
}
var file_emissions_v1_inference_proto_depIdxs = []int32{
...
func init() { file_emissions_v1_inference_proto_init() }
func file_emissions_v1_inference_proto_init() {
	if File_emissions_v1_inference_proto != nil {
		return
	}
	file_emissions_v1_nonce_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_emissions_v1_inference_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_emissions_v1_inference_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_emissions_v1_inference_proto_goTypes,
		DependencyIndexes: file_emissions_v1_inference_proto_depIdxs,
		MessageInfos:      file_emissions_v1_inference_proto_msgTypes,
	}.Build()
	File_emissions_v1_inference_proto = out.File
	file_emissions_v1_inference_proto_rawDesc = nil
	file_emissions_v1_inference_proto_goTypes = nil
	file_emissions_v1_inference_proto_depIdxs = nil
}
