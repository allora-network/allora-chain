...
var _ protoreflect.List = (*_TopicIdsList_1_list)(nil)

type _TopicIdsList_1_list struct {
	list *[]uint64
}

func (x *_TopicIdsList_1_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_TopicIdsList_1_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfUint64((*x.list)[i])
}

func (x *_TopicIdsList_1_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.Uint()
	concreteValue := valueUnwrapped
	(*x.list)[i] = concreteValue
}

func (x *_TopicIdsList_1_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.Uint()
	concreteValue := valueUnwrapped
	*x.list = append(*x.list, concreteValue)
}

func (x *_TopicIdsList_1_list) AppendMutable() protoreflect.Value {
	panic(fmt.Errorf("AppendMutable can not be called on message TopicIdsList at list field Ids as it is not of Message kind"))
}

func (x *_TopicIdsList_1_list) Truncate(n int) {
	*x.list = (*x.list)[:n]
}

func (x *_TopicIdsList_1_list) NewElement() protoreflect.Value {
	v := uint64(0)
	return protoreflect.ValueOfUint64(v)
}

func (x *_TopicIdsList_1_list) IsValid() bool {
	return x.list != nil
}

var (
	md_TopicIdsList     protoreflect.MessageDescriptor
	fd_TopicIdsList_ids protoreflect.FieldDescriptor
)

func init() {
	file_emissions_state_v1_types_proto_init()
	md_TopicIdsList = File_emissions_state_v1_types_proto.Messages().ByName("TopicIdsList")
	fd_TopicIdsList_ids = md_TopicIdsList.Fields().ByName("ids")
}

var _ protoreflect.Message = (*fastReflection_TopicIdsList)(nil)

type fastReflection_TopicIdsList TopicIdsList

func (x *TopicIdsList) ProtoReflect() protoreflect.Message {
	return (*fastReflection_TopicIdsList)(x)
}

func (x *TopicIdsList) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_TopicIdsList_messageType fastReflection_TopicIdsList_messageType
var _ protoreflect.MessageType = fastReflection_TopicIdsList_messageType{}

type fastReflection_TopicIdsList_messageType struct{}

func (x fastReflection_TopicIdsList_messageType) Zero() protoreflect.Message {
	return (*fastReflection_TopicIdsList)(nil)
}
func (x fastReflection_TopicIdsList_messageType) New() protoreflect.Message {
	return new(fastReflection_TopicIdsList)
}
func (x fastReflection_TopicIdsList_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_TopicIdsList
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_TopicIdsList) Descriptor() protoreflect.MessageDescriptor {
	return md_TopicIdsList
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_TopicIdsList) Type() protoreflect.MessageType {
	return _fastReflection_TopicIdsList_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_TopicIdsList) New() protoreflect.Message {
	return new(fastReflection_TopicIdsList)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_TopicIdsList) Interface() protoreflect.ProtoMessage {
	return (*TopicIdsList)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_TopicIdsList) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if len(x.Ids) != 0 {
		value := protoreflect.ValueOfList(&_TopicIdsList_1_list{list: &x.Ids})
		if !f(fd_TopicIdsList_ids, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_TopicIdsList) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "emissions.state.v1.TopicIdsList.ids":
		return len(x.Ids) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: emissions.state.v1.TopicIdsList"))
		}
		panic(fmt.Errorf("message emissions.state.v1.TopicIdsList does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_TopicIdsList) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "emissions.state.v1.TopicIdsList.ids":
		x.Ids = nil
	default:
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_TopicIdsList) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "emissions.state.v1.TopicIdsList.ids":
		if len(x.Ids) == 0 {
			return protoreflect.ValueOfList(&_TopicIdsList_1_list{})
		}
		listValue := &_TopicIdsList_1_list{list: &x.Ids}
		return protoreflect.ValueOfList(listValue)
	default:
		if descriptor.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: emissions.state.v1.TopicIdsList"))
		}
		panic(fmt.Errorf("message emissions.state.v1.TopicIdsList does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_TopicIdsList) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "emissions.state.v1.TopicIdsList.ids":
		lv := value.List()
		clv := lv.(*_TopicIdsList_1_list)
		x.Ids = *clv.list
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: emissions.state.v1.TopicIdsList"))
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_TopicIdsList) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "emissions.state.v1.TopicIdsList.ids":
		if x.Ids == nil {
			x.Ids = []uint64{}
		}
		value := &_TopicIdsList_1_list{list: &x.Ids}
		return protoreflect.ValueOfList(value)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: emissions.state.v1.TopicIdsList"))
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_TopicIdsList) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "emissions.state.v1.TopicIdsList.ids":
		list := []uint64{}
		return protoreflect.ValueOfList(&_TopicIdsList_1_list{list: &list})
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: emissions.state.v1.TopicIdsList"))
		}
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_TopicIdsList) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in emissions.state.v1.TopicIdsList", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_TopicIdsList) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_TopicIdsList) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_TopicIdsList) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_TopicIdsList) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*TopicIdsList)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: TopicIdsList: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: TopicIdsList: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType == 0 {
...
func (x *TopicIdsList) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TopicIdsList) ProtoMessage() {}

// Deprecated: Use TopicIdsList.ProtoReflect.Descriptor instead.
func (*TopicIdsList) Descriptor() ([]byte, []int) {
	return file_emissions_state_v1_types_proto_rawDescGZIP(), []int{14}
}

func (x *TopicIdsList) GetIds() []uint64 {
	if x != nil {
		return x.Ids
	}
	return nil
...
var file_emissions_state_v1_types_proto_rawDesc = []byte{
	...
	0x52, 0x0a, 0x70, 0x6c, 0x61, 0x63, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x22, 0x20, 0x0a, 0x0c,
	0x54, 0x6f, 0x70, 0x69, 0x63, 0x49, 0x64, 0x73, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x10, 0x0a, 0x03,
	0x69, 0x64, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x04, 0x52, 0x03, 0x69, 0x64, 0x73, 0x2a, 0xa9,
	0x07, 0x0a, 0x03, 0x45, 0x72, 0x72, 0x12, 0x15, 0x0a, 0x11, 0x45, 0x72, 0x72, 0x49, 0x6e, 0x76,
	...
	0x65, 0x79, 0x52, 0x65, 0x71, 0x75, 0x69, 0x72, 0x65, 0x64, 0x10, 0x04, 0x12, 0x1b, 0x0a, 0x17,
	0x45, 0x72, 0x72, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x4e, 0x6f, 0x74, 0x52, 0x65, 0x67,
	...
	,
...
var file_emissions_state_v1_types_proto_goTypes = []interface{}{
	...
	(*TopicIdsList)(nil),           // 15: emissions.state.v1.TopicIdsList
}
