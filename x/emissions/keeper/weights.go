...
func (k *WeightsKeeper) GetLatestRegretStdNorm(ctx context.Context, topicId TopicId) (alloraMath.Dec, error) {
...
func (k *WeightsKeeper) SetLatestRegretStdNorm(ctx context.Context, topicId TopicId, regretStdNorm alloraMath.Dec) error {
