...
func TestSynthPalette_Clone(t *testing.T) {
	...
	palette := synth.SynthPalette{
		...
		InfererRegrets:                   make(map[synth.Worker]*synth.StatefulRegret),
		...
		ForecasterRegrets:                make(map[synth.Worker]*synth.StatefulRegret),
		InferersNewStatus:                synth.InferersAllNew,
		SingleNotNewInferer:              "",
