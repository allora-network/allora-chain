...
func (s *MsgServerTestSuite) TestMsgInsertWorkerPayloadWithFewTopElementsPerForecast() {
	...
	_ = s.emissionsKeeper.UpdateInfererScoreEma(ctx, topicId, alpha, inferer1, score1)
	_ = s.emissionsKeeper.UpdateInfererScoreEma(ctx, topicId, alpha, inferer2, score2)
	_ = s.emissionsKeeper.UpdateInfererScoreEma(ctx, topicId, alpha, inferer3, score3)
	_ = s.emissionsKeeper.UpdateInfererScoreEma(ctx, topicId, alpha, inferer4, score4)
...
func (s *MsgServerTestSuite) TestGetLowScoreFromAllInferences() {
	ctx := s.ctx
	k := s.emissionsKeeper
	topicId := uint64(1)
...
func (s *MsgServerTestSuite) TestGetLowScoreFromAllForecasts() {
	ctx := s.ctx
	k := s.emissionsKeeper
	topicId := uint64(1)
	blockHeightInferences := int64(10)
...
func (s *MsgServerTestSuite) TestGetLowScoreFromAllLossBundles() {
	ctx := s.ctx
	k := s.emissionsKeeper
	topicId := uint64(1)
