...
func (s *MsgServerTestSuite) TestMsgServiceAddStakeRequest() {
	ctx := s.ctx
	require := s.Require()
...
func (s *MsgServerTestSuite) TestStartRemoveStake() {
	...
	msg := &types.MsgServiceRemoveStakeRequest{
...
func (s *MsgServerTestSuite) TestStartRemoveStakeTwiceInSameBlock() {
	...
	_, err = s.msgServer.RemoveStake(ctx, &types.MsgServiceRemoveStakeRequest{
		Sender:  senderAddr.String(),
		TopicId: topicId,
		Amount:  stakeAmount,
	})
...
func (s *MsgServerTestSuite) TestDelegateeCantWithdrawDelegatedStake() {
	...
	delegateStakeMsg := &types.MsgServiceDelegateStakeRequest{
		Sender:  delegatorAddr.String(),
		TopicId: topicId,
		Reputer: reputerAddr.String(),
		Amount:  stakeAmount,
	...
	removeMsg := &types.MsgServiceRemoveStakeRequest{
		Sender:  reputerAddr.String(),
		TopicId: topicId,
		Amount:  stakeAmount,
	}
...
func (s *MsgServerTestSuite) TestStartRemoveDelegateStake() {
	...
	msg2 := &types.MsgServiceRemoveDelegateStakeRequest{
		Sender:  delegatorAddr.String(),
		Reputer: reputerAddr.String(),
		TopicId: topicId,
		Amount:  stakeAmount,
...
func (s *MsgServerTestSuite) TestConfirmRemoveDelegateStake() {
	...
	_, err = s.msgServer.DelegateStake(ctx, &types.MsgServiceDelegateStakeRequest{
		Sender:  delegatorAddr.String(),
		TopicId: topicId,
		Reputer: reputerAddr.String(),
		Amount:  stakeAmount,
	...
	_, err = s.msgServer.RemoveDelegateStake(ctx, &types.MsgServiceRemoveDelegateStakeRequest{
		Sender:  delegatorAddr.String(),
		Reputer: reputerAddr.String(),
		TopicId: topicId,
		Amount:  stakeAmount,
...
func (s *MsgServerTestSuite) TestRewardDelegateStake() {
	...
	msg2 := &types.MsgServiceDelegateStakeRequest{
	...
	msg3 := &types.MsgServiceDelegateStakeRequest{
		Sender:  delegatorAddr.String(),
		TopicId: topicId,
		Reputer: reputerAddr.String(),
	...
	rewardMsg := &types.MsgServiceRewardDelegateStakeRequest{
		Sender:  delegatorAddr.String(),
		TopicId: topicId,
		Reputer: reputerAddr.String(),
	}
	...
	rewardMsg2 := &types.MsgServiceRewardDelegateStakeRequest{
		Sender:  delegator2Addr.String(),
		TopicId: topicId,
		Reputer: reputerAddr.String(),
	}
...
func (s *MsgServerTestSuite) TestMultiRoundReputerStakeVs1000xDelegatorStake() {
	...
	addDelegateStakeMsg := &types.MsgServiceDelegateStakeRequest{
		Sender:  delegatorAddr.String(),
		TopicId: topicId,
		Reputer: reputerAddr.String(),
		Amount:  reputerStakeAmount,
	...
	delegateRewardsMsg := &types.MsgServiceRewardDelegateStakeRequest{
		Sender:  delegatorAddr.String(),
		TopicId: topicId,
		Reputer: reputerAddr.String(),
	}
	...
	addLargeDelegateStakeMsg := &types.MsgServiceDelegateStakeRequest{
	...
	largeDelegateRewardsMsg := &types.MsgServiceRewardDelegateStakeRequest{
		Sender:  largeDelegatorAddr.String(),
		TopicId: topicId,
		Reputer: reputerAddr.String(),
	}
...
func (s *MsgServerTestSuite) TestCancelRemoveStake() {
	...
	msg := &types.MsgServiceCancelRemoveStakeRequest{
		Sender:  reputer,
		TopicId: topicID,
	}
...
func (s *MsgServerTestSuite) TestCancelRemoveDelegateStake() {
	...
	// Call CancelRemoveDelegateStake
	msg := &types.MsgServiceCancelRemoveDelegateStakeRequest{
		Sender:  delegator,
		Reputer: reputer,
		TopicId: topicID,
	}
