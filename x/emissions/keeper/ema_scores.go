...
func (k *Keeper) CalcAndSaveInfererScoreEmaWithLastSavedTopicQuantile(
	...
	types.EmitNewActorEMAScoresSetEvent(ctx, types.ActorType_ACTOR_TYPE_INFERER_UNSPECIFIED, emaScores, activeArr, types.TopicId(topic.Id))
	return nil
}
...
func (k *Keeper) CalcAndSaveForecasterScoreEmaWithLastSavedTopicQuantile(
	...
	types.EmitNewActorEMAScoresSetEvent(ctx, types.ActorType_ACTOR_TYPE_FORECASTER, emaScores, activeArr, types.TopicId(topic.Id))
	return nil
}
...
func (k *Keeper) CalcAndSaveReputerScoreEmaWithLastSavedTopicQuantile(
	...
	types.EmitNewActorEMAScoresSetEvent(ctx, types.ActorType_ACTOR_TYPE_REPUTER, emaScores, activeArr, types.TopicId(topic.Id))
	return nil
}
