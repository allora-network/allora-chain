...
type OptionalParams struct {
	...
	MaxMissingInferencePercent    []cosmossdk_io_math.LegacyDec `protobuf:"bytes,6,rep,name=max_missing_inference_percent,json=maxMissingInferencePercent,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"max_missing_inference_percent"`
	...
	RemoveStakeDelayWindow        []uint64                      `protobuf:"varint,8,rep,packed,name=remove_stake_delay_window,json=removeStakeDelayWindow,proto3" json:"remove_stake_delay_window,omitempty"`
	MinRequestCadence             []uint64                      `protobuf:"varint,9,rep,packed,name=min_request_cadence,json=minRequestCadence,proto3" json:"min_request_cadence,omitempty"`
	MinWeightCadence              []uint64                      `protobuf:"varint,10,rep,packed,name=min_weight_cadence,json=minWeightCadence,proto3" json:"min_weight_cadence,omitempty"`
	MaxInferenceRequestValidity   []uint64                      `protobuf:"varint,11,rep,packed,name=max_inference_request_validity,json=maxInferenceRequestValidity,proto3" json:"max_inference_request_validity,omitempty"`
	MaxRequestCadence             []uint64                      `protobuf:"varint,12,rep,packed,name=max_request_cadence,json=maxRequestCadence,proto3" json:"max_request_cadence,omitempty"`
	PercentRewardsReputersWorkers []cosmossdk_io_math.LegacyDec `protobuf:"bytes,13,rep,name=percent_rewards_reputers_workers,json=percentRewardsReputersWorkers,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"percent_rewards_reputers_workers"`
}
...
var fileDescriptor_72ef1bd09180c1d8 = []byte{
	...
	,
}
...
func (m *OptionalParams) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.PercentRewardsReputersWorkers) > 0 {
		for iNdEx := len(m.PercentRewardsReputersWorkers) - 1; iNdEx >= 0; iNdEx-- {
			{
				size := m.PercentRewardsReputersWorkers[iNdEx].Size()
				i -= size
				if _, err := m.PercentRewardsReputersWorkers[iNdEx].MarshalTo(dAtA[i:]); err != nil {
					return 0, err
				}
	...
	if len(m.MaxTopicsPerBlock) > 0 {
		dAtA12 := make([]byte, len(m.MaxTopicsPerBlock)*10)
		var j11 int
	...
	if len(m.EpochLength) > 0 {
		dAtA14 := make([]byte, len(m.EpochLength)*10)
		var j13 int
...
func (m *MsgRegister) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x2a
	if len(m.TopicIds) > 0 {
		dAtA17 := make([]byte, len(m.TopicIds)*10)
		var j16 int
...
func (m *OptionalParams) Size() (n int) {
	...
	if len(m.PercentRewardsReputersWorkers) > 0 {
		for _, e := range m.PercentRewardsReputersWorkers {
			l = e.Size()
			n += 1 + l + sovTx(uint64(l))
		}
	}
...
func (m *OptionalParams) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 13:
			...
			var v cosmossdk_io_math.LegacyDec
			m.PercentRewardsReputersWorkers = append(m.PercentRewardsReputersWorkers, v)
			if err := m.PercentRewardsReputersWorkers[len(m.PercentRewardsReputersWorkers)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
