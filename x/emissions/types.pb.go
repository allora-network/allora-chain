...
func (m *TopicIdsList) Reset()         { *m = TopicIdsList{} }
func (m *TopicIdsList) String() string { return proto.CompactTextString(m) }
func (*TopicIdsList) ProtoMessage()    {}
func (*TopicIdsList) Descriptor() ([]byte, []int) {
	return fileDescriptor_ea41525923641e50, []int{14}
}
func (m *TopicIdsList) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *TopicIdsList) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_TopicIdsList.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *TopicIdsList) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TopicIdsList.Merge(m, src)
}
func (m *TopicIdsList) XXX_Size() int {
	return m.Size()
}
func (m *TopicIdsList) XXX_DiscardUnknown() {
	xxx_messageInfo_TopicIdsList.DiscardUnknown(m)
}

var xxx_messageInfo_TopicIdsList proto.InternalMessageInfo

func (m *TopicIdsList) GetIds() []uint64 {
	if m != nil {
		return m.Ids
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*TopicIdsList)(nil), "emissions.state.v1.TopicIdsList")
}
...
var fileDescriptor_ea41525923641e50 = []byte{
	...
	,
}
...
func (m *TopicIdsList) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *TopicIdsList) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TopicIdsList) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *TopicIdsList) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *TopicIdsList) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TopicIdsList: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TopicIdsList: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType == 0 {
