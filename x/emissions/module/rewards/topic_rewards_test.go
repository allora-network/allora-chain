...
func (s *RewardsTestSuite) TestGetRewardAndRemovedRewardableTopics() {
	...
	s.InsertReputerLossBundle(topicId, topic.EpochLastEnded, reputerIndexes)
...
func (s *RewardsTestSuite) TestPreviousTopicWeightsAfterInactivation() {
	...
	s.InsertReputerLossBundle(topicId, topic.EpochLastEnded, reputerIndexes, testutil.WithReputerValues(reputerValues))
