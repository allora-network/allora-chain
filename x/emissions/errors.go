...
var (
	...
	ErrWeightCadenceBelowMinimum                         = errors.Register(ModuleName, 49, "weight cadence must be at least 10800 seconds (3 hours)")
	...
	ErrNotInWeightSettingWhitelist                       = errors.Register(ModuleName, 52, "not in topic weight setting whitelist")
