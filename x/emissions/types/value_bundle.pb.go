...
func (*WorkerAttributedValue) Descriptor() ([]byte, []int) {
	return fileDescriptor_d9dd0b072f1e2f79, []int{0}
}
...
func (*WithheldWorkerAttributedValue) Descriptor() ([]byte, []int) {
	return fileDescriptor_d9dd0b072f1e2f79, []int{1}
}
...
func (*OneOutInfererForecasterValues) Descriptor() ([]byte, []int) {
	return fileDescriptor_d9dd0b072f1e2f79, []int{2}
}
...
func (*ValueBundle) Descriptor() ([]byte, []int) {
	return fileDescriptor_d9dd0b072f1e2f79, []int{3}
}
...
func init() { proto.RegisterFile("emissions/v3/value_bundle.proto", fileDescriptor_d9dd0b072f1e2f79) }

var fileDescriptor_d9dd0b072f1e2f79 = []byte{
	// 583 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *WorkerAttributedValue) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	{
		...
		i = encodeVarintValueBundle(dAtA, i, uint64(size))
	}
	i--
	dAtA[i] = 0x12
	if len(m.Worker) > 0 {
		...
		i = encodeVarintValueBundle(dAtA, i, uint64(len(m.Worker)))
		i--
		dAtA[i] = 0xa
	}
...
func (m *OneOutInfererForecasterValues) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Forecaster) > 0 {
		...
		i = encodeVarintValueBundle(dAtA, i, uint64(len(m.Forecaster)))
		i--
		dAtA[i] = 0x1a
	}
	return len(dAtA) - i, nil
...
func (m *ValueBundle) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ExtraData) > 0 {
		...
		i = encodeVarintValueBundle(dAtA, i, uint64(len(m.ExtraData)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.Reputer) > 0 {
		...
		i = encodeVarintValueBundle(dAtA, i, uint64(len(m.Reputer)))
		i--
		dAtA[i] = 0x1a
	}
	...
	if m.TopicId != 0 {
		i = encodeVarintValueBundle(dAtA, i, uint64(m.TopicId))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func encodeVarintValueBundle(dAtA []byte, offset int, v uint64) int {
	offset -= sovValueBundle(v)
	base := offset
	for v >= 1<<7 {
...
func (m *ValueBundle) Size() (n int) {
	...
	_ = l
	if m.TopicId != 0 {
		n += 1 + sovValueBundle(uint64(m.TopicId))
	}
	if m.ReputerRequestNonce != nil {
...
func sovValueBundle(x uint64) (n int) {
	return (math_bits.Len64(x|1) + 6) / 7
}
func sozValueBundle(x uint64) (n int) {
	return sovValueBundle(uint64((x << 1) ^ uint64((int64(x) >> 63))))
}
func (m *WorkerAttributedValue) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return ErrIntOverflowValueBundle
			}
			if iNdEx >= l {
		...
		case 1:
			...
			if intStringLen < 0 {
				return ErrInvalidLengthValueBundle
			}
		...
		default:
			iNdEx = preIndex
			skippy, err := skipValueBundle(dAtA[iNdEx:])
			if err != nil {
				return err
			}
...
func skipValueBundle(dAtA []byte) (n int, err error) {
	l := len(dAtA)
	iNdEx := 0
	depth := 0
	for iNdEx < l {
		...
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return 0, ErrIntOverflowValueBundle
			}
			if iNdEx >= l {
		...
		case 2:
			...
			if length < 0 {
				return 0, ErrInvalidLengthValueBundle
			}
			iNdEx += length
		case 3:
			depth++
		case 4:
			if depth == 0 {
				return 0, ErrUnexpectedEndOfGroupValueBundle
			}
			depth--
		case 5:
			iNdEx += 4
...
var (
	ErrInvalidLengthValueBundle        = fmt.Errorf("proto: negative length found during unmarshaling")
	ErrIntOverflowValueBundle          = fmt.Errorf("proto: integer overflow")
	ErrUnexpectedEndOfGroupValueBundle = fmt.Errorf("proto: unexpected end of group")
)
