...
func (*SimpleCursorPaginationRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_767943d0ce0ca0fd, []int{0}
}
...
func (*SimpleCursorPaginationResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_767943d0ce0ca0fd, []int{1}
}
...
func (*ListeningCoefficient) Descriptor() ([]byte, []int) {
	return fileDescriptor_767943d0ce0ca0fd, []int{2}
}
...
func init() {
	proto.RegisterType((*SimpleCursorPaginationRequest)(nil), "emissions.v2.SimpleCursorPaginationRequest")
	proto.RegisterType((*SimpleCursorPaginationResponse)(nil), "emissions.v2.SimpleCursorPaginationResponse")
	proto.RegisterType((*ListeningCoefficient)(nil), "emissions.v2.ListeningCoefficient")
}

func init() { proto.RegisterFile("emissions/v2/types.proto", fileDescriptor_767943d0ce0ca0fd) }

var fileDescriptor_767943d0ce0ca0fd = []byte{
	...
	0x9b, 0x60, 0xa1, 0x89, 0x1d, 0x98, 0x58, 0x68, 0x61, 0xce, 0x4a, 0x1b, 0xb2, 0x5c, 0x86, 0x63,
	...
	0x00, 0xff, 0xff, 0x22, 0x81, 0x67, 0xcb, 0xc1, 0x01, 0x00, 0x00,
}
