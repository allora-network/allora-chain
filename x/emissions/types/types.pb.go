...
type Params struct {
	...
	TopicRewardStakeImportance      github_com_allora_network_allora_chain_math.Dec `protobuf:"bytes,25,opt,name=topic_reward_stake_importance,json=topicRewardStakeImportance,proto3,customtype=github.com/allora-network/allora-chain/math.Dec" json:"topic_reward_stake_importance"`
	TopicRewardFeeRevenueImportance github_com_allora_network_allora_chain_math.Dec `protobuf:"bytes,26,opt,name=topic_reward_fee_revenue_importance,json=topicRewardFeeRevenueImportance,proto3,customtype=github.com/allora-network/allora-chain/math.Dec" json:"topic_reward_fee_revenue_importance"`
	// 0.5
	TopicRewardAlpha github_com_allora_network_allora_chain_math.Dec `protobuf:"bytes,27,opt,name=topic_reward_alpha,json=topicRewardAlpha,proto3,customtype=github.com/allora-network/allora-chain/math.Dec" json:"topic_reward_alpha"`
	// updates
	TaskRewardAlpha                 github_com_allora_network_allora_chain_math.Dec `protobuf:"bytes,28,opt,name=task_reward_alpha,json=taskRewardAlpha,proto3,customtype=github.com/allora-network/allora-chain/math.Dec" json:"task_reward_alpha"`
	ValidatorsVsAlloraPercentReward github_com_allora_network_allora_chain_math.Dec `protobuf:"bytes,29,opt,name=validators_vs_allora_percent_reward,json=validatorsVsAlloraPercentReward,proto3,customtype=github.com/allora-network/allora-chain/math.Dec" json:"validators_vs_allora_percent_reward"`
	MaxSamplesToScaleScores         uint64                                          `protobuf:"varint,30,opt,name=max_samples_to_scale_scores,json=maxSamplesToScaleScores,proto3" json:"max_samples_to_scale_scores,omitempty"`
	// max this many inferences from unique workers and forecasts thereof are accepted per payload
	MaxTopWorkersToReward           uint64                                          `protobuf:"varint,31,opt,name=max_top_workers_to_reward,json=maxTopWorkersToReward,proto3" json:"max_top_workers_to_reward,omitempty"`
	MaxTopReputersToReward          uint64                                          `protobuf:"varint,32,opt,name=max_top_reputers_to_reward,json=maxTopReputersToReward,proto3" json:"max_top_reputers_to_reward,omitempty"`
	CreateTopicFee                  cosmossdk_io_math.Int                           `protobuf:"bytes,33,opt,name=create_topic_fee,json=createTopicFee,proto3,customtype=cosmossdk.io/math.Int" json:"create_topic_fee"`
	SigmoidA                        github_com_allora_network_allora_chain_math.Dec `protobuf:"bytes,34,opt,name=sigmoid_a,json=sigmoidA,proto3,customtype=github.com/allora-network/allora-chain/math.Dec" json:"sigmoid_a"`
	SigmoidB                        github_com_allora_network_allora_chain_math.Dec `protobuf:"bytes,35,opt,name=sigmoid_b,json=sigmoidB,proto3,customtype=github.com/allora-network/allora-chain/math.Dec" json:"sigmoid_b"`
	...
	MaxRequestsPerTopic             uint64                                          `protobuf:"varint,46,opt,name=max_requests_per_topic,json=maxRequestsPerTopic,proto3" json:"max_requests_per_topic,omitempty"`
	DefaultLimit                    uint64                                          `protobuf:"varint,47,opt,name=default_limit,json=defaultLimit,proto3" json:"default_limit,omitempty"`
	MaxLimit                        uint64                                          `protobuf:"varint,48,opt,name=max_limit,json=maxLimit,proto3" json:"max_limit,omitempty"`
}
...
func (m *Params) GetMaxRequestsPerTopic() uint64 {
	if m != nil {
...
type InferenceRequest struct {
	...
	MaxPricePerInference cosmossdk_io_math.Uint `protobuf:"bytes,6,opt,name=max_price_per_inference,json=maxPricePerInference,proto3,customtype=cosmossdk.io/math.Uint" json:"max_price_per_inference"`
	BidAmount            cosmossdk_io_math.Uint `protobuf:"bytes,7,opt,name=bid_amount,json=bidAmount,proto3,customtype=cosmossdk.io/math.Uint" json:"bid_amount"`
	BlockLastChecked     int64                  `protobuf:"varint,8,opt,name=block_last_checked,json=blockLastChecked,proto3" json:"block_last_checked,omitempty"`
...
func (m *InferenceRequests) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *InferenceRequests) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_InferenceRequests.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *InferenceRequests) XXX_Merge(src proto.Message) {
	xxx_messageInfo_InferenceRequests.Merge(m, src)
}
func (m *InferenceRequests) XXX_Size() int {
	return m.Size()
}
func (m *InferenceRequests) XXX_DiscardUnknown() {
	xxx_messageInfo_InferenceRequests.DiscardUnknown(m)
}

var xxx_messageInfo_InferenceRequests proto.InternalMessageInfo

func (m *InferenceRequests) GetInferenceRequests() []*InferenceRequest {
	if m != nil {
...
func (*TopicFeeRevenue) Descriptor() ([]byte, []int) {
	return fileDescriptor_32ba9f7333c0b525, []int{33}
}
...
func (*PreviousTopicWeight) Descriptor() ([]byte, []int) {
	return fileDescriptor_32ba9f7333c0b525, []int{34}
}
...
type DelegatorInfo struct {
	...
	RewardDebt cosmossdk_io_math.Uint `protobuf:"bytes,2,opt,name=reward_debt,json=rewardDebt,proto3,customtype=cosmossdk.io/math.Uint" json:"reward_debt"`
}
...
func (*DelegatorInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_32ba9f7333c0b525, []int{35}
}
...
func init() {
	...
	proto.RegisterType((*InferenceRequests)(nil), "emissions.v1.InferenceRequests")
...
var fileDescriptor_32ba9f7333c0b525 = []byte{
	...
	,
}
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.DefaultLimit != 0 {
		i = encodeVarintTypes(dAtA, i, uint64(m.DefaultLimit))
		i--
		dAtA[i] = 0x2
		i--
		dAtA[i] = 0xf8
	}
	if m.MaxRequestsPerTopic != 0 {
		i = encodeVarintTypes(dAtA, i, uint64(m.MaxRequestsPerTopic))
		i--
		dAtA[i] = 0x2
		i--
		dAtA[i] = 0xf0
...
func (m *InferenceRequests) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *InferenceRequests) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *InferenceRequests) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *Params) Size() (n int) {
	...
	n += 2 + l + sovTypes(uint64(l))
	if m.MaxRequestsPerTopic != 0 {
		n += 2 + sovTypes(uint64(m.MaxRequestsPerTopic))
	}
	if m.DefaultLimit != 0 {
		n += 2 + sovTypes(uint64(m.DefaultLimit))
	}
	if m.MaxLimit != 0 {
...
func (m *InferenceRequests) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	for iNdEx < l {
		...
		case 46:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MaxRequestsPerTopic |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *InferenceRequests) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: InferenceRequests: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: InferenceRequests: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
