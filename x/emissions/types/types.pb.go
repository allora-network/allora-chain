...
type Params struct {
	...
	DcoefAbs                        github_com_allora_network_allora_chain_math.Dec `protobuf:"bytes,14,opt,name=dcoef_abs,json=dcoefAbs,proto3,customtype=github.com/allora-network/allora-chain/math.Dec" json:"dcoef_abs"`
	LearningRate                    github_com_allora_network_allora_chain_math.Dec `protobuf:"bytes,15,opt,name=learning_rate,json=learningRate,proto3,customtype=github.com/allora-network/allora-chain/math.Dec" json:"learning_rate"`
	MaxGradientThreshold            github_com_allora_network_allora_chain_math.Dec `protobuf:"bytes,16,opt,name=max_gradient_threshold,json=maxGradientThreshold,proto3,customtype=github.com/allora-network/allora-chain/math.Dec" json:"max_gradient_threshold"`
	MinStakeFraction                github_com_allora_network_allora_chain_math.Dec `protobuf:"bytes,17,opt,name=min_stake_fraction,json=minStakeFraction,proto3,customtype=github.com/allora-network/allora-chain/math.Dec" json:"min_stake_fraction"`
	MaxWorkersPerTopicRequest       uint64                                          `protobuf:"varint,18,opt,name=max_workers_per_topic_request,json=maxWorkersPerTopicRequest,proto3" json:"max_workers_per_topic_request,omitempty"`
	MaxReputersPerTopicRequest      uint64                                          `protobuf:"varint,19,opt,name=max_reputers_per_topic_request,json=maxReputersPerTopicRequest,proto3" json:"max_reputers_per_topic_request,omitempty"`
	Epsilon                         github_com_allora_network_allora_chain_math.Dec `protobuf:"bytes,20,opt,name=epsilon,proto3,customtype=github.com/allora-network/allora-chain/math.Dec" json:"epsilon"`
	PInferenceSynthesis             github_com_allora_network_allora_chain_math.Dec `protobuf:"bytes,21,opt,name=p_inference_synthesis,json=pInferenceSynthesis,proto3,customtype=github.com/allora-network/allora-chain/math.Dec" json:"p_inference_synthesis"`
	PRewardSpread                   github_com_allora_network_allora_chain_math.Dec `protobuf:"bytes,22,opt,name=p_reward_spread,json=pRewardSpread,proto3,customtype=github.com/allora-network/allora-chain/math.Dec" json:"p_reward_spread"`
	...
	// updates
	TaskRewardAlpha                 github_com_allora_network_allora_chain_math.Dec `protobuf:"bytes,31,opt,name=task_reward_alpha,json=taskRewardAlpha,proto3,customtype=github.com/allora-network/allora-chain/math.Dec" json:"task_reward_alpha"`
	ValidatorsVsAlloraPercentReward cosmossdk_io_math.LegacyDec                     `protobuf:"bytes,32,opt,name=validators_vs_allora_percent_reward,json=validatorsVsAlloraPercentReward,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"validators_vs_allora_percent_reward"`
	MaxSamplesToScaleScores         uint64                                          `protobuf:"varint,33,opt,name=max_samples_to_scale_scores,json=maxSamplesToScaleScores,proto3" json:"max_samples_to_scale_scores,omitempty"`
	...
	MaxReputersAcceptedPerPayload uint64                                          `protobuf:"varint,35,opt,name=max_reputers_accepted_per_payload,json=maxReputersAcceptedPerPayload,proto3" json:"max_reputers_accepted_per_payload,omitempty"`
	MaxTopWorkersToReward         uint64                                          `protobuf:"varint,36,opt,name=max_top_workers_to_reward,json=maxTopWorkersToReward,proto3" json:"max_top_workers_to_reward,omitempty"`
	MaxTopReputersToReward        uint64                                          `protobuf:"varint,37,opt,name=max_top_reputers_to_reward,json=maxTopReputersToReward,proto3" json:"max_top_reputers_to_reward,omitempty"`
	CreateTopicFee                uint64                                          `protobuf:"varint,38,opt,name=create_topic_fee,json=createTopicFee,proto3" json:"create_topic_fee,omitempty"`
	SigmoidA                      github_com_allora_network_allora_chain_math.Dec `protobuf:"bytes,39,opt,name=sigmoid_a,json=sigmoidA,proto3,customtype=github.com/allora-network/allora-chain/math.Dec" json:"sigmoid_a"`
	SigmoidB                      github_com_allora_network_allora_chain_math.Dec `protobuf:"bytes,40,opt,name=sigmoid_b,json=sigmoidB,proto3,customtype=github.com/allora-network/allora-chain/math.Dec" json:"sigmoid_b"`
}
...
func (m *Params) GetMaxWorkersAcceptedPerPayload() uint64 {
	if m != nil {
...
func (m *Params) GetMaxReputersAcceptedPerPayload() uint64 {
	if m != nil {
...
func (m *Params) GetCreateTopicFee() uint64 {
	if m != nil {
...
func (m *ReputerValueBundle) GetReputerRequestNonce() *ReputerRequestNonce {
	if m != nil {
...
func (m *Inference) GetNonce() *Nonce {
	if m != nil {
		return m.Nonce
	}
	return nil
...
func (m *Forecast) GetNonce() *Nonce {
	if m != nil {
		return m.Nonce
	}
	return nil
...
func (m *ReputerRequestNonces) GetReputerRequestNonces() []*ReputerRequestNonce {
	if m != nil {
...
var fileDescriptor_32ba9f7333c0b525 = []byte{
	...
	,
}
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	i--
	dAtA[i] = 0xba
	if m.CreateTopicFee != 0 {
		i = encodeVarintTypes(dAtA, i, uint64(m.CreateTopicFee))
		i--
		dAtA[i] = 0x2
		i--
		dAtA[i] = 0xb0
	...
	if m.MaxReputersAcceptedPerPayload != 0 {
		i = encodeVarintTypes(dAtA, i, uint64(m.MaxReputersAcceptedPerPayload))
		i--
		dAtA[i] = 0x2
		i--
		dAtA[i] = 0x98
	}
	if m.MaxWorkersAcceptedPerPayload != 0 {
		i = encodeVarintTypes(dAtA, i, uint64(m.MaxWorkersAcceptedPerPayload))
		i--
		dAtA[i] = 0x2
		i--
		dAtA[i] = 0x90
...
func (m *ReputerRequestNonces) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.ReputerRequestNonces) > 0 {
		for iNdEx := len(m.ReputerRequestNonces) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.ReputerRequestNonces[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *Params) Size() (n int) {
	...
	if m.MaxWorkersAcceptedPerPayload != 0 {
		n += 2 + sovTypes(uint64(m.MaxWorkersAcceptedPerPayload))
	}
	if m.MaxReputersAcceptedPerPayload != 0 {
		n += 2 + sovTypes(uint64(m.MaxReputersAcceptedPerPayload))
	}
	if m.MaxTopWorkersToReward != 0 {
	...
	if m.CreateTopicFee != 0 {
		n += 2 + sovTypes(uint64(m.CreateTopicFee))
	}
	l = m.SigmoidA.Size()
	n += 2 + l + sovTypes(uint64(l))
	l = m.SigmoidB.Size()
...
func (m *ReputerRequestNonces) Size() (n int) {
	...
	_ = l
	if len(m.ReputerRequestNonces) > 0 {
		for _, e := range m.ReputerRequestNonces {
			l = e.Size()
			n += 1 + l + sovTypes(uint64(l))
		}
	}
...
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 34:
			...
			m.MaxWorkersAcceptedPerPayload = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowTypes
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MaxWorkersAcceptedPerPayload |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 35:
			...
			m.MaxReputersAcceptedPerPayload = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowTypes
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MaxReputersAcceptedPerPayload |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 38:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.CreateTopicFee |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *ReputerRequestNonces) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.ReputerRequestNonces = append(m.ReputerRequestNonces, &ReputerRequestNonce{})
			if err := m.ReputerRequestNonces[len(m.ReputerRequestNonces)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
