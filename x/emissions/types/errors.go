...
var (
	...
	ErrTopicCadenceBelowMinimum                          = errors.Register(ModuleName, 48, "inference cadence must be at least 60 seconds (1 minute)")
	...
	ErrNotInReputerWhitelist                             = errors.Register(ModuleName, 51, "not in reputer whitelist")
	ErrTopicNotEnoughDemand                              = errors.Register(ModuleName, 52, "topic not enough demand")
	ErrInvalidRequestId                                  = errors.Register(ModuleName, 53, "invalid request ID")
	ErrInferenceRequestNotInMempool                      = errors.Register(ModuleName, 54, "inference request not in mempool")
	ErrIntegerUnderflowStakeFromDelegator                = errors.Register(ModuleName, 55, "integer underflow for stake from delegator")
	ErrIntegerUnderflowDelegatedStakePlacement           = errors.Register(ModuleName, 56, "integer underflow for delegated stake placement")
	ErrIntegerUnderflowDelegatedStakeUponReputer         = errors.Register(ModuleName, 57, "integer underflow for delegated stake upon reputer")
)
