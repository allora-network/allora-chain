...
var (
	...
	ErrNonceAlreadyFulfilled                             = errors.Register(ModuleName, 108, "nonce already fulfilled")
	ErrNonceStillUnfulfilled                             = errors.Register(ModuleName, 109, "nonce still unfulfilled")
	ErrTopicCreatorNotEnoughDenom                        = errors.Register(ModuleName, 110, "topic creator does not have enough denom")
	ErrSignatureVerificationFailed                       = errors.Register(ModuleName, 111, "signature verification was failed")
	ErrInvalidWorkerNonce                                = errors.Register(ModuleName, 112, "invalid worker nonce")
	ErrInvalidReputerNonce                               = errors.Register(ModuleName, 113, "invalid reputer nonce")
)
