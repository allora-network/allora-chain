...
var (
	...
	ErrEToTheXExponentiationIsInfinity               = errors.Register(ModuleName, 42, "exponentiation overflow")
	ErrNaturalLogarithmIsInfinity                    = errors.Register(ModuleName, 43, "natural logarithm overflow")
	ErrLnToThePExponentiationIsInfinity              = errors.Register(ModuleName, 44, "exponentiation overflow")
	ErrAdjustedStakeInvalidSliceLength               = errors.Register(ModuleName, 45, "adjusted stake: invalid slice length")
	ErrFractionDivideByZero                          = errors.Register(ModuleName, 46, "fraction: divide by zero")
	ErrNumberRatioDivideByZero                       = errors.Register(ModuleName, 47, "number ratio: divide by zero")
	ErrNumberRatioInvalidSliceLength                 = errors.Register(ModuleName, 48, "number ratio: invalid slice length")
	ErrInvalidSliceLength                            = errors.Register(ModuleName, 49, "invalid slice length")
	ErrTopicCadenceBelowMinimum                      = errors.Register(ModuleName, 50, "topic cadence must be at least 60 seconds (1 minute)")
	ErrPhiCannotBeZero                               = errors.Register(ModuleName, 51, "phi: cannot be zero")
	ErrInferenceRequestBlockValidUntilInPast         = errors.Register(ModuleName, 52, "inference request block valid until in past")
	ErrInferenceRequestBlockValidUntilTooFarInFuture = errors.Register(ModuleName, 53, "inference request block valid until too far in future")
	ErrSumWeightsLessThanEta                         = errors.Register(ModuleName, 54, "sum weights less than eta")
	ErrSliceLengthMismatch                           = errors.Register(ModuleName, 55, "slice length mismatch")
	ErrNonceAlreadyFulfilled                         = errors.Register(ModuleName, 56, "nonce already fulfilled")
	ErrNonceStillUnfulfilled                         = errors.Register(ModuleName, 57, "nonce still unfulfilled")
	ErrTopicCreatorNotEnoughDenom                    = errors.Register(ModuleName, 58, "topic creator does not have enough denom")
	ErrSignatureVerificationFailed                   = errors.Register(ModuleName, 59, "signature verification was failed")
)
