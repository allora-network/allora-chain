...
var (
	...
	ErrMaxTopInferersIncompatibleWithActiveQuantile    = errors.Register(ModuleName, 67, "inverse of max top inferers to reward must be less than max active inferers quantile")
	ErrMaxTopForecastersIncompatibleWithActiveQuantile = errors.Register(ModuleName, 68, "inverse of max top forecasters to reward must be less than max active forecasters quantile")
	ErrMaxTopReputersIncompatibleWithActiveQuantile    = errors.Register(ModuleName, 69, "inverse of max top reputers to reward must be less than max active reputers quantile")
	ErrMustBeBelow100Percent                           = errors.Register(ModuleName, 70, "value must be below 100 percent")
	ErrMustBeBelowGlobalMaxActorQuantile               = errors.Register(ModuleName, 71, "value must be below global max actor quantile")
	ErrInvalidActorType                                = errors.Register(ModuleName, 72, "invalid actor type")
)
