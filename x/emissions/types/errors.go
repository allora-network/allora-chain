...
var (
	...
	ErrInferenceRewardsInvalidInput                      = errors.Register(ModuleName, 85, "inference rewards: invalid input")
	ErrInferenceRewardsIsNaN                             = errors.Register(ModuleName, 86, "inference rewards: is NaN")
	ErrInferenceRewardsIsInfinity                        = errors.Register(ModuleName, 87, "inference rewards: is infinity")
	ErrForecastingRewardsInvalidInput                    = errors.Register(ModuleName, 88, "forecasting rewards: invalid input")
	ErrForecastingRewardsIsNaN                           = errors.Register(ModuleName, 89, "forecasting rewards: is NaN")
	ErrForecastingRewardsIsInfinity                      = errors.Register(ModuleName, 90, "forecasting rewards: is infinity")
	...
	ErrSigmoidInvalidInput                               = errors.Register(ModuleName, 97, "sigmoid: invalid input")
	ErrSigmoidIsNaN                                      = errors.Register(ModuleName, 98, "sigmoid: is NaN")
	ErrSigmoidIsInfinity                                 = errors.Register(ModuleName, 99, "sigmoid: is infinity")
	ErrForecastingUtilityInvalidInput                    = errors.Register(ModuleName, 100, "forecasting utility: invalid input")
	ErrForecastingUtilityIsNaN                           = errors.Register(ModuleName, 101, "forecasting utility: is NaN")
	ErrForecastingUtilityIsInfinity                      = errors.Register(ModuleName, 102, "forecasting utility: is infinity")
	ErrNormalizationFactorInvalidInput                   = errors.Register(ModuleName, 103, "normalization factor: invalid input")
	ErrNormalizationFactorIsNaN                          = errors.Register(ModuleName, 104, "normalization factor: is NaN")
	ErrNormalizationFactorIsInfinity                     = errors.Register(ModuleName, 105, "normalization factor: is infinity")
)
