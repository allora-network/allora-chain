...
type Topic struct {
	...
	ActiveInfererQuantile    github_com_allora_network_allora_chain_math.Dec `protobuf:"bytes,18,opt,name=active_inferer_quantile,json=activeInfererQuantile,proto3,customtype=github.com/allora-network/allora-chain/math.Dec" json:"active_inferer_quantile"`
	ActiveForecasterQuantile github_com_allora_network_allora_chain_math.Dec `protobuf:"bytes,19,opt,name=active_forecaster_quantile,json=activeForecasterQuantile,proto3,customtype=github.com/allora-network/allora-chain/math.Dec" json:"active_forecaster_quantile"`
	ActiveReputerQuantile    github_com_allora_network_allora_chain_math.Dec `protobuf:"bytes,20,opt,name=active_reputer_quantile,json=activeReputerQuantile,proto3,customtype=github.com/allora-network/allora-chain/math.Dec" json:"active_reputer_quantile"`
}
...
var fileDescriptor_6320c39e204beb2b = []byte{
	...
	,
}
