...
func (*Topic) Descriptor() ([]byte, []int) {
	return fileDescriptor_aa075a2dfa8a6cad, []int{0}
}
...
func (*TopicList) Descriptor() ([]byte, []int) {
	return fileDescriptor_aa075a2dfa8a6cad, []int{1}
}
...
func (*TimestampedActorNonce) Descriptor() ([]byte, []int) {
	return fileDescriptor_aa075a2dfa8a6cad, []int{2}
}
...
func (*TopicIds) Descriptor() ([]byte, []int) {
	return fileDescriptor_aa075a2dfa8a6cad, []int{3}
}
...
func (*TopicIdWeightPair) Descriptor() ([]byte, []int) {
	return fileDescriptor_aa075a2dfa8a6cad, []int{4}
}
...
func init() {
	proto.RegisterType((*Topic)(nil), "emissions.v4.Topic")
	proto.RegisterType((*TopicList)(nil), "emissions.v4.TopicList")
	proto.RegisterType((*TimestampedActorNonce)(nil), "emissions.v4.TimestampedActorNonce")
	proto.RegisterType((*TopicIds)(nil), "emissions.v4.TopicIds")
	proto.RegisterType((*TopicIdWeightPair)(nil), "emissions.v4.TopicIdWeightPair")
}

func init() { proto.RegisterFile("emissions/v4/topic.proto", fileDescriptor_aa075a2dfa8a6cad) }

var fileDescriptor_aa075a2dfa8a6cad = []byte{
	...
	,
}
