...
type GenesisState struct {
	...
	// EPOCH LABEL REGISTRIES
	// map of (topic, block_height) -> temporary or final EpochLabelRegistry
	TopicLabelRegistries []*TopicIdBlockHeightEpochLabelRegistry `protobuf:"bytes,101,rep,name=topic_label_registries,json=topicLabelRegistries,proto3" json:"topic_label_registries,omitempty"`
	// Last allocated epoch NonceV2 per topic (map of topic_id -> nonce).
	TopicLastEpochNonces []*TopicIdAndEpochNonce `protobuf:"bytes,102,rep,name=topic_last_epoch_nonces,json=topicLastEpochNonces,proto3" json:"topic_last_epoch_nonces,omitempty"`
	// MONTHLY REWARDS
...
func (m *GenesisState) GetTopicLabelRegistries() []*TopicIdBlockHeightEpochLabelRegistry {
	if m != nil {
		return m.TopicLabelRegistries
	}
	return nil
}

func (m *GenesisState) GetTopicLastEpochNonces() []*TopicIdAndEpochNonce {
	if m != nil {
		return m.TopicLastEpochNonces
	}
	return nil
}
...
type TopicIdAndEpochNonce struct {
	TopicId uint64 `protobuf:"varint,1,opt,name=topic_id,json=topicId,proto3" json:"topic_id,omitempty"`
	// Last allocated epoch nonce for the topic (NonceV2 encoded as uint64).
	Nonce NonceV2 `protobuf:"varint,2,opt,name=nonce,proto3,customtype=NonceV2" json:"nonce"`
}

func (m *TopicIdAndEpochNonce) Reset()         { *m = TopicIdAndEpochNonce{} }
func (m *TopicIdAndEpochNonce) String() string { return proto.CompactTextString(m) }
func (*TopicIdAndEpochNonce) ProtoMessage()    {}
func (*TopicIdAndEpochNonce) Descriptor() ([]byte, []int) {
	return fileDescriptor_c2017374dc45a41f, []int{4}
}
func (m *TopicIdAndEpochNonce) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *TopicIdAndEpochNonce) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_TopicIdAndEpochNonce.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *TopicIdAndEpochNonce) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TopicIdAndEpochNonce.Merge(m, src)
}
func (m *TopicIdAndEpochNonce) XXX_Size() int {
	return m.Size()
}
func (m *TopicIdAndEpochNonce) XXX_DiscardUnknown() {
	xxx_messageInfo_TopicIdAndEpochNonce.DiscardUnknown(m)
}

var xxx_messageInfo_TopicIdAndEpochNonce proto.InternalMessageInfo

func (m *TopicIdAndEpochNonce) GetTopicId() uint64 {
	if m != nil {
		return m.TopicId
	}
	return 0
...
type TopicIdBlockHeightEpochLabelRegistry struct {
	TopicId            uint64              `protobuf:"varint,1,opt,name=topic_id,json=topicId,proto3" json:"topic_id,omitempty"`
	BlockHeight        int64               `protobuf:"varint,2,opt,name=block_height,json=blockHeight,proto3" json:"block_height,omitempty"`
	EpochLabelRegistry *EpochLabelRegistry `protobuf:"bytes,3,opt,name=epoch_label_registry,json=epochLabelRegistry,proto3" json:"epoch_label_registry,omitempty"`
}

func (m *TopicIdBlockHeightEpochLabelRegistry) Reset()         { *m = TopicIdBlockHeightEpochLabelRegistry{} }
func (m *TopicIdBlockHeightEpochLabelRegistry) String() string { return proto.CompactTextString(m) }
func (*TopicIdBlockHeightEpochLabelRegistry) ProtoMessage()    {}
func (*TopicIdBlockHeightEpochLabelRegistry) Descriptor() ([]byte, []int) {
	return fileDescriptor_c2017374dc45a41f, []int{23}
}
func (m *TopicIdBlockHeightEpochLabelRegistry) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *TopicIdBlockHeightEpochLabelRegistry) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_TopicIdBlockHeightEpochLabelRegistry.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *TopicIdBlockHeightEpochLabelRegistry) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TopicIdBlockHeightEpochLabelRegistry.Merge(m, src)
}
func (m *TopicIdBlockHeightEpochLabelRegistry) XXX_Size() int {
	return m.Size()
}
func (m *TopicIdBlockHeightEpochLabelRegistry) XXX_DiscardUnknown() {
	xxx_messageInfo_TopicIdBlockHeightEpochLabelRegistry.DiscardUnknown(m)
}

var xxx_messageInfo_TopicIdBlockHeightEpochLabelRegistry proto.InternalMessageInfo

func (m *TopicIdBlockHeightEpochLabelRegistry) GetTopicId() uint64 {
	if m != nil {
		return m.TopicId
	}
	return 0
...
func (m *TopicIdBlockHeightEpochLabelRegistry) GetBlockHeight() int64 {
	if m != nil {
		return m.BlockHeight
	}
	return 0
...
func (m *TopicIdBlockHeightEpochLabelRegistry) GetEpochLabelRegistry() *EpochLabelRegistry {
	if m != nil {
		return m.EpochLabelRegistry
	}
	return nil
}
...
func init() {
	...
	proto.RegisterType((*TopicIdAndEpochNonce)(nil), "emissions.v10.TopicIdAndEpochNonce")
	...
	proto.RegisterType((*TopicIdBlockHeightEpochLabelRegistry)(nil), "emissions.v10.TopicIdBlockHeightEpochLabelRegistry")
...
var fileDescriptor_c2017374dc45a41f = []byte{
	...
	,
}
...
func (m *GenesisState) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.TopicLastEpochNonces) > 0 {
		for iNdEx := len(m.TopicLastEpochNonces) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.TopicLastEpochNonces[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	if len(m.TopicLabelRegistries) > 0 {
		for iNdEx := len(m.TopicLabelRegistries) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.TopicLabelRegistries[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *TopicIdAndEpochNonce) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *TopicIdAndEpochNonce) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TopicIdAndEpochNonce) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *TopicIdBlockHeightEpochLabelRegistry) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *TopicIdBlockHeightEpochLabelRegistry) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TopicIdBlockHeightEpochLabelRegistry) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.EpochLabelRegistry != nil {
		{
			size, err := m.EpochLabelRegistry.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *GenesisState) Size() (n int) {
	...
	if len(m.TopicLabelRegistries) > 0 {
		for _, e := range m.TopicLabelRegistries {
			l = e.Size()
			n += 2 + l + sovGenesis(uint64(l))
		}
	}
	if len(m.TopicLastEpochNonces) > 0 {
		for _, e := range m.TopicLastEpochNonces {
			l = e.Size()
			n += 2 + l + sovGenesis(uint64(l))
		}
	}
...
func (m *TopicIdAndEpochNonce) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *TopicIdBlockHeightEpochLabelRegistry) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GenesisState) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 101:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TopicLabelRegistries", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.TopicLabelRegistries = append(m.TopicLabelRegistries, &TopicIdBlockHeightEpochLabelRegistry{})
			if err := m.TopicLabelRegistries[len(m.TopicLabelRegistries)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 102:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TopicLastEpochNonces", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.TopicLastEpochNonces = append(m.TopicLastEpochNonces, &TopicIdAndEpochNonce{})
			if err := m.TopicLastEpochNonces[len(m.TopicLastEpochNonces)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *TopicIdAndEpochNonce) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TopicIdAndEpochNonce: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TopicIdAndEpochNonce: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *TopicIdBlockHeightEpochLabelRegistry) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TopicIdBlockHeightEpochLabelRegistry: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TopicIdBlockHeightEpochLabelRegistry: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field EpochLabelRegistry", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.EpochLabelRegistry == nil {
				m.EpochLabelRegistry = &EpochLabelRegistry{}
			}
			if err := m.EpochLabelRegistry.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
