...
// source: emissions/v10/genesis.proto
...
type GenesisState struct {
	...
	/// MISC GLOBAL STATE
	// Deprecated: migrated to worker_latest_input_inferences in the v15
	// migration. Kept for backwards-compatible genesis round-trip of any
	// in-flight entries captured pre-migration; will always be empty once the
	// chain has applied the v15 upgrade handler.
	// map of (topic, worker) -> inference
	Inferences []*TopicIdActorIdInference `protobuf:"bytes,32,rep,name=inferences,proto3" json:"inferences,omitempty"` // Deprecated: Do not use.
	...
	// REGRET STDNORM
	LatestRegretStdNorm []*TopicIdAndDec `protobuf:"bytes,92,rep,name=latest_regret_std_norm,json=latestRegretStdNorm,proto3" json:"latest_regret_std_norm,omitempty"`
	// WEIGHTS
	LatestInfererWeights    []*TopicIdActorIdDec `protobuf:"bytes,93,rep,name=latest_inferer_weights,json=latestInfererWeights,proto3" json:"latest_inferer_weights,omitempty"`
	LatestForecasterWeights []*TopicIdActorIdDec `protobuf:"bytes,94,rep,name=latest_forecaster_weights,json=latestForecasterWeights,proto3" json:"latest_forecaster_weights,omitempty"`
	// NETWORK INFERENCES
	...
	NetworkInferenceBundle                 []*TopicIdBlockHeightNetworkInferenceBundles `protobuf:"bytes,99,rep,name=network_inference_bundle,json=networkInferenceBundle,proto3" json:"network_inference_bundle,omitempty"`
	OutlierResistantNetworkInferenceBundle []*TopicIdBlockHeightNetworkInferenceBundles `protobuf:"bytes,100,rep,name=outlier_resistant_network_inference_bundle,json=outlierResistantNetworkInferenceBundle,proto3" json:"outlier_resistant_network_inference_bundle,omitempty"`
	// MONTHLY REWARDS
	MonthlyReputerRewards cosmossdk_io_math.Int `protobuf:"bytes,97,opt,name=monthly_reputer_rewards,json=monthlyReputerRewards,proto3,customtype=cosmossdk.io/math.Int" json:"monthly_reputer_rewards"`
	...
	// EPOCH LABEL REGISTRY v2
	// Per-worker staged raw submissions (post-canonicalization) written during
	// the worker submission window. Replaces the legacy `inferences` map at
	// runtime; on every CloseWorkerNonce this is drained and the active-set
	// entries are materialized into Inference vectors aligned to the committed
	// EpochLabelRegistry.
	WorkerLatestInputInferences []*TopicIdActorIdInputInference `protobuf:"bytes,101,rep,name=worker_latest_input_inferences,json=workerLatestInputInferences,proto3" json:"worker_latest_input_inferences,omitempty"`
	// Per-(topic, nonce, label) refcount of how many active inferers are
	// currently using a given canonical label inside the open submission window.
	// Feeds the deterministic lex-sort that builds the EpochLabelRegistry at
	// close time. Cleared after CloseWorkerNonce.
	ActiveInfererLabelRefcount []*TopicIdBlockHeightLabelRefCount `protobuf:"bytes,102,rep,name=active_inferer_label_refcount,json=activeInfererLabelRefcount,proto3" json:"active_inferer_label_refcount,omitempty"`
}
...
func (*GenesisState) Descriptor() ([]byte, []int) {
	return fileDescriptor_c2017374dc45a41f, []int{0}
}
...
func (m *GenesisState) GetLatestRegretStdNorm() []*TopicIdAndDec {
	if m != nil {
		return m.LatestRegretStdNorm
	}
	return nil
}

func (m *GenesisState) GetLatestInfererWeights() []*TopicIdActorIdDec {
	if m != nil {
...
func (m *GenesisState) GetLatestForecasterWeights() []*TopicIdActorIdDec {
	if m != nil {
...
func (m *GenesisState) GetNetworkInferences() []*TopicIdBlockHeightValueBundles {
	if m != nil {
...
func (m *GenesisState) GetOutlierResistantNetworkInferences() []*TopicIdBlockHeightValueBundles {
	if m != nil {
		return m.OutlierResistantNetworkInferences
	}
	return nil
}

func (m *GenesisState) GetNetworkInferenceBundle() []*TopicIdBlockHeightNetworkInferenceBundles {
	if m != nil {
		return m.NetworkInferenceBundle
	}
	return nil
}

func (m *GenesisState) GetOutlierResistantNetworkInferenceBundle() []*TopicIdBlockHeightNetworkInferenceBundles {
	if m != nil {
		return m.OutlierResistantNetworkInferenceBundle
	}
	return nil
}

func (m *GenesisState) GetWorkerLatestInputInferences() []*TopicIdActorIdInputInference {
	if m != nil {
		return m.WorkerLatestInputInferences
	}
	return nil
}

func (m *GenesisState) GetActiveInfererLabelRefcount() []*TopicIdBlockHeightLabelRefCount {
	if m != nil {
		return m.ActiveInfererLabelRefcount
	}
	return nil
}
...
func (*TopicIdAndTopic) Descriptor() ([]byte, []int) {
	return fileDescriptor_c2017374dc45a41f, []int{1}
}
...
func (*TopicAndActorId) Descriptor() ([]byte, []int) {
	return fileDescriptor_c2017374dc45a41f, []int{2}
}
...
func (*TopicIdAndBlockHeight) Descriptor() ([]byte, []int) {
	return fileDescriptor_c2017374dc45a41f, []int{3}
}
...
func (*BlockHeightAndTopicIds) Descriptor() ([]byte, []int) {
	return fileDescriptor_c2017374dc45a41f, []int{4}
}
...
func (*TopicIdBlockHeightScores) Descriptor() ([]byte, []int) {
	return fileDescriptor_c2017374dc45a41f, []int{5}
}
...
func (*TopicIdActorIdScore) Descriptor() ([]byte, []int) {
	return fileDescriptor_c2017374dc45a41f, []int{6}
}
...
func (*TopicIdActorIdUint64) Descriptor() ([]byte, []int) {
	return fileDescriptor_c2017374dc45a41f, []int{7}
}
...
func (*TopicIdActorIdListeningCoefficient) Descriptor() ([]byte, []int) {
	return fileDescriptor_c2017374dc45a41f, []int{8}
}
...
func (*TopicIdActorIdDec) Descriptor() ([]byte, []int) {
	return fileDescriptor_c2017374dc45a41f, []int{9}
}
...
func (*TopicIdAndInt) Descriptor() ([]byte, []int) {
	return fileDescriptor_c2017374dc45a41f, []int{10}
}
...
func (*TopicIdActorIdInt) Descriptor() ([]byte, []int) {
	return fileDescriptor_c2017374dc45a41f, []int{11}
}
...
func (*TopicIdDelegatorReputerDelegatorInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_c2017374dc45a41f, []int{12}
}
...
func (*BlockHeightTopicIdReputerStakeRemovalInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_c2017374dc45a41f, []int{13}
}
...
func (*ActorIdTopicIdBlockHeight) Descriptor() ([]byte, []int) {
	return fileDescriptor_c2017374dc45a41f, []int{14}
}
...
func (*BlockHeightTopicIdDelegatorReputerDelegateStakeRemovalInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_c2017374dc45a41f, []int{15}
}
...
func (*DelegatorReputerTopicIdBlockHeight) Descriptor() ([]byte, []int) {
	return fileDescriptor_c2017374dc45a41f, []int{16}
}
...
func (*TopicIdActorIdInference) Descriptor() ([]byte, []int) {
	return fileDescriptor_c2017374dc45a41f, []int{17}
}
...
// Per-worker staged input inference, used by
// GenesisState.worker_latest_input_inferences to round-trip the
// workerLatestInputInferences store across genesis.
type TopicIdActorIdInputInference struct {
	TopicId        uint64          `protobuf:"varint,1,opt,name=topic_id,json=topicId,proto3" json:"topic_id,omitempty"`
	ActorId        string          `protobuf:"bytes,2,opt,name=actor_id,json=actorId,proto3" json:"actor_id,omitempty"`
	InputInference *InputInference `protobuf:"bytes,3,opt,name=input_inference,json=inputInference,proto3" json:"input_inference,omitempty"`
}

func (m *TopicIdActorIdInputInference) Reset()         { *m = TopicIdActorIdInputInference{} }
func (m *TopicIdActorIdInputInference) String() string { return proto.CompactTextString(m) }
func (*TopicIdActorIdInputInference) ProtoMessage()    {}
func (*TopicIdActorIdInputInference) Descriptor() ([]byte, []int) {
	return fileDescriptor_c2017374dc45a41f, []int{18}
}
func (m *TopicIdActorIdInputInference) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *TopicIdActorIdInputInference) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_TopicIdActorIdInputInference.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *TopicIdActorIdInputInference) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TopicIdActorIdInputInference.Merge(m, src)
}
func (m *TopicIdActorIdInputInference) XXX_Size() int {
	return m.Size()
}
func (m *TopicIdActorIdInputInference) XXX_DiscardUnknown() {
	xxx_messageInfo_TopicIdActorIdInputInference.DiscardUnknown(m)
}

var xxx_messageInfo_TopicIdActorIdInputInference proto.InternalMessageInfo

func (m *TopicIdActorIdInputInference) GetTopicId() uint64 {
	if m != nil {
		return m.TopicId
	}
	return 0
...
func (m *TopicIdActorIdInputInference) GetActorId() string {
	if m != nil {
		return m.ActorId
	}
	return ""
...
func (m *TopicIdActorIdInputInference) GetInputInference() *InputInference {
	if m != nil {
		return m.InputInference
	}
	return nil
}

// One refcount row for a given canonical label inside an open worker
// submission window, used by GenesisState.active_inferer_label_refcount to
// round-trip the activeInfererLabelRefCount store across genesis.
type TopicIdBlockHeightLabelRefCount struct {
	TopicId     uint64 `protobuf:"varint,1,opt,name=topic_id,json=topicId,proto3" json:"topic_id,omitempty"`
	BlockHeight int64  `protobuf:"varint,2,opt,name=block_height,json=blockHeight,proto3" json:"block_height,omitempty"`
...
func (m *TopicIdBlockHeightLabelRefCount) Reset()         { *m = TopicIdBlockHeightLabelRefCount{} }
func (m *TopicIdBlockHeightLabelRefCount) String() string { return proto.CompactTextString(m) }
func (*TopicIdBlockHeightLabelRefCount) ProtoMessage()    {}
func (*TopicIdBlockHeightLabelRefCount) Descriptor() ([]byte, []int) {
	return fileDescriptor_c2017374dc45a41f, []int{19}
}
func (m *TopicIdBlockHeightLabelRefCount) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *TopicIdBlockHeightLabelRefCount) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_TopicIdBlockHeightLabelRefCount.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *TopicIdBlockHeightLabelRefCount) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TopicIdBlockHeightLabelRefCount.Merge(m, src)
}
func (m *TopicIdBlockHeightLabelRefCount) XXX_Size() int {
	return m.Size()
}
func (m *TopicIdBlockHeightLabelRefCount) XXX_DiscardUnknown() {
	xxx_messageInfo_TopicIdBlockHeightLabelRefCount.DiscardUnknown(m)
}

var xxx_messageInfo_TopicIdBlockHeightLabelRefCount proto.InternalMessageInfo

func (m *TopicIdBlockHeightLabelRefCount) GetTopicId() uint64 {
	if m != nil {
		return m.TopicId
	}
	return 0
...
func (m *TopicIdBlockHeightLabelRefCount) GetBlockHeight() int64 {
	if m != nil {
		return m.BlockHeight
	}
	return 0
...
func (m *TopicIdBlockHeightLabelRefCount) GetLabel() string {
	if m != nil {
		return m.Label
	}
	return ""
...
func (m *TopicIdBlockHeightLabelRefCount) GetCount() uint64 {
	if m != nil {
		return m.Count
	}
	return 0
...
func (*TopicIdActorIdForecast) Descriptor() ([]byte, []int) {
	return fileDescriptor_c2017374dc45a41f, []int{20}
}
...
func (*LibP2PKeyAndOffchainNode) Descriptor() ([]byte, []int) {
	return fileDescriptor_c2017374dc45a41f, []int{21}
}
...
func (*TopicIdAndDec) Descriptor() ([]byte, []int) {
	return fileDescriptor_c2017374dc45a41f, []int{22}
}
...
func (*TopicIdBlockHeightInferences) Descriptor() ([]byte, []int) {
	return fileDescriptor_c2017374dc45a41f, []int{23}
}
...
func (*TopicIdBlockHeightForecasts) Descriptor() ([]byte, []int) {
	return fileDescriptor_c2017374dc45a41f, []int{24}
}
...
func (*TopicIdBlockHeightReputerValueBundles) Descriptor() ([]byte, []int) {
	return fileDescriptor_c2017374dc45a41f, []int{25}
}
...
func (*TopicIdBlockHeightValueBundles) Descriptor() ([]byte, []int) {
	return fileDescriptor_c2017374dc45a41f, []int{26}
}
...
type TopicIdBlockHeightNetworkInferenceBundles struct {
	TopicId                uint64                  `protobuf:"varint,1,opt,name=topic_id,json=topicId,proto3" json:"topic_id,omitempty"`
	BlockHeight            int64                   `protobuf:"varint,2,opt,name=block_height,json=blockHeight,proto3" json:"block_height,omitempty"`
	NetworkInferenceBundle *NetworkInferenceBundle `protobuf:"bytes,3,opt,name=network_inference_bundle,json=networkInferenceBundle,proto3" json:"network_inference_bundle,omitempty"`
}

func (m *TopicIdBlockHeightNetworkInferenceBundles) Reset() {
	*m = TopicIdBlockHeightNetworkInferenceBundles{}
}
func (m *TopicIdBlockHeightNetworkInferenceBundles) String() string {
	return proto.CompactTextString(m)
}
func (*TopicIdBlockHeightNetworkInferenceBundles) ProtoMessage() {}
func (*TopicIdBlockHeightNetworkInferenceBundles) Descriptor() ([]byte, []int) {
	return fileDescriptor_c2017374dc45a41f, []int{27}
}
func (m *TopicIdBlockHeightNetworkInferenceBundles) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *TopicIdBlockHeightNetworkInferenceBundles) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_TopicIdBlockHeightNetworkInferenceBundles.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *TopicIdBlockHeightNetworkInferenceBundles) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TopicIdBlockHeightNetworkInferenceBundles.Merge(m, src)
}
func (m *TopicIdBlockHeightNetworkInferenceBundles) XXX_Size() int {
	return m.Size()
}
func (m *TopicIdBlockHeightNetworkInferenceBundles) XXX_DiscardUnknown() {
	xxx_messageInfo_TopicIdBlockHeightNetworkInferenceBundles.DiscardUnknown(m)
}

var xxx_messageInfo_TopicIdBlockHeightNetworkInferenceBundles proto.InternalMessageInfo

func (m *TopicIdBlockHeightNetworkInferenceBundles) GetTopicId() uint64 {
	if m != nil {
		return m.TopicId
	}
	return 0
...
func (m *TopicIdBlockHeightNetworkInferenceBundles) GetBlockHeight() int64 {
	if m != nil {
		return m.BlockHeight
	}
	return 0
...
func (m *TopicIdBlockHeightNetworkInferenceBundles) GetNetworkInferenceBundle() *NetworkInferenceBundle {
	if m != nil {
		return m.NetworkInferenceBundle
	}
	return nil
...
func (*TopicIdAndNonces) Descriptor() ([]byte, []int) {
	return fileDescriptor_c2017374dc45a41f, []int{28}
}
...
func (*TopicIdAndReputerRequestNonces) Descriptor() ([]byte, []int) {
	return fileDescriptor_c2017374dc45a41f, []int{29}
}
...
func (*TopicIdActorIdTimeStampedValue) Descriptor() ([]byte, []int) {
	return fileDescriptor_c2017374dc45a41f, []int{30}
}
...
func (*TopicIdActorIdActorIdTimeStampedValue) Descriptor() ([]byte, []int) {
	return fileDescriptor_c2017374dc45a41f, []int{31}
}
...
func (*TopicIdTimestampedActorNonce) Descriptor() ([]byte, []int) {
	return fileDescriptor_c2017374dc45a41f, []int{32}
}
...
func (*BlockHeightTopicIds) Descriptor() ([]byte, []int) {
	return fileDescriptor_c2017374dc45a41f, []int{33}
}
...
func (*BlockHeightTopicIdWeightPair) Descriptor() ([]byte, []int) {
	return fileDescriptor_c2017374dc45a41f, []int{34}
}
...
func (*TopicIdReputerReputerValueBundle) Descriptor() ([]byte, []int) {
	return fileDescriptor_c2017374dc45a41f, []int{35}
}
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "emissions.v10.GenesisState")
	proto.RegisterType((*TopicIdAndTopic)(nil), "emissions.v10.TopicIdAndTopic")
	proto.RegisterType((*TopicAndActorId)(nil), "emissions.v10.TopicAndActorId")
	proto.RegisterType((*TopicIdAndBlockHeight)(nil), "emissions.v10.TopicIdAndBlockHeight")
	proto.RegisterType((*BlockHeightAndTopicIds)(nil), "emissions.v10.BlockHeightAndTopicIds")
	proto.RegisterType((*TopicIdBlockHeightScores)(nil), "emissions.v10.TopicIdBlockHeightScores")
	proto.RegisterType((*TopicIdActorIdScore)(nil), "emissions.v10.TopicIdActorIdScore")
	proto.RegisterType((*TopicIdActorIdUint64)(nil), "emissions.v10.TopicIdActorIdUint64")
	proto.RegisterType((*TopicIdActorIdListeningCoefficient)(nil), "emissions.v10.TopicIdActorIdListeningCoefficient")
	proto.RegisterType((*TopicIdActorIdDec)(nil), "emissions.v10.TopicIdActorIdDec")
	proto.RegisterType((*TopicIdAndInt)(nil), "emissions.v10.TopicIdAndInt")
	proto.RegisterType((*TopicIdActorIdInt)(nil), "emissions.v10.TopicIdActorIdInt")
	proto.RegisterType((*TopicIdDelegatorReputerDelegatorInfo)(nil), "emissions.v10.TopicIdDelegatorReputerDelegatorInfo")
	proto.RegisterType((*BlockHeightTopicIdReputerStakeRemovalInfo)(nil), "emissions.v10.BlockHeightTopicIdReputerStakeRemovalInfo")
	proto.RegisterType((*ActorIdTopicIdBlockHeight)(nil), "emissions.v10.ActorIdTopicIdBlockHeight")
	proto.RegisterType((*BlockHeightTopicIdDelegatorReputerDelegateStakeRemovalInfo)(nil), "emissions.v10.BlockHeightTopicIdDelegatorReputerDelegateStakeRemovalInfo")
	proto.RegisterType((*DelegatorReputerTopicIdBlockHeight)(nil), "emissions.v10.DelegatorReputerTopicIdBlockHeight")
	proto.RegisterType((*TopicIdActorIdInference)(nil), "emissions.v10.TopicIdActorIdInference")
	proto.RegisterType((*TopicIdActorIdInputInference)(nil), "emissions.v10.TopicIdActorIdInputInference")
	proto.RegisterType((*TopicIdBlockHeightLabelRefCount)(nil), "emissions.v10.TopicIdBlockHeightLabelRefCount")
	proto.RegisterType((*TopicIdActorIdForecast)(nil), "emissions.v10.TopicIdActorIdForecast")
	proto.RegisterType((*LibP2PKeyAndOffchainNode)(nil), "emissions.v10.LibP2pKeyAndOffchainNode")
	proto.RegisterType((*TopicIdAndDec)(nil), "emissions.v10.TopicIdAndDec")
	proto.RegisterType((*TopicIdBlockHeightInferences)(nil), "emissions.v10.TopicIdBlockHeightInferences")
	proto.RegisterType((*TopicIdBlockHeightForecasts)(nil), "emissions.v10.TopicIdBlockHeightForecasts")
	proto.RegisterType((*TopicIdBlockHeightReputerValueBundles)(nil), "emissions.v10.TopicIdBlockHeightReputerValueBundles")
	proto.RegisterType((*TopicIdBlockHeightValueBundles)(nil), "emissions.v10.TopicIdBlockHeightValueBundles")
	proto.RegisterType((*TopicIdBlockHeightNetworkInferenceBundles)(nil), "emissions.v10.TopicIdBlockHeightNetworkInferenceBundles")
	proto.RegisterType((*TopicIdAndNonces)(nil), "emissions.v10.TopicIdAndNonces")
	proto.RegisterType((*TopicIdAndReputerRequestNonces)(nil), "emissions.v10.TopicIdAndReputerRequestNonces")
	proto.RegisterType((*TopicIdActorIdTimeStampedValue)(nil), "emissions.v10.TopicIdActorIdTimeStampedValue")
	proto.RegisterType((*TopicIdActorIdActorIdTimeStampedValue)(nil), "emissions.v10.TopicIdActorIdActorIdTimeStampedValue")
	proto.RegisterType((*TopicIdTimestampedActorNonce)(nil), "emissions.v10.TopicIdTimestampedActorNonce")
	proto.RegisterType((*BlockHeightTopicIds)(nil), "emissions.v10.BlockHeightTopicIds")
	proto.RegisterType((*BlockHeightTopicIdWeightPair)(nil), "emissions.v10.BlockHeightTopicIdWeightPair")
	proto.RegisterType((*TopicIdReputerReputerValueBundle)(nil), "emissions.v10.TopicIdReputerReputerValueBundle")
}

func init() { proto.RegisterFile("emissions/v10/genesis.proto", fileDescriptor_c2017374dc45a41f) }

var fileDescriptor_c2017374dc45a41f = []byte{
	// 3758 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *GenesisState) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.ActiveInfererLabelRefcount) > 0 {
		for iNdEx := len(m.ActiveInfererLabelRefcount) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.ActiveInfererLabelRefcount[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	if len(m.WorkerLatestInputInferences) > 0 {
		for iNdEx := len(m.WorkerLatestInputInferences) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.WorkerLatestInputInferences[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	if len(m.OutlierResistantNetworkInferenceBundle) > 0 {
		for iNdEx := len(m.OutlierResistantNetworkInferenceBundle) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.OutlierResistantNetworkInferenceBundle[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	if len(m.NetworkInferenceBundle) > 0 {
		for iNdEx := len(m.NetworkInferenceBundle) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.NetworkInferenceBundle[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	{
		size := m.MonthlyTopicRewards.Size()
		i -= size
		if _, err := m.MonthlyTopicRewards.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
		i = encodeVarintGenesis(dAtA, i, uint64(size))
	}
	...
	dAtA[i] = 0x92
	{
		size := m.MonthlyReputerRewards.Size()
		i -= size
		if _, err := m.MonthlyReputerRewards.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
		i = encodeVarintGenesis(dAtA, i, uint64(size))
	}
	...
	i--
	dAtA[i] = 0x8a
	if len(m.OutlierResistantNetworkInferences) > 0 {
		for iNdEx := len(m.OutlierResistantNetworkInferences) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.OutlierResistantNetworkInferences[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	if len(m.NetworkInferences) > 0 {
		for iNdEx := len(m.NetworkInferences) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.NetworkInferences[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	if len(m.LatestForecasterWeights) > 0 {
		for iNdEx := len(m.LatestForecasterWeights) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.LatestForecasterWeights[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	if len(m.LatestInfererWeights) > 0 {
		for iNdEx := len(m.LatestInfererWeights) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.LatestInfererWeights[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	if len(m.LatestRegretStdNorm) > 0 {
		for iNdEx := len(m.LatestRegretStdNorm) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.LatestRegretStdNorm[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *TopicIdActorIdInputInference) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *TopicIdActorIdInputInference) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TopicIdActorIdInputInference) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.InputInference != nil {
		{
			size, err := m.InputInference.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *TopicIdBlockHeightLabelRefCount) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *TopicIdBlockHeightLabelRefCount) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TopicIdBlockHeightLabelRefCount) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *TopicIdBlockHeightNetworkInferenceBundles) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *TopicIdBlockHeightNetworkInferenceBundles) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TopicIdBlockHeightNetworkInferenceBundles) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.NetworkInferenceBundle != nil {
		{
			size, err := m.NetworkInferenceBundle.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *GenesisState) Size() (n int) {
	...
	if len(m.LatestRegretStdNorm) > 0 {
		for _, e := range m.LatestRegretStdNorm {
			l = e.Size()
			n += 2 + l + sovGenesis(uint64(l))
		}
	}
	if len(m.LatestInfererWeights) > 0 {
		for _, e := range m.LatestInfererWeights {
			l = e.Size()
			n += 2 + l + sovGenesis(uint64(l))
		}
	}
	if len(m.LatestForecasterWeights) > 0 {
		for _, e := range m.LatestForecasterWeights {
			l = e.Size()
			n += 2 + l + sovGenesis(uint64(l))
		}
	}
	if len(m.NetworkInferences) > 0 {
		for _, e := range m.NetworkInferences {
			l = e.Size()
			n += 2 + l + sovGenesis(uint64(l))
		}
	}
	if len(m.OutlierResistantNetworkInferences) > 0 {
		for _, e := range m.OutlierResistantNetworkInferences {
			l = e.Size()
			n += 2 + l + sovGenesis(uint64(l))
		}
	}
	l = m.MonthlyReputerRewards.Size()
	n += 2 + l + sovGenesis(uint64(l))
	l = m.MonthlyTopicRewards.Size()
	n += 2 + l + sovGenesis(uint64(l))
	if len(m.NetworkInferenceBundle) > 0 {
		for _, e := range m.NetworkInferenceBundle {
			l = e.Size()
			n += 2 + l + sovGenesis(uint64(l))
		}
	}
	if len(m.OutlierResistantNetworkInferenceBundle) > 0 {
		for _, e := range m.OutlierResistantNetworkInferenceBundle {
			l = e.Size()
			n += 2 + l + sovGenesis(uint64(l))
		}
	}
	if len(m.WorkerLatestInputInferences) > 0 {
		for _, e := range m.WorkerLatestInputInferences {
			l = e.Size()
			n += 2 + l + sovGenesis(uint64(l))
		}
	}
	if len(m.ActiveInfererLabelRefcount) > 0 {
		for _, e := range m.ActiveInfererLabelRefcount {
			l = e.Size()
			n += 2 + l + sovGenesis(uint64(l))
		}
	}
...
func (m *TopicIdActorIdInputInference) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.InputInference != nil {
		l = m.InputInference.Size()
		n += 1 + l + sovGenesis(uint64(l))
	}
	return n
}

func (m *TopicIdBlockHeightLabelRefCount) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *TopicIdBlockHeightNetworkInferenceBundles) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.NetworkInferenceBundle != nil {
		l = m.NetworkInferenceBundle.Size()
		n += 1 + l + sovGenesis(uint64(l))
	}
	return n
}
...
func (m *GenesisState) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 92:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field LatestRegretStdNorm", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.LatestRegretStdNorm = append(m.LatestRegretStdNorm, &TopicIdAndDec{})
			if err := m.LatestRegretStdNorm[len(m.LatestRegretStdNorm)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 93:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field LatestInfererWeights", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.LatestInfererWeights = append(m.LatestInfererWeights, &TopicIdActorIdDec{})
			if err := m.LatestInfererWeights[len(m.LatestInfererWeights)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 94:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field LatestForecasterWeights", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.LatestForecasterWeights = append(m.LatestForecasterWeights, &TopicIdActorIdDec{})
			if err := m.LatestForecasterWeights[len(m.LatestForecasterWeights)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 95:
			...
			m.NetworkInferences = append(m.NetworkInferences, &TopicIdBlockHeightValueBundles{})
			if err := m.NetworkInferences[len(m.NetworkInferences)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 96:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field OutlierResistantNetworkInferences", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.OutlierResistantNetworkInferences = append(m.OutlierResistantNetworkInferences, &TopicIdBlockHeightValueBundles{})
			if err := m.OutlierResistantNetworkInferences[len(m.OutlierResistantNetworkInferences)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 97:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MonthlyReputerRewards", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.MonthlyReputerRewards.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 98:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MonthlyTopicRewards", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.MonthlyTopicRewards.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 99:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field NetworkInferenceBundle", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.NetworkInferenceBundle = append(m.NetworkInferenceBundle, &TopicIdBlockHeightNetworkInferenceBundles{})
			if err := m.NetworkInferenceBundle[len(m.NetworkInferenceBundle)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 100:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field OutlierResistantNetworkInferenceBundle", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.OutlierResistantNetworkInferenceBundle = append(m.OutlierResistantNetworkInferenceBundle, &TopicIdBlockHeightNetworkInferenceBundles{})
			if err := m.OutlierResistantNetworkInferenceBundle[len(m.OutlierResistantNetworkInferenceBundle)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 101:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field WorkerLatestInputInferences", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.WorkerLatestInputInferences = append(m.WorkerLatestInputInferences, &TopicIdActorIdInputInference{})
			if err := m.WorkerLatestInputInferences[len(m.WorkerLatestInputInferences)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 102:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ActiveInfererLabelRefcount", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ActiveInfererLabelRefcount = append(m.ActiveInfererLabelRefcount, &TopicIdBlockHeightLabelRefCount{})
			if err := m.ActiveInfererLabelRefcount[len(m.ActiveInfererLabelRefcount)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *TopicIdActorIdInputInference) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TopicIdActorIdInputInference: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TopicIdActorIdInputInference: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field InputInference", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.InputInference == nil {
				m.InputInference = &InputInference{}
			}
			if err := m.InputInference.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *TopicIdBlockHeightLabelRefCount) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TopicIdBlockHeightLabelRefCount: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TopicIdBlockHeightLabelRefCount: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *TopicIdBlockHeightNetworkInferenceBundles) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TopicIdBlockHeightNetworkInferenceBundles: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TopicIdBlockHeightNetworkInferenceBundles: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 3:
			...
			if m.NetworkInferenceBundle == nil {
				m.NetworkInferenceBundle = &NetworkInferenceBundle{}
			}
			if err := m.NetworkInferenceBundle.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
