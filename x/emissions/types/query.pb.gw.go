...
var (
	...
	pattern_Query_GetDelegateStakePlacement_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 1, 0, 4, 1, 5, 4, 1, 0, 4, 1, 5, 5}, []string{"emissions", "v1", "delegate_stake_placement", "delegator_address", "reputer_address", "topic_id"}, "", runtime.AssumeColonVerbOpt(false)))
