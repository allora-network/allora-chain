...
var (
	...
	InfererScoreEmasByWorkerKey                 = collections.NewPrefix(46)
	ForecasterScoreEmasByWorkerKey              = collections.NewPrefix(47)
	ReputerScoreEmasByReputerKey                = collections.NewPrefix(48)
