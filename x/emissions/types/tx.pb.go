...
type OptionalParams struct {
	...
	// the chain logic.
	CNorm                               []github_com_allora_network_allora_chain_math.Dec `protobuf:"bytes,38,rep,name=c_norm,json=cNorm,proto3,customtype=github.com/allora-network/allora-chain/math.Dec" json:"c_norm"` // Deprecated: Do not use.
	...
	MinWeightThresholdForStdnorm        []github_com_allora_network_allora_chain_math.Dec `protobuf:"bytes,60,rep,name=min_weight_threshold_for_stdnorm,json=minWeightThresholdForStdnorm,proto3,customtype=github.com/allora-network/allora-chain/math.Dec" json:"min_weight_threshold_for_stdnorm"`
	// Max byte length of a canonical label name after NFC normalization and
	// trimming.
	MaxCanonicalLabelByteLength []uint64 `protobuf:"varint,61,rep,packed,name=max_canonical_label_byte_length,json=maxCanonicalLabelByteLength,proto3" json:"max_canonical_label_byte_length,omitempty"`
	MaxTopicLabelWhitelistSize  []uint64 `protobuf:"varint,62,rep,packed,name=max_topic_label_whitelist_size,json=maxTopicLabelWhitelistSize,proto3" json:"max_topic_label_whitelist_size,omitempty"`
	MaxEpochLabelRegistrySize   []uint64 `protobuf:"varint,63,rep,packed,name=max_epoch_label_registry_size,json=maxEpochLabelRegistrySize,proto3" json:"max_epoch_label_registry_size,omitempty"`
	// Floor for the per-topic inferer admission cap; zero means no floor.
	MinTopInferersToReward []uint64 `protobuf:"varint,64,rep,packed,name=min_top_inferers_to_reward,json=minTopInferersToReward,proto3" json:"min_top_inferers_to_reward,omitempty"`
}
...
func (*OptionalParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{0}
}
...
func (m *OptionalParams) GetMaxCanonicalLabelByteLength() []uint64 {
	if m != nil {
...
func (m *OptionalParams) GetMaxTopicLabelWhitelistSize() []uint64 {
	if m != nil {
...
func (m *OptionalParams) GetMaxEpochLabelRegistrySize() []uint64 {
	if m != nil {
...
func (m *OptionalParams) GetMinTopInferersToReward() []uint64 {
	if m != nil {
...
func (*UpdateParamsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{1}
}
...
func (*UpdateParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{2}
}
...
type CreateNewTopicRequest struct {
	...
	TopicType                TopicType                                       `protobuf:"varint,22,opt,name=topic_type,json=topicType,proto3,enum=emissions.v10.TopicType" json:"topic_type,omitempty"`
	...
	UnityTolerance           github_com_allora_network_allora_chain_math.Dec `protobuf:"bytes,25,opt,name=unity_tolerance,json=unityTolerance,proto3,customtype=github.com/allora-network/allora-chain/math.Dec" json:"unity_tolerance"`
	...
	// Default value for missing MULTI label slots. Submitted labels equal to
	// this value are treated as absent for registry inclusion.
	LabelDefaultValue github_com_allora_network_allora_chain_math.Dec `protobuf:"bytes,28,opt,name=label_default_value,json=labelDefaultValue,proto3,customtype=github.com/allora-network/allora-chain/math.Dec" json:"label_default_value"`
...
func (*CreateNewTopicRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{3}
}
...
func (m *CreateNewTopicRequest) GetTopicType() TopicType {
	if m != nil {
		return m.TopicType
	}
...
func (m *CreateNewTopicRequest) GetOutputArity() TopicOutputArity {
	if m != nil {
...
func (m *CreateNewTopicRequest) GetRequireUnity() bool {
	if m != nil {
...
func (m *CreateNewTopicRequest) GetMaxLabelsPerSubmission() uint64 {
	if m != nil {
...
func (m *CreateNewTopicRequest) GetLabelWhitelist() []string {
	if m != nil {
...
func (m *CreateNewTopicRequest) GetLabelCaseSensitive() bool {
	if m != nil {
...
func (m *CreateNewTopicRequest) GetMaxTopInferersToReward() uint64 {
	if m != nil {
		return m.MaxTopInferersToReward
	}
	return 0
...
func (*CreateNewTopicResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{4}
}
...
type UpdateTopicRequest struct {
	...
	LossMethod          string                                          `protobuf:"bytes,4,opt,name=loss_method,json=lossMethod,proto3" json:"loss_method,omitempty"`
	AlphaRegret         github_com_allora_network_allora_chain_math.Dec `protobuf:"bytes,5,opt,name=alpha_regret,json=alphaRegret,proto3,customtype=github.com/allora-network/allora-chain/math.Dec" json:"alpha_regret"`
	MeritSortitionAlpha github_com_allora_network_allora_chain_math.Dec `protobuf:"bytes,6,opt,name=merit_sortition_alpha,json=meritSortitionAlpha,proto3,customtype=github.com/allora-network/allora-chain/math.Dec" json:"merit_sortition_alpha"`
	...
	CNorm               github_com_allora_network_allora_chain_math.Dec `protobuf:"bytes,8,opt,name=c_norm,json=cNorm,proto3,customtype=github.com/allora-network/allora-chain/math.Dec" json:"c_norm"`
	...
	MaxLabelsPerSubmission uint64 `protobuf:"varint,9,opt,name=max_labels_per_submission,json=maxLabelsPerSubmission,proto3" json:"max_labels_per_submission,omitempty"`
	...
	LabelWhitelist []string `protobuf:"bytes,10,rep,name=label_whitelist,json=labelWhitelist,proto3" json:"label_whitelist,omitempty"`
...
func (*UpdateTopicRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{5}
}
...
func (m *UpdateTopicRequest) GetSender() string {
	if m != nil {
		return m.Sender
	}
	return ""
...
func (m *UpdateTopicRequest) GetTopicId() uint64 {
	if m != nil {
		return m.TopicId
	}
	return 0
...
func (m *UpdateTopicRequest) GetMetadata() string {
	if m != nil {
		return m.Metadata
	}
	return ""
...
func (m *UpdateTopicRequest) GetMaxLabelsPerSubmission() uint64 {
	if m != nil {
		return m.MaxLabelsPerSubmission
	}
	return 0
...
func (m *UpdateTopicRequest) GetLabelWhitelist() []string {
	if m != nil {
		return m.LabelWhitelist
	}
	return nil
...
func (m *UpdateTopicRequest) GetMaxTopInferersToReward() uint64 {
	if m != nil {
		return m.MaxTopInferersToReward
	}
	return 0
...
func (*UpdateTopicResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{6}
}
...
type InsertReputerPayloadRequest struct {
	Sender             string                   `protobuf:"bytes,1,opt,name=sender,proto3" json:"sender,omitempty"`
	ReputerValueBundle *InputReputerValueBundle `protobuf:"bytes,2,opt,name=reputer_value_bundle,json=reputerValueBundle,proto3" json:"reputer_value_bundle,omitempty"`
}
...
func (*InsertReputerPayloadRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{7}
}
...
func (m *InsertReputerPayloadRequest) GetReputerValueBundle() *InputReputerValueBundle {
	if m != nil {
...
func (*InsertReputerPayloadResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{8}
}
...
type InsertWorkerPayloadRequest struct {
	Sender           string                 `protobuf:"bytes,1,opt,name=sender,proto3" json:"sender,omitempty"`
	WorkerDataBundle *InputWorkerDataBundle `protobuf:"bytes,2,opt,name=worker_data_bundle,json=workerDataBundle,proto3" json:"worker_data_bundle,omitempty"`
}
...
func (*InsertWorkerPayloadRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{9}
}
...
func (m *InsertWorkerPayloadRequest) GetWorkerDataBundle() *InputWorkerDataBundle {
	if m != nil {
...
func (*InsertWorkerPayloadResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{10}
}
...
type TransferActorOwnershipRequest struct {
	Sender    string `protobuf:"bytes,1,opt,name=sender,proto3" json:"sender,omitempty"`
...
func (m *TransferActorOwnershipRequest) Reset()         { *m = TransferActorOwnershipRequest{} }
func (m *TransferActorOwnershipRequest) String() string { return proto.CompactTextString(m) }
func (*TransferActorOwnershipRequest) ProtoMessage()    {}
func (*TransferActorOwnershipRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{11}
}
func (m *TransferActorOwnershipRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *TransferActorOwnershipRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_TransferActorOwnershipRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *TransferActorOwnershipRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TransferActorOwnershipRequest.Merge(m, src)
}
func (m *TransferActorOwnershipRequest) XXX_Size() int {
	return m.Size()
}
func (m *TransferActorOwnershipRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_TransferActorOwnershipRequest.DiscardUnknown(m)
}

var xxx_messageInfo_TransferActorOwnershipRequest proto.InternalMessageInfo

func (m *TransferActorOwnershipRequest) GetSender() string {
	if m != nil {
		return m.Sender
	}
	return ""
...
func (m *TransferActorOwnershipRequest) GetNewOwner() string {
	if m != nil {
		return m.NewOwner
	}
	return ""
...
func (m *TransferActorOwnershipRequest) GetIsReputer() bool {
	if m != nil {
		return m.IsReputer
	}
	return false
...
type TransferActorOwnershipResponse struct {
}

func (m *TransferActorOwnershipResponse) Reset()         { *m = TransferActorOwnershipResponse{} }
func (m *TransferActorOwnershipResponse) String() string { return proto.CompactTextString(m) }
func (*TransferActorOwnershipResponse) ProtoMessage()    {}
func (*TransferActorOwnershipResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{12}
}
func (m *TransferActorOwnershipResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *TransferActorOwnershipResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_TransferActorOwnershipResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *TransferActorOwnershipResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TransferActorOwnershipResponse.Merge(m, src)
}
func (m *TransferActorOwnershipResponse) XXX_Size() int {
	return m.Size()
}
func (m *TransferActorOwnershipResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_TransferActorOwnershipResponse.DiscardUnknown(m)
}

var xxx_messageInfo_TransferActorOwnershipResponse proto.InternalMessageInfo
...
func (*RegisterRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{13}
}
...
type RegisterResponse struct {
	...
	Message string `protobuf:"bytes,2,opt,name=message,proto3" json:"message,omitempty"`  // Deprecated: Do not use.
}
...
func (*RegisterResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{14}
}
...
func (*RemoveRegistrationRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{15}
}
...
func (*RemoveRegistrationResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{16}
}
...
func (*AddStakeRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{17}
}
...
func (*AddStakeResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{18}
}
...
func (*RemoveStakeRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{19}
}
...
func (*RemoveStakeResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{20}
}
...
func (*CancelRemoveStakeRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{21}
}
...
func (*CancelRemoveStakeResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{22}
}
...
func (*DelegateStakeRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{23}
}
...
func (*DelegateStakeResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{24}
}
...
func (*RemoveDelegateStakeRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{25}
}
...
func (*RemoveDelegateStakeResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{26}
}
...
func (*CancelRemoveDelegateStakeRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{27}
}
...
func (*CancelRemoveDelegateStakeResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{28}
}
...
func (*RewardDelegateStakeRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{29}
}
...
func (*RewardDelegateStakeResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{30}
}
...
func (*FundTopicRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{31}
}
...
func (*FundTopicResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{32}
}
...
func (*AddToWhitelistAdminRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{33}
}
...
func (*AddToWhitelistAdminResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{34}
}
...
func (*RemoveFromWhitelistAdminRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{35}
}
...
func (*RemoveFromWhitelistAdminResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{36}
}
...
func (*EnableTopicWorkerWhitelistRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{37}
}
...
func (*EnableTopicWorkerWhitelistResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{38}
}
...
func (*DisableTopicWorkerWhitelistRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{39}
}
...
func (*DisableTopicWorkerWhitelistResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{40}
}
...
func (*EnableTopicReputerWhitelistRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{41}
}
...
func (*EnableTopicReputerWhitelistResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{42}
}
...
func (*DisableTopicReputerWhitelistRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{43}
}
...
func (*DisableTopicReputerWhitelistResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{44}
}
...
func (*AddToGlobalWhitelistRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{45}
}
...
func (*AddToGlobalWhitelistResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{46}
}
...
func (*RemoveFromGlobalWhitelistRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{47}
}
...
func (*RemoveFromGlobalWhitelistResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{48}
}
...
func (*AddToTopicCreatorWhitelistRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{49}
}
...
func (*AddToTopicCreatorWhitelistResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{50}
}
...
func (*AddToGlobalWorkerWhitelistRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{51}
}
...
func (*AddToGlobalWorkerWhitelistResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{52}
}
...
func (*RemoveFromGlobalWorkerWhitelistRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{53}
}
...
func (*RemoveFromGlobalWorkerWhitelistResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{54}
}
...
func (*AddToGlobalReputerWhitelistRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{55}
}
...
func (*AddToGlobalReputerWhitelistResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{56}
}
...
func (*RemoveFromGlobalReputerWhitelistRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{57}
}
...
func (*RemoveFromGlobalReputerWhitelistResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{58}
}
...
func (*AddToGlobalAdminWhitelistRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{59}
}
...
func (*AddToGlobalAdminWhitelistResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{60}
}
...
func (*RemoveFromGlobalAdminWhitelistRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{61}
}
...
func (*RemoveFromGlobalAdminWhitelistResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{62}
}
...
func (*BulkAddToGlobalWorkerWhitelistRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{63}
}
...
func (*BulkAddToGlobalWorkerWhitelistResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{64}
}
...
func (*BulkRemoveFromGlobalWorkerWhitelistRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{65}
}
...
func (*BulkRemoveFromGlobalWorkerWhitelistResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{66}
}
...
func (*BulkAddToGlobalReputerWhitelistRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{67}
}
...
func (*BulkAddToGlobalReputerWhitelistResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{68}
}
...
func (*BulkRemoveFromGlobalReputerWhitelistRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{69}
}
...
func (*BulkRemoveFromGlobalReputerWhitelistResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{70}
}
...
func (*BulkAddToTopicWorkerWhitelistRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{71}
}
...
func (*BulkAddToTopicWorkerWhitelistResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{72}
}
...
func (*BulkRemoveFromTopicWorkerWhitelistRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{73}
}
...
func (*BulkRemoveFromTopicWorkerWhitelistResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{74}
}
...
func (*BulkAddToTopicReputerWhitelistRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{75}
}
...
func (*BulkAddToTopicReputerWhitelistResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{76}
}
...
func (*BulkRemoveFromTopicReputerWhitelistRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{77}
}
...
func (*BulkRemoveFromTopicReputerWhitelistResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{78}
}
...
func (*RemoveFromTopicCreatorWhitelistRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{79}
}
...
func (*RemoveFromTopicCreatorWhitelistResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{80}
}
...
func (*AddToTopicWorkerWhitelistRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{81}
}
...
func (*AddToTopicWorkerWhitelistResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{82}
}
...
func (*RemoveFromTopicWorkerWhitelistRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{83}
}
...
func (*RemoveFromTopicWorkerWhitelistResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{84}
}
...
func (*AddToTopicReputerWhitelistRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{85}
}
...
func (*AddToTopicReputerWhitelistResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{86}
}
...
func (*RemoveFromTopicReputerWhitelistRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{87}
}
...
func (*RemoveFromTopicReputerWhitelistResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_2cbaaf648f37497a, []int{88}
}
...
func init() {
	proto.RegisterType((*OptionalParams)(nil), "emissions.v10.OptionalParams")
	proto.RegisterType((*UpdateParamsRequest)(nil), "emissions.v10.UpdateParamsRequest")
	proto.RegisterType((*UpdateParamsResponse)(nil), "emissions.v10.UpdateParamsResponse")
	proto.RegisterType((*CreateNewTopicRequest)(nil), "emissions.v10.CreateNewTopicRequest")
	proto.RegisterType((*CreateNewTopicResponse)(nil), "emissions.v10.CreateNewTopicResponse")
	proto.RegisterType((*UpdateTopicRequest)(nil), "emissions.v10.UpdateTopicRequest")
	proto.RegisterType((*UpdateTopicResponse)(nil), "emissions.v10.UpdateTopicResponse")
	proto.RegisterType((*InsertReputerPayloadRequest)(nil), "emissions.v10.InsertReputerPayloadRequest")
	proto.RegisterType((*InsertReputerPayloadResponse)(nil), "emissions.v10.InsertReputerPayloadResponse")
	proto.RegisterType((*InsertWorkerPayloadRequest)(nil), "emissions.v10.InsertWorkerPayloadRequest")
	proto.RegisterType((*InsertWorkerPayloadResponse)(nil), "emissions.v10.InsertWorkerPayloadResponse")
	proto.RegisterType((*TransferActorOwnershipRequest)(nil), "emissions.v10.TransferActorOwnershipRequest")
	proto.RegisterType((*TransferActorOwnershipResponse)(nil), "emissions.v10.TransferActorOwnershipResponse")
	proto.RegisterType((*RegisterRequest)(nil), "emissions.v10.RegisterRequest")
	proto.RegisterType((*RegisterResponse)(nil), "emissions.v10.RegisterResponse")
	proto.RegisterType((*RemoveRegistrationRequest)(nil), "emissions.v10.RemoveRegistrationRequest")
	proto.RegisterType((*RemoveRegistrationResponse)(nil), "emissions.v10.RemoveRegistrationResponse")
	proto.RegisterType((*AddStakeRequest)(nil), "emissions.v10.AddStakeRequest")
	proto.RegisterType((*AddStakeResponse)(nil), "emissions.v10.AddStakeResponse")
	proto.RegisterType((*RemoveStakeRequest)(nil), "emissions.v10.RemoveStakeRequest")
	proto.RegisterType((*RemoveStakeResponse)(nil), "emissions.v10.RemoveStakeResponse")
	proto.RegisterType((*CancelRemoveStakeRequest)(nil), "emissions.v10.CancelRemoveStakeRequest")
	proto.RegisterType((*CancelRemoveStakeResponse)(nil), "emissions.v10.CancelRemoveStakeResponse")
	proto.RegisterType((*DelegateStakeRequest)(nil), "emissions.v10.DelegateStakeRequest")
	proto.RegisterType((*DelegateStakeResponse)(nil), "emissions.v10.DelegateStakeResponse")
	proto.RegisterType((*RemoveDelegateStakeRequest)(nil), "emissions.v10.RemoveDelegateStakeRequest")
	proto.RegisterType((*RemoveDelegateStakeResponse)(nil), "emissions.v10.RemoveDelegateStakeResponse")
	proto.RegisterType((*CancelRemoveDelegateStakeRequest)(nil), "emissions.v10.CancelRemoveDelegateStakeRequest")
	proto.RegisterType((*CancelRemoveDelegateStakeResponse)(nil), "emissions.v10.CancelRemoveDelegateStakeResponse")
	proto.RegisterType((*RewardDelegateStakeRequest)(nil), "emissions.v10.RewardDelegateStakeRequest")
	proto.RegisterType((*RewardDelegateStakeResponse)(nil), "emissions.v10.RewardDelegateStakeResponse")
	proto.RegisterType((*FundTopicRequest)(nil), "emissions.v10.FundTopicRequest")
	proto.RegisterType((*FundTopicResponse)(nil), "emissions.v10.FundTopicResponse")
	proto.RegisterType((*AddToWhitelistAdminRequest)(nil), "emissions.v10.AddToWhitelistAdminRequest")
	proto.RegisterType((*AddToWhitelistAdminResponse)(nil), "emissions.v10.AddToWhitelistAdminResponse")
	proto.RegisterType((*RemoveFromWhitelistAdminRequest)(nil), "emissions.v10.RemoveFromWhitelistAdminRequest")
	proto.RegisterType((*RemoveFromWhitelistAdminResponse)(nil), "emissions.v10.RemoveFromWhitelistAdminResponse")
	proto.RegisterType((*EnableTopicWorkerWhitelistRequest)(nil), "emissions.v10.EnableTopicWorkerWhitelistRequest")
	proto.RegisterType((*EnableTopicWorkerWhitelistResponse)(nil), "emissions.v10.EnableTopicWorkerWhitelistResponse")
	proto.RegisterType((*DisableTopicWorkerWhitelistRequest)(nil), "emissions.v10.DisableTopicWorkerWhitelistRequest")
	proto.RegisterType((*DisableTopicWorkerWhitelistResponse)(nil), "emissions.v10.DisableTopicWorkerWhitelistResponse")
	proto.RegisterType((*EnableTopicReputerWhitelistRequest)(nil), "emissions.v10.EnableTopicReputerWhitelistRequest")
	proto.RegisterType((*EnableTopicReputerWhitelistResponse)(nil), "emissions.v10.EnableTopicReputerWhitelistResponse")
	proto.RegisterType((*DisableTopicReputerWhitelistRequest)(nil), "emissions.v10.DisableTopicReputerWhitelistRequest")
	proto.RegisterType((*DisableTopicReputerWhitelistResponse)(nil), "emissions.v10.DisableTopicReputerWhitelistResponse")
	proto.RegisterType((*AddToGlobalWhitelistRequest)(nil), "emissions.v10.AddToGlobalWhitelistRequest")
	proto.RegisterType((*AddToGlobalWhitelistResponse)(nil), "emissions.v10.AddToGlobalWhitelistResponse")
	proto.RegisterType((*RemoveFromGlobalWhitelistRequest)(nil), "emissions.v10.RemoveFromGlobalWhitelistRequest")
	proto.RegisterType((*RemoveFromGlobalWhitelistResponse)(nil), "emissions.v10.RemoveFromGlobalWhitelistResponse")
	proto.RegisterType((*AddToTopicCreatorWhitelistRequest)(nil), "emissions.v10.AddToTopicCreatorWhitelistRequest")
	proto.RegisterType((*AddToTopicCreatorWhitelistResponse)(nil), "emissions.v10.AddToTopicCreatorWhitelistResponse")
	proto.RegisterType((*AddToGlobalWorkerWhitelistRequest)(nil), "emissions.v10.AddToGlobalWorkerWhitelistRequest")
	proto.RegisterType((*AddToGlobalWorkerWhitelistResponse)(nil), "emissions.v10.AddToGlobalWorkerWhitelistResponse")
	proto.RegisterType((*RemoveFromGlobalWorkerWhitelistRequest)(nil), "emissions.v10.RemoveFromGlobalWorkerWhitelistRequest")
	proto.RegisterType((*RemoveFromGlobalWorkerWhitelistResponse)(nil), "emissions.v10.RemoveFromGlobalWorkerWhitelistResponse")
	proto.RegisterType((*AddToGlobalReputerWhitelistRequest)(nil), "emissions.v10.AddToGlobalReputerWhitelistRequest")
	proto.RegisterType((*AddToGlobalReputerWhitelistResponse)(nil), "emissions.v10.AddToGlobalReputerWhitelistResponse")
	proto.RegisterType((*RemoveFromGlobalReputerWhitelistRequest)(nil), "emissions.v10.RemoveFromGlobalReputerWhitelistRequest")
	proto.RegisterType((*RemoveFromGlobalReputerWhitelistResponse)(nil), "emissions.v10.RemoveFromGlobalReputerWhitelistResponse")
	proto.RegisterType((*AddToGlobalAdminWhitelistRequest)(nil), "emissions.v10.AddToGlobalAdminWhitelistRequest")
	proto.RegisterType((*AddToGlobalAdminWhitelistResponse)(nil), "emissions.v10.AddToGlobalAdminWhitelistResponse")
	proto.RegisterType((*RemoveFromGlobalAdminWhitelistRequest)(nil), "emissions.v10.RemoveFromGlobalAdminWhitelistRequest")
	proto.RegisterType((*RemoveFromGlobalAdminWhitelistResponse)(nil), "emissions.v10.RemoveFromGlobalAdminWhitelistResponse")
	proto.RegisterType((*BulkAddToGlobalWorkerWhitelistRequest)(nil), "emissions.v10.BulkAddToGlobalWorkerWhitelistRequest")
	proto.RegisterType((*BulkAddToGlobalWorkerWhitelistResponse)(nil), "emissions.v10.BulkAddToGlobalWorkerWhitelistResponse")
	proto.RegisterType((*BulkRemoveFromGlobalWorkerWhitelistRequest)(nil), "emissions.v10.BulkRemoveFromGlobalWorkerWhitelistRequest")
	proto.RegisterType((*BulkRemoveFromGlobalWorkerWhitelistResponse)(nil), "emissions.v10.BulkRemoveFromGlobalWorkerWhitelistResponse")
	proto.RegisterType((*BulkAddToGlobalReputerWhitelistRequest)(nil), "emissions.v10.BulkAddToGlobalReputerWhitelistRequest")
	proto.RegisterType((*BulkAddToGlobalReputerWhitelistResponse)(nil), "emissions.v10.BulkAddToGlobalReputerWhitelistResponse")
	proto.RegisterType((*BulkRemoveFromGlobalReputerWhitelistRequest)(nil), "emissions.v10.BulkRemoveFromGlobalReputerWhitelistRequest")
	proto.RegisterType((*BulkRemoveFromGlobalReputerWhitelistResponse)(nil), "emissions.v10.BulkRemoveFromGlobalReputerWhitelistResponse")
	proto.RegisterType((*BulkAddToTopicWorkerWhitelistRequest)(nil), "emissions.v10.BulkAddToTopicWorkerWhitelistRequest")
	proto.RegisterType((*BulkAddToTopicWorkerWhitelistResponse)(nil), "emissions.v10.BulkAddToTopicWorkerWhitelistResponse")
	proto.RegisterType((*BulkRemoveFromTopicWorkerWhitelistRequest)(nil), "emissions.v10.BulkRemoveFromTopicWorkerWhitelistRequest")
	proto.RegisterType((*BulkRemoveFromTopicWorkerWhitelistResponse)(nil), "emissions.v10.BulkRemoveFromTopicWorkerWhitelistResponse")
	proto.RegisterType((*BulkAddToTopicReputerWhitelistRequest)(nil), "emissions.v10.BulkAddToTopicReputerWhitelistRequest")
	proto.RegisterType((*BulkAddToTopicReputerWhitelistResponse)(nil), "emissions.v10.BulkAddToTopicReputerWhitelistResponse")
	proto.RegisterType((*BulkRemoveFromTopicReputerWhitelistRequest)(nil), "emissions.v10.BulkRemoveFromTopicReputerWhitelistRequest")
	proto.RegisterType((*BulkRemoveFromTopicReputerWhitelistResponse)(nil), "emissions.v10.BulkRemoveFromTopicReputerWhitelistResponse")
	proto.RegisterType((*RemoveFromTopicCreatorWhitelistRequest)(nil), "emissions.v10.RemoveFromTopicCreatorWhitelistRequest")
	proto.RegisterType((*RemoveFromTopicCreatorWhitelistResponse)(nil), "emissions.v10.RemoveFromTopicCreatorWhitelistResponse")
	proto.RegisterType((*AddToTopicWorkerWhitelistRequest)(nil), "emissions.v10.AddToTopicWorkerWhitelistRequest")
	proto.RegisterType((*AddToTopicWorkerWhitelistResponse)(nil), "emissions.v10.AddToTopicWorkerWhitelistResponse")
	proto.RegisterType((*RemoveFromTopicWorkerWhitelistRequest)(nil), "emissions.v10.RemoveFromTopicWorkerWhitelistRequest")
	proto.RegisterType((*RemoveFromTopicWorkerWhitelistResponse)(nil), "emissions.v10.RemoveFromTopicWorkerWhitelistResponse")
	proto.RegisterType((*AddToTopicReputerWhitelistRequest)(nil), "emissions.v10.AddToTopicReputerWhitelistRequest")
	proto.RegisterType((*AddToTopicReputerWhitelistResponse)(nil), "emissions.v10.AddToTopicReputerWhitelistResponse")
	proto.RegisterType((*RemoveFromTopicReputerWhitelistRequest)(nil), "emissions.v10.RemoveFromTopicReputerWhitelistRequest")
	proto.RegisterType((*RemoveFromTopicReputerWhitelistResponse)(nil), "emissions.v10.RemoveFromTopicReputerWhitelistResponse")
}

func init() { proto.RegisterFile("emissions/v10/tx.proto", fileDescriptor_2cbaaf648f37497a) }

var fileDescriptor_2cbaaf648f37497a = []byte{
	...
	,
}
...
func (c *msgServiceClient) UpdateParams(ctx context.Context, in *UpdateParamsRequest, opts ...grpc.CallOption) (*UpdateParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/emissions.v10.MsgService/UpdateParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgServiceClient) CreateNewTopic(ctx context.Context, in *CreateNewTopicRequest, opts ...grpc.CallOption) (*CreateNewTopicResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/emissions.v10.MsgService/CreateNewTopic", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgServiceClient) UpdateTopic(ctx context.Context, in *UpdateTopicRequest, opts ...grpc.CallOption) (*UpdateTopicResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/emissions.v10.MsgService/UpdateTopic", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgServiceClient) Register(ctx context.Context, in *RegisterRequest, opts ...grpc.CallOption) (*RegisterResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/emissions.v10.MsgService/Register", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgServiceClient) RemoveRegistration(ctx context.Context, in *RemoveRegistrationRequest, opts ...grpc.CallOption) (*RemoveRegistrationResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/emissions.v10.MsgService/RemoveRegistration", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgServiceClient) AddStake(ctx context.Context, in *AddStakeRequest, opts ...grpc.CallOption) (*AddStakeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/emissions.v10.MsgService/AddStake", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgServiceClient) RemoveStake(ctx context.Context, in *RemoveStakeRequest, opts ...grpc.CallOption) (*RemoveStakeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/emissions.v10.MsgService/RemoveStake", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgServiceClient) CancelRemoveStake(ctx context.Context, in *CancelRemoveStakeRequest, opts ...grpc.CallOption) (*CancelRemoveStakeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/emissions.v10.MsgService/CancelRemoveStake", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgServiceClient) DelegateStake(ctx context.Context, in *DelegateStakeRequest, opts ...grpc.CallOption) (*DelegateStakeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/emissions.v10.MsgService/DelegateStake", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgServiceClient) RewardDelegateStake(ctx context.Context, in *RewardDelegateStakeRequest, opts ...grpc.CallOption) (*RewardDelegateStakeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/emissions.v10.MsgService/RewardDelegateStake", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgServiceClient) RemoveDelegateStake(ctx context.Context, in *RemoveDelegateStakeRequest, opts ...grpc.CallOption) (*RemoveDelegateStakeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/emissions.v10.MsgService/RemoveDelegateStake", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgServiceClient) CancelRemoveDelegateStake(ctx context.Context, in *CancelRemoveDelegateStakeRequest, opts ...grpc.CallOption) (*CancelRemoveDelegateStakeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/emissions.v10.MsgService/CancelRemoveDelegateStake", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgServiceClient) FundTopic(ctx context.Context, in *FundTopicRequest, opts ...grpc.CallOption) (*FundTopicResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/emissions.v10.MsgService/FundTopic", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgServiceClient) AddToWhitelistAdmin(ctx context.Context, in *AddToWhitelistAdminRequest, opts ...grpc.CallOption) (*AddToWhitelistAdminResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/emissions.v10.MsgService/AddToWhitelistAdmin", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgServiceClient) RemoveFromWhitelistAdmin(ctx context.Context, in *RemoveFromWhitelistAdminRequest, opts ...grpc.CallOption) (*RemoveFromWhitelistAdminResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/emissions.v10.MsgService/RemoveFromWhitelistAdmin", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgServiceClient) InsertWorkerPayload(ctx context.Context, in *InsertWorkerPayloadRequest, opts ...grpc.CallOption) (*InsertWorkerPayloadResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/emissions.v10.MsgService/InsertWorkerPayload", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgServiceClient) InsertReputerPayload(ctx context.Context, in *InsertReputerPayloadRequest, opts ...grpc.CallOption) (*InsertReputerPayloadResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/emissions.v10.MsgService/InsertReputerPayload", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgServiceClient) AddToGlobalWhitelist(ctx context.Context, in *AddToGlobalWhitelistRequest, opts ...grpc.CallOption) (*AddToGlobalWhitelistResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/emissions.v10.MsgService/AddToGlobalWhitelist", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgServiceClient) RemoveFromGlobalWhitelist(ctx context.Context, in *RemoveFromGlobalWhitelistRequest, opts ...grpc.CallOption) (*RemoveFromGlobalWhitelistResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/emissions.v10.MsgService/RemoveFromGlobalWhitelist", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgServiceClient) AddToGlobalWorkerWhitelist(ctx context.Context, in *AddToGlobalWorkerWhitelistRequest, opts ...grpc.CallOption) (*AddToGlobalWorkerWhitelistResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/emissions.v10.MsgService/AddToGlobalWorkerWhitelist", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgServiceClient) RemoveFromGlobalWorkerWhitelist(ctx context.Context, in *RemoveFromGlobalWorkerWhitelistRequest, opts ...grpc.CallOption) (*RemoveFromGlobalWorkerWhitelistResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/emissions.v10.MsgService/RemoveFromGlobalWorkerWhitelist", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgServiceClient) AddToGlobalReputerWhitelist(ctx context.Context, in *AddToGlobalReputerWhitelistRequest, opts ...grpc.CallOption) (*AddToGlobalReputerWhitelistResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/emissions.v10.MsgService/AddToGlobalReputerWhitelist", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgServiceClient) RemoveFromGlobalReputerWhitelist(ctx context.Context, in *RemoveFromGlobalReputerWhitelistRequest, opts ...grpc.CallOption) (*RemoveFromGlobalReputerWhitelistResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/emissions.v10.MsgService/RemoveFromGlobalReputerWhitelist", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgServiceClient) AddToGlobalAdminWhitelist(ctx context.Context, in *AddToGlobalAdminWhitelistRequest, opts ...grpc.CallOption) (*AddToGlobalAdminWhitelistResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/emissions.v10.MsgService/AddToGlobalAdminWhitelist", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgServiceClient) RemoveFromGlobalAdminWhitelist(ctx context.Context, in *RemoveFromGlobalAdminWhitelistRequest, opts ...grpc.CallOption) (*RemoveFromGlobalAdminWhitelistResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/emissions.v10.MsgService/RemoveFromGlobalAdminWhitelist", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgServiceClient) BulkAddToGlobalWorkerWhitelist(ctx context.Context, in *BulkAddToGlobalWorkerWhitelistRequest, opts ...grpc.CallOption) (*BulkAddToGlobalWorkerWhitelistResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/emissions.v10.MsgService/BulkAddToGlobalWorkerWhitelist", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgServiceClient) BulkRemoveFromGlobalWorkerWhitelist(ctx context.Context, in *BulkRemoveFromGlobalWorkerWhitelistRequest, opts ...grpc.CallOption) (*BulkRemoveFromGlobalWorkerWhitelistResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/emissions.v10.MsgService/BulkRemoveFromGlobalWorkerWhitelist", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgServiceClient) BulkAddToGlobalReputerWhitelist(ctx context.Context, in *BulkAddToGlobalReputerWhitelistRequest, opts ...grpc.CallOption) (*BulkAddToGlobalReputerWhitelistResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/emissions.v10.MsgService/BulkAddToGlobalReputerWhitelist", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgServiceClient) BulkRemoveFromGlobalReputerWhitelist(ctx context.Context, in *BulkRemoveFromGlobalReputerWhitelistRequest, opts ...grpc.CallOption) (*BulkRemoveFromGlobalReputerWhitelistResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/emissions.v10.MsgService/BulkRemoveFromGlobalReputerWhitelist", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgServiceClient) BulkAddToTopicWorkerWhitelist(ctx context.Context, in *BulkAddToTopicWorkerWhitelistRequest, opts ...grpc.CallOption) (*BulkAddToTopicWorkerWhitelistResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/emissions.v10.MsgService/BulkAddToTopicWorkerWhitelist", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgServiceClient) BulkRemoveFromTopicWorkerWhitelist(ctx context.Context, in *BulkRemoveFromTopicWorkerWhitelistRequest, opts ...grpc.CallOption) (*BulkRemoveFromTopicWorkerWhitelistResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/emissions.v10.MsgService/BulkRemoveFromTopicWorkerWhitelist", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgServiceClient) BulkAddToTopicReputerWhitelist(ctx context.Context, in *BulkAddToTopicReputerWhitelistRequest, opts ...grpc.CallOption) (*BulkAddToTopicReputerWhitelistResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/emissions.v10.MsgService/BulkAddToTopicReputerWhitelist", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgServiceClient) BulkRemoveFromTopicReputerWhitelist(ctx context.Context, in *BulkRemoveFromTopicReputerWhitelistRequest, opts ...grpc.CallOption) (*BulkRemoveFromTopicReputerWhitelistResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/emissions.v10.MsgService/BulkRemoveFromTopicReputerWhitelist", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgServiceClient) EnableTopicWorkerWhitelist(ctx context.Context, in *EnableTopicWorkerWhitelistRequest, opts ...grpc.CallOption) (*EnableTopicWorkerWhitelistResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/emissions.v10.MsgService/EnableTopicWorkerWhitelist", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgServiceClient) DisableTopicWorkerWhitelist(ctx context.Context, in *DisableTopicWorkerWhitelistRequest, opts ...grpc.CallOption) (*DisableTopicWorkerWhitelistResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/emissions.v10.MsgService/DisableTopicWorkerWhitelist", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgServiceClient) EnableTopicReputerWhitelist(ctx context.Context, in *EnableTopicReputerWhitelistRequest, opts ...grpc.CallOption) (*EnableTopicReputerWhitelistResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/emissions.v10.MsgService/EnableTopicReputerWhitelist", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgServiceClient) DisableTopicReputerWhitelist(ctx context.Context, in *DisableTopicReputerWhitelistRequest, opts ...grpc.CallOption) (*DisableTopicReputerWhitelistResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/emissions.v10.MsgService/DisableTopicReputerWhitelist", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgServiceClient) AddToTopicCreatorWhitelist(ctx context.Context, in *AddToTopicCreatorWhitelistRequest, opts ...grpc.CallOption) (*AddToTopicCreatorWhitelistResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/emissions.v10.MsgService/AddToTopicCreatorWhitelist", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgServiceClient) RemoveFromTopicCreatorWhitelist(ctx context.Context, in *RemoveFromTopicCreatorWhitelistRequest, opts ...grpc.CallOption) (*RemoveFromTopicCreatorWhitelistResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/emissions.v10.MsgService/RemoveFromTopicCreatorWhitelist", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgServiceClient) AddToTopicWorkerWhitelist(ctx context.Context, in *AddToTopicWorkerWhitelistRequest, opts ...grpc.CallOption) (*AddToTopicWorkerWhitelistResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/emissions.v10.MsgService/AddToTopicWorkerWhitelist", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgServiceClient) RemoveFromTopicWorkerWhitelist(ctx context.Context, in *RemoveFromTopicWorkerWhitelistRequest, opts ...grpc.CallOption) (*RemoveFromTopicWorkerWhitelistResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/emissions.v10.MsgService/RemoveFromTopicWorkerWhitelist", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgServiceClient) AddToTopicReputerWhitelist(ctx context.Context, in *AddToTopicReputerWhitelistRequest, opts ...grpc.CallOption) (*AddToTopicReputerWhitelistResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/emissions.v10.MsgService/AddToTopicReputerWhitelist", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgServiceClient) RemoveFromTopicReputerWhitelist(ctx context.Context, in *RemoveFromTopicReputerWhitelistRequest, opts ...grpc.CallOption) (*RemoveFromTopicReputerWhitelistResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/emissions.v10.MsgService/RemoveFromTopicReputerWhitelist", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgServiceClient) TransferActorOwnership(ctx context.Context, in *TransferActorOwnershipRequest, opts ...grpc.CallOption) (*TransferActorOwnershipResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/emissions.v10.MsgService/TransferActorOwnership", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedMsgServiceServer) UpdateTopic(ctx context.Context, req *UpdateTopicRequest) (*UpdateTopicResponse, error) {
...
func (*UnimplementedMsgServiceServer) TransferActorOwnership(ctx context.Context, req *TransferActorOwnershipRequest) (*TransferActorOwnershipResponse, error) {
...
func _MsgService_UpdateParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/emissions.v10.MsgService/UpdateParams",
	}
...
func _MsgService_CreateNewTopic_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/emissions.v10.MsgService/CreateNewTopic",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MsgService_UpdateTopic_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/emissions.v10.MsgService/UpdateTopic",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MsgService_Register_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/emissions.v10.MsgService/Register",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MsgService_RemoveRegistration_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/emissions.v10.MsgService/RemoveRegistration",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MsgService_AddStake_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/emissions.v10.MsgService/AddStake",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MsgService_RemoveStake_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/emissions.v10.MsgService/RemoveStake",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MsgService_CancelRemoveStake_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/emissions.v10.MsgService/CancelRemoveStake",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MsgService_DelegateStake_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/emissions.v10.MsgService/DelegateStake",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MsgService_RewardDelegateStake_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/emissions.v10.MsgService/RewardDelegateStake",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MsgService_RemoveDelegateStake_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/emissions.v10.MsgService/RemoveDelegateStake",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MsgService_CancelRemoveDelegateStake_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/emissions.v10.MsgService/CancelRemoveDelegateStake",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MsgService_FundTopic_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/emissions.v10.MsgService/FundTopic",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MsgService_AddToWhitelistAdmin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/emissions.v10.MsgService/AddToWhitelistAdmin",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MsgService_RemoveFromWhitelistAdmin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/emissions.v10.MsgService/RemoveFromWhitelistAdmin",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MsgService_InsertWorkerPayload_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/emissions.v10.MsgService/InsertWorkerPayload",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MsgService_InsertReputerPayload_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/emissions.v10.MsgService/InsertReputerPayload",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MsgService_AddToGlobalWhitelist_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/emissions.v10.MsgService/AddToGlobalWhitelist",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MsgService_RemoveFromGlobalWhitelist_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/emissions.v10.MsgService/RemoveFromGlobalWhitelist",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MsgService_AddToGlobalWorkerWhitelist_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/emissions.v10.MsgService/AddToGlobalWorkerWhitelist",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MsgService_RemoveFromGlobalWorkerWhitelist_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/emissions.v10.MsgService/RemoveFromGlobalWorkerWhitelist",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MsgService_AddToGlobalReputerWhitelist_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/emissions.v10.MsgService/AddToGlobalReputerWhitelist",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MsgService_RemoveFromGlobalReputerWhitelist_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/emissions.v10.MsgService/RemoveFromGlobalReputerWhitelist",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MsgService_AddToGlobalAdminWhitelist_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/emissions.v10.MsgService/AddToGlobalAdminWhitelist",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MsgService_RemoveFromGlobalAdminWhitelist_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/emissions.v10.MsgService/RemoveFromGlobalAdminWhitelist",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MsgService_BulkAddToGlobalWorkerWhitelist_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/emissions.v10.MsgService/BulkAddToGlobalWorkerWhitelist",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MsgService_BulkRemoveFromGlobalWorkerWhitelist_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/emissions.v10.MsgService/BulkRemoveFromGlobalWorkerWhitelist",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MsgService_BulkAddToGlobalReputerWhitelist_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/emissions.v10.MsgService/BulkAddToGlobalReputerWhitelist",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MsgService_BulkRemoveFromGlobalReputerWhitelist_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/emissions.v10.MsgService/BulkRemoveFromGlobalReputerWhitelist",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MsgService_BulkAddToTopicWorkerWhitelist_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/emissions.v10.MsgService/BulkAddToTopicWorkerWhitelist",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MsgService_BulkRemoveFromTopicWorkerWhitelist_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/emissions.v10.MsgService/BulkRemoveFromTopicWorkerWhitelist",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MsgService_BulkAddToTopicReputerWhitelist_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/emissions.v10.MsgService/BulkAddToTopicReputerWhitelist",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MsgService_BulkRemoveFromTopicReputerWhitelist_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/emissions.v10.MsgService/BulkRemoveFromTopicReputerWhitelist",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MsgService_EnableTopicWorkerWhitelist_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/emissions.v10.MsgService/EnableTopicWorkerWhitelist",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MsgService_DisableTopicWorkerWhitelist_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/emissions.v10.MsgService/DisableTopicWorkerWhitelist",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MsgService_EnableTopicReputerWhitelist_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/emissions.v10.MsgService/EnableTopicReputerWhitelist",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MsgService_DisableTopicReputerWhitelist_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/emissions.v10.MsgService/DisableTopicReputerWhitelist",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MsgService_AddToTopicCreatorWhitelist_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/emissions.v10.MsgService/AddToTopicCreatorWhitelist",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MsgService_RemoveFromTopicCreatorWhitelist_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/emissions.v10.MsgService/RemoveFromTopicCreatorWhitelist",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MsgService_AddToTopicWorkerWhitelist_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/emissions.v10.MsgService/AddToTopicWorkerWhitelist",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MsgService_RemoveFromTopicWorkerWhitelist_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/emissions.v10.MsgService/RemoveFromTopicWorkerWhitelist",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MsgService_AddToTopicReputerWhitelist_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/emissions.v10.MsgService/AddToTopicReputerWhitelist",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MsgService_RemoveFromTopicReputerWhitelist_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/emissions.v10.MsgService/RemoveFromTopicReputerWhitelist",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MsgService_TransferActorOwnership_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/emissions.v10.MsgService/TransferActorOwnership",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _MsgService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "emissions.v10.MsgService",
	...
	Metadata: "emissions/v10/tx.proto",
}
...
func (m *OptionalParams) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.MinTopInferersToReward) > 0 {
		dAtA2 := make([]byte, len(m.MinTopInferersToReward)*10)
		var j1 int
		for _, num := range m.MinTopInferersToReward {
			for num >= 1<<7 {
	...
	if len(m.MaxEpochLabelRegistrySize) > 0 {
		dAtA4 := make([]byte, len(m.MaxEpochLabelRegistrySize)*10)
		var j3 int
		for _, num := range m.MaxEpochLabelRegistrySize {
			for num >= 1<<7 {
	...
	if len(m.MaxTopicLabelWhitelistSize) > 0 {
		dAtA6 := make([]byte, len(m.MaxTopicLabelWhitelistSize)*10)
		var j5 int
		for _, num := range m.MaxTopicLabelWhitelistSize {
			for num >= 1<<7 {
	...
	if len(m.MaxCanonicalLabelByteLength) > 0 {
		dAtA8 := make([]byte, len(m.MaxCanonicalLabelByteLength)*10)
		var j7 int
		for _, num := range m.MaxCanonicalLabelByteLength {
			for num >= 1<<7 {
	...
	if len(m.MinWeightThresholdForStdnorm) > 0 {
		for iNdEx := len(m.MinWeightThresholdForStdnorm) - 1; iNdEx >= 0; iNdEx-- {
			{
				size := m.MinWeightThresholdForStdnorm[iNdEx].Size()
				i -= size
				if _, err := m.MinWeightThresholdForStdnorm[iNdEx].MarshalTo(dAtA[i:]); err != nil {
					return 0, err
				}
	...
	if len(m.MaxWhitelistInputArrayLength) > 0 {
		dAtA10 := make([]byte, len(m.MaxWhitelistInputArrayLength)*10)
		var j9 int
	...
	if len(m.MinExperiencedWorkerRegrets) > 0 {
		dAtA12 := make([]byte, len(m.MinExperiencedWorkerRegrets)*10)
		var j11 int
	...
	if len(m.MaxStringLength) > 0 {
		dAtA14 := make([]byte, len(m.MaxStringLength)*10)
		var j13 int
	...
	if len(m.MaxActiveTopicsPerBlock) > 0 {
		dAtA16 := make([]byte, len(m.MaxActiveTopicsPerBlock)*10)
		var j15 int
	...
	if len(m.MaxElementsPerForecast) > 0 {
		dAtA18 := make([]byte, len(m.MaxElementsPerForecast)*10)
		var j17 int
	...
	if len(m.HalfMaxProcessStakeRemovalsEndBlock) > 0 {
		dAtA20 := make([]byte, len(m.HalfMaxProcessStakeRemovalsEndBlock)*10)
		var j19 int
	...
	if len(m.BlocksPerMonth) > 0 {
		dAtA22 := make([]byte, len(m.BlocksPerMonth)*10)
		var j21 int
	...
	if len(m.MinEpochLengthRecordLimit) > 0 {
		dAtA24 := make([]byte, len(m.MinEpochLengthRecordLimit)*10)
		var j23 int
	...
	if len(m.MaxPageLimit) > 0 {
		dAtA26 := make([]byte, len(m.MaxPageLimit)*10)
		var j25 int
	...
	if len(m.DefaultPageLimit) > 0 {
		dAtA28 := make([]byte, len(m.DefaultPageLimit)*10)
		var j27 int
	...
	if len(m.GradientDescentMaxIters) > 0 {
		dAtA30 := make([]byte, len(m.GradientDescentMaxIters)*10)
		var j29 int
	...
	if len(m.MaxTopReputersToReward) > 0 {
		dAtA32 := make([]byte, len(m.MaxTopReputersToReward)*10)
		var j31 int
	...
	if len(m.MaxTopForecastersToReward) > 0 {
		dAtA34 := make([]byte, len(m.MaxTopForecastersToReward)*10)
		var j33 int
	...
	if len(m.MaxTopInferersToReward) > 0 {
		dAtA36 := make([]byte, len(m.MaxTopInferersToReward)*10)
		var j35 int
	...
	if len(m.MaxSamplesToScaleScores) > 0 {
		dAtA38 := make([]byte, len(m.MaxSamplesToScaleScores)*10)
		var j37 int
	...
	if len(m.MaxUnfulfilledReputerRequests) > 0 {
		dAtA40 := make([]byte, len(m.MaxUnfulfilledReputerRequests)*10)
		var j39 int
	...
	if len(m.MaxUnfulfilledWorkerRequests) > 0 {
		dAtA42 := make([]byte, len(m.MaxUnfulfilledWorkerRequests)*10)
		var j41 int
		...
		i = encodeVarintTx(dAtA, i, uint64(j41))
		i--
		dAtA[i] = 0x6a
	}
	...
	if len(m.MinEpochLength) > 0 {
		dAtA44 := make([]byte, len(m.MinEpochLength)*10)
		var j43 int
		...
		i = encodeVarintTx(dAtA, i, uint64(j43))
		i--
		dAtA[i] = 0x3a
	}
	if len(m.RemoveStakeDelayWindow) > 0 {
		dAtA46 := make([]byte, len(m.RemoveStakeDelayWindow)*10)
		var j45 int
		...
		i = encodeVarintTx(dAtA, i, uint64(j45))
		i--
		dAtA[i] = 0x32
	}
	...
	if len(m.MaxSerializedMsgLength) > 0 {
		dAtA48 := make([]byte, len(m.MaxSerializedMsgLength)*10)
		var j47 int
		...
		i = encodeVarintTx(dAtA, i, uint64(j47))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Version) > 0 {
...
func (m *CreateNewTopicRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.MaxTopInferersToReward != 0 {
		i = encodeVarintTx(dAtA, i, uint64(m.MaxTopInferersToReward))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xf0
	...
	if len(m.LabelWhitelist) > 0 {
		for iNdEx := len(m.LabelWhitelist) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintTx(dAtA, i, uint64(len(m.LabelWhitelist[iNdEx])))
			i--
			dAtA[i] = 0x1
			i--
			dAtA[i] = 0xda
	...
	if m.OutputArity != 0 {
		i = encodeVarintTx(dAtA, i, uint64(m.OutputArity))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xb8
	...
	if m.TopicType != 0 {
		i = encodeVarintTx(dAtA, i, uint64(m.TopicType))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xb0
...
func (m *UpdateTopicRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *UpdateTopicResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *UpdateTopicResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *UpdateTopicResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *TransferActorOwnershipRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *TransferActorOwnershipRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TransferActorOwnershipRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *TransferActorOwnershipResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *TransferActorOwnershipResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TransferActorOwnershipResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *OptionalParams) Size() (n int) {
	...
	if len(m.MinWeightThresholdForStdnorm) > 0 {
		for _, e := range m.MinWeightThresholdForStdnorm {
			l = e.Size()
			n += 2 + l + sovTx(uint64(l))
		}
	}
	if len(m.MaxCanonicalLabelByteLength) > 0 {
		l = 0
		for _, e := range m.MaxCanonicalLabelByteLength {
			l += sovTx(uint64(e))
		}
		n += 2 + sovTx(uint64(l)) + l
	}
	if len(m.MaxTopicLabelWhitelistSize) > 0 {
		l = 0
		for _, e := range m.MaxTopicLabelWhitelistSize {
			l += sovTx(uint64(e))
		}
		n += 2 + sovTx(uint64(l)) + l
	}
	if len(m.MaxEpochLabelRegistrySize) > 0 {
		l = 0
		for _, e := range m.MaxEpochLabelRegistrySize {
			l += sovTx(uint64(e))
		}
		n += 2 + sovTx(uint64(l)) + l
	}
	if len(m.MinTopInferersToReward) > 0 {
		l = 0
		for _, e := range m.MinTopInferersToReward {
			l += sovTx(uint64(e))
		}
		n += 2 + sovTx(uint64(l)) + l
	}
...
func (m *CreateNewTopicRequest) Size() (n int) {
	...
	n += 2 + l + sovTx(uint64(l))
	if m.TopicType != 0 {
		n += 2 + sovTx(uint64(m.TopicType))
	}
	if m.OutputArity != 0 {
		n += 2 + sovTx(uint64(m.OutputArity))
	}
	if m.RequireUnity {
		n += 3
	}
	...
	n += 2 + l + sovTx(uint64(l))
	if m.MaxLabelsPerSubmission != 0 {
		n += 2 + sovTx(uint64(m.MaxLabelsPerSubmission))
	}
	if len(m.LabelWhitelist) > 0 {
	...
	if m.MaxTopInferersToReward != 0 {
		n += 2 + sovTx(uint64(m.MaxTopInferersToReward))
	}
	return n
}
...
func (m *UpdateTopicRequest) Size() (n int) {
	...
	n += 1 + l + sovTx(uint64(l))
	if m.MaxLabelsPerSubmission != 0 {
		n += 1 + sovTx(uint64(m.MaxLabelsPerSubmission))
	}
	if len(m.LabelWhitelist) > 0 {
		for _, s := range m.LabelWhitelist {
			l = len(s)
	...
	n += 1 + l + sovTx(uint64(l))
	if m.MaxTopInferersToReward != 0 {
		n += 1 + sovTx(uint64(m.MaxTopInferersToReward))
	}
	return n
}

func (m *UpdateTopicResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *TransferActorOwnershipRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *TransferActorOwnershipResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *OptionalParams) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 60:
			...
			var v github_com_allora_network_allora_chain_math.Dec
			m.MinWeightThresholdForStdnorm = append(m.MinWeightThresholdForStdnorm, v)
			if err := m.MinWeightThresholdForStdnorm[len(m.MinWeightThresholdForStdnorm)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 61:
			if wireType == 0 {
				...
				m.MaxCanonicalLabelByteLength = append(m.MaxCanonicalLabelByteLength, v)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				elementCount = count
				if elementCount != 0 && len(m.MaxCanonicalLabelByteLength) == 0 {
					m.MaxCanonicalLabelByteLength = make([]uint64, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v uint64
					for shift := uint(0); ; shift += 7 {
		...
		case 62:
			if wireType == 0 {
				...
				m.MaxTopicLabelWhitelistSize = append(m.MaxTopicLabelWhitelistSize, v)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				elementCount = count
				if elementCount != 0 && len(m.MaxTopicLabelWhitelistSize) == 0 {
					m.MaxTopicLabelWhitelistSize = make([]uint64, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v uint64
					for shift := uint(0); ; shift += 7 {
		...
		case 63:
			if wireType == 0 {
				...
				m.MaxEpochLabelRegistrySize = append(m.MaxEpochLabelRegistrySize, v)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				elementCount = count
				if elementCount != 0 && len(m.MaxEpochLabelRegistrySize) == 0 {
					m.MaxEpochLabelRegistrySize = make([]uint64, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v uint64
					for shift := uint(0); ; shift += 7 {
		...
		case 64:
			if wireType == 0 {
				...
				m.MinTopInferersToReward = append(m.MinTopInferersToReward, v)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				elementCount = count
				if elementCount != 0 && len(m.MinTopInferersToReward) == 0 {
					m.MinTopInferersToReward = make([]uint64, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v uint64
					for shift := uint(0); ; shift += 7 {
...
func (m *UpdateTopicResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *InsertReputerPayloadRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.ReputerValueBundle == nil {
				m.ReputerValueBundle = &InputReputerValueBundle{}
			}
...
func (m *InsertWorkerPayloadRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.WorkerDataBundle == nil {
				m.WorkerDataBundle = &InputWorkerDataBundle{}
			}
...
func (m *TransferActorOwnershipRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TransferActorOwnershipRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TransferActorOwnershipRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *TransferActorOwnershipResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TransferActorOwnershipResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TransferActorOwnershipResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
