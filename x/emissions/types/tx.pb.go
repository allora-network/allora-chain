...
type OptionalParams struct {
	...
	MaxActiveInferersQuantile       []github_com_allora_network_allora_chain_math.Dec `protobuf:"bytes,24,rep,name=max_active_inferers_quantile,json=maxActiveInferersQuantile,proto3,customtype=github.com/allora-network/allora-chain/math.Dec" json:"max_active_inferers_quantile"`
	MaxActiveForecastersQuantile    []github_com_allora_network_allora_chain_math.Dec `protobuf:"bytes,25,rep,name=max_active_forecasters_quantile,json=maxActiveForecastersQuantile,proto3,customtype=github.com/allora-network/allora-chain/math.Dec" json:"max_active_forecasters_quantile"`
	MaxActiveReputersQuantile       []github_com_allora_network_allora_chain_math.Dec `protobuf:"bytes,26,rep,name=max_active_reputers_quantile,json=maxActiveReputersQuantile,proto3,customtype=github.com/allora-network/allora-chain/math.Dec" json:"max_active_reputers_quantile"`
	CreateTopicFee                  []cosmossdk_io_math.Int                           `protobuf:"bytes,27,rep,name=create_topic_fee,json=createTopicFee,proto3,customtype=cosmossdk.io/math.Int" json:"create_topic_fee"`
	...
	PRewardInference                []github_com_allora_network_allora_chain_math.Dec `protobuf:"bytes,36,rep,name=p_reward_inference,json=pRewardInference,proto3,customtype=github.com/allora-network/allora-chain/math.Dec" json:"p_reward_inference"`
	PRewardForecast                 []github_com_allora_network_allora_chain_math.Dec `protobuf:"bytes,37,rep,name=p_reward_forecast,json=pRewardForecast,proto3,customtype=github.com/allora-network/allora-chain/math.Dec" json:"p_reward_forecast"`
	PRewardReputer                  []github_com_allora_network_allora_chain_math.Dec `protobuf:"bytes,38,rep,name=p_reward_reputer,json=pRewardReputer,proto3,customtype=github.com/allora-network/allora-chain/math.Dec" json:"p_reward_reputer"`
	CRewardInference                []github_com_allora_network_allora_chain_math.Dec `protobuf:"bytes,39,rep,name=c_reward_inference,json=cRewardInference,proto3,customtype=github.com/allora-network/allora-chain/math.Dec" json:"c_reward_inference"`
	CRewardForecast                 []github_com_allora_network_allora_chain_math.Dec `protobuf:"bytes,40,rep,name=c_reward_forecast,json=cRewardForecast,proto3,customtype=github.com/allora-network/allora-chain/math.Dec" json:"c_reward_forecast"`
	CNorm                           []github_com_allora_network_allora_chain_math.Dec `protobuf:"bytes,41,rep,name=c_norm,json=cNorm,proto3,customtype=github.com/allora-network/allora-chain/math.Dec" json:"c_norm"`
	TopicFeeRevenueDecayRate        []github_com_allora_network_allora_chain_math.Dec `protobuf:"bytes,42,rep,name=topic_fee_revenue_decay_rate,json=topicFeeRevenueDecayRate,proto3,customtype=github.com/allora-network/allora-chain/math.Dec" json:"topic_fee_revenue_decay_rate"`
	EpsilonReputer                  []github_com_allora_network_allora_chain_math.Dec `protobuf:"bytes,43,rep,name=epsilon_reputer,json=epsilonReputer,proto3,customtype=github.com/allora-network/allora-chain/math.Dec" json:"epsilon_reputer"`
	MinEffectiveTopicRevenue        []github_com_allora_network_allora_chain_math.Dec `protobuf:"bytes,44,rep,name=min_effective_topic_revenue,json=minEffectiveTopicRevenue,proto3,customtype=github.com/allora-network/allora-chain/math.Dec" json:"min_effective_topic_revenue"`
}
...
type MsgCreateNewTopic struct {
	...
	ActiveInfererQuantile    github_com_allora_network_allora_chain_math.Dec `protobuf:"bytes,14,opt,name=active_inferer_quantile,json=activeInfererQuantile,proto3,customtype=github.com/allora-network/allora-chain/math.Dec" json:"active_inferer_quantile"`
	ActiveForecasterQuantile github_com_allora_network_allora_chain_math.Dec `protobuf:"bytes,15,opt,name=active_forecaster_quantile,json=activeForecasterQuantile,proto3,customtype=github.com/allora-network/allora-chain/math.Dec" json:"active_forecaster_quantile"`
	ActiveReputerQuantile    github_com_allora_network_allora_chain_math.Dec `protobuf:"bytes,16,opt,name=active_reputer_quantile,json=activeReputerQuantile,proto3,customtype=github.com/allora-network/allora-chain/math.Dec" json:"active_reputer_quantile"`
}
...
var fileDescriptor_8293ea1b0f4b608c = []byte{
	...
	,
}
...
func (m *OptionalParams) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.MaxActiveReputersQuantile) > 0 {
		for iNdEx := len(m.MaxActiveReputersQuantile) - 1; iNdEx >= 0; iNdEx-- {
			{
				size := m.MaxActiveReputersQuantile[iNdEx].Size()
				i -= size
				if _, err := m.MaxActiveReputersQuantile[iNdEx].MarshalTo(dAtA[i:]); err != nil {
					return 0, err
				}
				i = encodeVarintTx(dAtA, i, uint64(size))
			}
	...
	if len(m.MaxActiveForecastersQuantile) > 0 {
		for iNdEx := len(m.MaxActiveForecastersQuantile) - 1; iNdEx >= 0; iNdEx-- {
			{
				size := m.MaxActiveForecastersQuantile[iNdEx].Size()
				i -= size
				if _, err := m.MaxActiveForecastersQuantile[iNdEx].MarshalTo(dAtA[i:]); err != nil {
					return 0, err
				}
				i = encodeVarintTx(dAtA, i, uint64(size))
			}
	...
	if len(m.MaxActiveInferersQuantile) > 0 {
		for iNdEx := len(m.MaxActiveInferersQuantile) - 1; iNdEx >= 0; iNdEx-- {
			{
				size := m.MaxActiveInferersQuantile[iNdEx].Size()
				i -= size
				if _, err := m.MaxActiveInferersQuantile[iNdEx].MarshalTo(dAtA[i:]); err != nil {
					return 0, err
				}
				i = encodeVarintTx(dAtA, i, uint64(size))
			}
...
func (m *OptionalParams) Size() (n int) {
	...
	if len(m.MaxActiveInferersQuantile) > 0 {
		for _, e := range m.MaxActiveInferersQuantile {
			l = e.Size()
			n += 2 + l + sovTx(uint64(l))
		}
	}
	if len(m.MaxActiveForecastersQuantile) > 0 {
		for _, e := range m.MaxActiveForecastersQuantile {
			l = e.Size()
			n += 2 + l + sovTx(uint64(l))
		}
	}
	if len(m.MaxActiveReputersQuantile) > 0 {
		for _, e := range m.MaxActiveReputersQuantile {
			l = e.Size()
			n += 2 + l + sovTx(uint64(l))
		}
	}
...
func (m *OptionalParams) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 24:
			...
			var v github_com_allora_network_allora_chain_math.Dec
			m.MaxActiveInferersQuantile = append(m.MaxActiveInferersQuantile, v)
			if err := m.MaxActiveInferersQuantile[len(m.MaxActiveInferersQuantile)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 25:
			...
			var v github_com_allora_network_allora_chain_math.Dec
			m.MaxActiveForecastersQuantile = append(m.MaxActiveForecastersQuantile, v)
			if err := m.MaxActiveForecastersQuantile[len(m.MaxActiveForecastersQuantile)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 26:
			...
			var v github_com_allora_network_allora_chain_math.Dec
			m.MaxActiveReputersQuantile = append(m.MaxActiveReputersQuantile, v)
			if err := m.MaxActiveReputersQuantile[len(m.MaxActiveReputersQuantile)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 27:
