...
type CreateNewTopicRequest struct {
	...
	// Per-topic cap on labels per worker submission. Zero means "use module
	// default". Effective cap at the msgserver is min(params, this) when this
	// is non-zero.
...
type UpdateTopicRequest struct {
	...
	// Per-topic cap on labels per worker submission. Zero means "unchanged" in
	// UpdateTopic (the existing value is preserved). Topic keeper rejects
	// mutations while any worker submission window is open for this topic.
	...
	// Per-topic canonical label allowlist. Nil means "unchanged" in UpdateTopic;
	// an empty (non-nil) list means "clear the whitelist" (unrestricted).
	// Topic keeper rejects mutations while any worker submission window is open.
...
var fileDescriptor_2cbaaf648f37497a = []byte{
	...
	,
}
...
func (m *OptionalParams) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.MaxLabelsPerSubmission) > 0 {
		dAtA2 := make([]byte, len(m.MaxLabelsPerSubmission)*10)
		var j1 int
