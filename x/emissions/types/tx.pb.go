...
type OptionalParams struct {
	...
	ValidatorsVsAlloraPercentReward []cosmossdk_io_math.LegacyDec                     `protobuf:"bytes,32,rep,name=validators_vs_allora_percent_reward,json=validatorsVsAlloraPercentReward,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"validators_vs_allora_percent_reward"`
	...
	MaxWorkersAcceptedPerPayload    []uint64                                          `protobuf:"varint,34,rep,packed,name=max_workers_accepted_per_payload,json=maxWorkersAcceptedPerPayload,proto3" json:"max_workers_accepted_per_payload,omitempty"`
	MaxReputersAcceptedPerPayload   []uint64                                          `protobuf:"varint,35,rep,packed,name=max_reputers_accepted_per_payload,json=maxReputersAcceptedPerPayload,proto3" json:"max_reputers_accepted_per_payload,omitempty"`
	MaxTopWorkersToReward           []uint64                                          `protobuf:"varint,36,rep,packed,name=max_top_workers_to_reward,json=maxTopWorkersToReward,proto3" json:"max_top_workers_to_reward,omitempty"`
	MaxTopReputersToReward          []uint64                                          `protobuf:"varint,37,rep,packed,name=max_top_reputers_to_reward,json=maxTopReputersToReward,proto3" json:"max_top_reputers_to_reward,omitempty"`
	CreateTopicFee                  []uint64                                          `protobuf:"varint,38,rep,packed,name=create_topic_fee,json=createTopicFee,proto3" json:"create_topic_fee,omitempty"`
	SigmoidA                        []github_com_allora_network_allora_chain_math.Dec `protobuf:"bytes,39,rep,name=sigmoid_a,json=sigmoidA,proto3,customtype=github.com/allora-network/allora-chain/math.Dec" json:"sigmoid_a"`
	SigmoidB                        []github_com_allora_network_allora_chain_math.Dec `protobuf:"bytes,40,rep,name=sigmoid_b,json=sigmoidB,proto3,customtype=github.com/allora-network/allora-chain/math.Dec" json:"sigmoid_b"`
}
...
func (m *OptionalParams) GetMaxWorkersAcceptedPerPayload() []uint64 {
	if m != nil {
		return m.MaxWorkersAcceptedPerPayload
	}
	return nil
}

func (m *OptionalParams) GetMaxReputersAcceptedPerPayload() []uint64 {
	if m != nil {
		return m.MaxReputersAcceptedPerPayload
	}
	return nil
}
...
func (m *OptionalParams) GetCreateTopicFee() []uint64 {
	if m != nil {
		return m.CreateTopicFee
	}
	return nil
}
...
func (m *MsgInsertBulkReputerPayload) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func (m *MsgInsertBulkWorkerPayload) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
var fileDescriptor_8293ea1b0f4b608c = []byte{
	...
	,
}
...
func (m *OptionalParams) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.CreateTopicFee) > 0 {
		dAtA2 := make([]byte, len(m.CreateTopicFee)*10)
		var j1 int
		for _, num := range m.CreateTopicFee {
			for num >= 1<<7 {
	...
	if len(m.MaxTopReputersToReward) > 0 {
		dAtA4 := make([]byte, len(m.MaxTopReputersToReward)*10)
		var j3 int
	...
	if len(m.MaxTopWorkersToReward) > 0 {
		dAtA6 := make([]byte, len(m.MaxTopWorkersToReward)*10)
		var j5 int
	...
	if len(m.MaxReputersAcceptedPerPayload) > 0 {
		dAtA8 := make([]byte, len(m.MaxReputersAcceptedPerPayload)*10)
		var j7 int
		for _, num := range m.MaxReputersAcceptedPerPayload {
			for num >= 1<<7 {
	...
	if len(m.MaxWorkersAcceptedPerPayload) > 0 {
		dAtA10 := make([]byte, len(m.MaxWorkersAcceptedPerPayload)*10)
		var j9 int
		for _, num := range m.MaxWorkersAcceptedPerPayload {
			for num >= 1<<7 {
	...
	if len(m.MaxSamplesToScaleScores) > 0 {
		dAtA12 := make([]byte, len(m.MaxSamplesToScaleScores)*10)
		var j11 int
	...
	if len(m.SybilTaxExponent) > 0 {
		dAtA14 := make([]byte, len(m.SybilTaxExponent)*10)
		var j13 int
	...
	if len(m.NumberExpectedInferenceSybils) > 0 {
		dAtA16 := make([]byte, len(m.NumberExpectedInferenceSybils)*10)
		var j15 int
	...
	if len(m.MaxUnfulfilledReputerRequests) > 0 {
		dAtA18 := make([]byte, len(m.MaxUnfulfilledReputerRequests)*10)
		var j17 int
	...
	if len(m.MaxUnfulfilledWorkerRequests) > 0 {
		dAtA20 := make([]byte, len(m.MaxUnfulfilledWorkerRequests)*10)
		var j19 int
	...
	if len(m.MaxReputersPerTopicRequest) > 0 {
		dAtA22 := make([]byte, len(m.MaxReputersPerTopicRequest)*10)
		var j21 int
	...
	if len(m.MaxWorkersPerTopicRequest) > 0 {
		dAtA24 := make([]byte, len(m.MaxWorkersPerTopicRequest)*10)
		var j23 int
	...
	if len(m.MaxRequestCadence) > 0 {
		dAtA26 := make([]byte, len(m.MaxRequestCadence)*10)
		var j25 int
	...
	if len(m.MaxInferenceRequestValidity) > 0 {
		dAtA28 := make([]byte, len(m.MaxInferenceRequestValidity)*10)
		var j27 int
	...
	if len(m.RewardCadence) > 0 {
		dAtA36 := make([]byte, len(m.RewardCadence)*10)
		var j35 int
...
func (m *MsgRegister) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x2a
	if len(m.TopicIds) > 0 {
		dAtA41 := make([]byte, len(m.TopicIds)*10)
		var j40 int
		...
		i = encodeVarintTx(dAtA, i, uint64(j40))
		i--
		dAtA[i] = 0x22
	}
...
func (m *OptionalParams) Size() (n int) {
	...
	if len(m.MaxWorkersAcceptedPerPayload) > 0 {
		l = 0
		for _, e := range m.MaxWorkersAcceptedPerPayload {
			l += sovTx(uint64(e))
		}
		n += 2 + sovTx(uint64(l)) + l
	}
	if len(m.MaxReputersAcceptedPerPayload) > 0 {
		l = 0
		for _, e := range m.MaxReputersAcceptedPerPayload {
			l += sovTx(uint64(e))
		}
		n += 2 + sovTx(uint64(l)) + l
	}
	...
	for iNdEx < l {
		...
		case 34:
			if wireType == 0 {
				...
				m.MaxWorkersAcceptedPerPayload = append(m.MaxWorkersAcceptedPerPayload, v)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				elementCount = count
				if elementCount != 0 && len(m.MaxWorkersAcceptedPerPayload) == 0 {
					m.MaxWorkersAcceptedPerPayload = make([]uint64, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v uint64
					for shift := uint(0); ; shift += 7 {
				...
				return fmt.Errorf("proto: wrong wireType = %d for field MaxWorkersAcceptedPerPayload", wireType)
			}
		case 35:
			if wireType == 0 {
				var v uint64
				...
				m.MaxReputersAcceptedPerPayload = append(m.MaxReputersAcceptedPerPayload, v)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				elementCount = count
				if elementCount != 0 && len(m.MaxReputersAcceptedPerPayload) == 0 {
					m.MaxReputersAcceptedPerPayload = make([]uint64, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v uint64
					for shift := uint(0); ; shift += 7 {
				...
				return fmt.Errorf("proto: wrong wireType = %d for field MaxReputersAcceptedPerPayload", wireType)
			}
		case 36:
			if wireType == 0 {
				var v uint64
		...
		case 38:
			if wireType == 0 {
				...
				elementCount = count
				if elementCount != 0 && len(m.CreateTopicFee) == 0 {
					m.CreateTopicFee = make([]uint64, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v uint64
					for shift := uint(0); ; shift += 7 {
