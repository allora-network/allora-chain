...
type Params struct {
	...
	MaxActiveInferersQuantile       github_com_allora_network_allora_chain_math.Dec `protobuf:"bytes,24,opt,name=max_active_inferers_quantile,json=maxActiveInferersQuantile,proto3,customtype=github.com/allora-network/allora-chain/math.Dec" json:"max_active_inferers_quantile"`
	MaxActiveForecastersQuantile    github_com_allora_network_allora_chain_math.Dec `protobuf:"bytes,25,opt,name=max_active_forecasters_quantile,json=maxActiveForecastersQuantile,proto3,customtype=github.com/allora-network/allora-chain/math.Dec" json:"max_active_forecasters_quantile"`
	MaxActiveReputersQuantile       github_com_allora_network_allora_chain_math.Dec `protobuf:"bytes,26,opt,name=max_active_reputers_quantile,json=maxActiveReputersQuantile,proto3,customtype=github.com/allora-network/allora-chain/math.Dec" json:"max_active_reputers_quantile"`
	...
	PRewardInference         github_com_allora_network_allora_chain_math.Dec `protobuf:"bytes,36,opt,name=p_reward_inference,json=pRewardInference,proto3,customtype=github.com/allora-network/allora-chain/math.Dec" json:"p_reward_inference"`
	PRewardForecast          github_com_allora_network_allora_chain_math.Dec `protobuf:"bytes,37,opt,name=p_reward_forecast,json=pRewardForecast,proto3,customtype=github.com/allora-network/allora-chain/math.Dec" json:"p_reward_forecast"`
	PRewardReputer           github_com_allora_network_allora_chain_math.Dec `protobuf:"bytes,38,opt,name=p_reward_reputer,json=pRewardReputer,proto3,customtype=github.com/allora-network/allora-chain/math.Dec" json:"p_reward_reputer"`
	CRewardInference         github_com_allora_network_allora_chain_math.Dec `protobuf:"bytes,39,opt,name=c_reward_inference,json=cRewardInference,proto3,customtype=github.com/allora-network/allora-chain/math.Dec" json:"c_reward_inference"`
	CRewardForecast          github_com_allora_network_allora_chain_math.Dec `protobuf:"bytes,40,opt,name=c_reward_forecast,json=cRewardForecast,proto3,customtype=github.com/allora-network/allora-chain/math.Dec" json:"c_reward_forecast"`
	CNorm                    github_com_allora_network_allora_chain_math.Dec `protobuf:"bytes,41,opt,name=c_norm,json=cNorm,proto3,customtype=github.com/allora-network/allora-chain/math.Dec" json:"c_norm"`
	TopicFeeRevenueDecayRate github_com_allora_network_allora_chain_math.Dec `protobuf:"bytes,42,opt,name=topic_fee_revenue_decay_rate,json=topicFeeRevenueDecayRate,proto3,customtype=github.com/allora-network/allora-chain/math.Dec" json:"topic_fee_revenue_decay_rate"`
	EpsilonReputer           github_com_allora_network_allora_chain_math.Dec `protobuf:"bytes,43,opt,name=epsilon_reputer,json=epsilonReputer,proto3,customtype=github.com/allora-network/allora-chain/math.Dec" json:"epsilon_reputer"`
	MinEffectiveTopicRevenue github_com_allora_network_allora_chain_math.Dec `protobuf:"bytes,44,opt,name=min_effective_topic_revenue,json=minEffectiveTopicRevenue,proto3,customtype=github.com/allora-network/allora-chain/math.Dec" json:"min_effective_topic_revenue"`
}
...
var fileDescriptor_f535e53c00d44458 = []byte{
	...
	,
}
