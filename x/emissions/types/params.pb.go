...
type Params struct {
	...
	PRewardInference github_com_allora_network_allora_chain_math.Dec `protobuf:"bytes,40,opt,name=p_reward_inference,json=pRewardInference,proto3,customtype=github.com/allora-network/allora-chain/math.Dec" json:"p_reward_inference"`
	PRewardForecast  github_com_allora_network_allora_chain_math.Dec `protobuf:"bytes,41,opt,name=p_reward_forecast,json=pRewardForecast,proto3,customtype=github.com/allora-network/allora-chain/math.Dec" json:"p_reward_forecast"`
	PRewardReputer   github_com_allora_network_allora_chain_math.Dec `protobuf:"bytes,42,opt,name=p_reward_reputer,json=pRewardReputer,proto3,customtype=github.com/allora-network/allora-chain/math.Dec" json:"p_reward_reputer"`
	CRewardInference github_com_allora_network_allora_chain_math.Dec `protobuf:"bytes,43,opt,name=c_reward_inference,json=cRewardInference,proto3,customtype=github.com/allora-network/allora-chain/math.Dec" json:"c_reward_inference"`
	CRewardForecast  github_com_allora_network_allora_chain_math.Dec `protobuf:"bytes,44,opt,name=c_reward_forecast,json=cRewardForecast,proto3,customtype=github.com/allora-network/allora-chain/math.Dec" json:"c_reward_forecast"`
	FTolerance       github_com_allora_network_allora_chain_math.Dec `protobuf:"bytes,45,opt,name=f_tolerance,json=fTolerance,proto3,customtype=github.com/allora-network/allora-chain/math.Dec" json:"f_tolerance"`
}
...
var fileDescriptor_f535e53c00d44458 = []byte{
	...
	,
}
