...
func (*UpdateParamsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_4b19af806a9d832c, []int{0}
}
...
func (*UpdateParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_4b19af806a9d832c, []int{1}
}
...
func (*RecalculateTargetEmissionRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_4b19af806a9d832c, []int{2}
}
...
func (*RecalculateTargetEmissionResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_4b19af806a9d832c, []int{3}
}
...
func init() {
	proto.RegisterType((*UpdateParamsRequest)(nil), "mint.v5.UpdateParamsRequest")
	proto.RegisterType((*UpdateParamsResponse)(nil), "mint.v5.UpdateParamsResponse")
	proto.RegisterType((*RecalculateTargetEmissionRequest)(nil), "mint.v5.RecalculateTargetEmissionRequest")
	proto.RegisterType((*RecalculateTargetEmissionResponse)(nil), "mint.v5.RecalculateTargetEmissionResponse")
}

func init() { proto.RegisterFile("mint/v5/tx.proto", fileDescriptor_4b19af806a9d832c) }

var fileDescriptor_4b19af806a9d832c = []byte{
	// 485 bytes of a gzipped FileDescriptorProto
	,
}
...
func (c *msgServiceClient) UpdateParams(ctx context.Context, in *UpdateParamsRequest, opts ...grpc.CallOption) (*UpdateParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mint.v5.MsgService/UpdateParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgServiceClient) RecalculateTargetEmission(ctx context.Context, in *RecalculateTargetEmissionRequest, opts ...grpc.CallOption) (*RecalculateTargetEmissionResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mint.v5.MsgService/RecalculateTargetEmission", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _MsgService_UpdateParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mint.v5.MsgService/UpdateParams",
	}
...
func _MsgService_RecalculateTargetEmission_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mint.v5.MsgService/RecalculateTargetEmission",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _MsgService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "mint.v5.MsgService",
