...
const (
	MsgService_UpdateParams_FullMethodName              = "/mint.v5.MsgService/UpdateParams"
	MsgService_RecalculateTargetEmission_FullMethodName = "/mint.v5.MsgService/RecalculateTargetEmission"
)
