...
func init() {
	file_mint_v5_tx_proto_init()
	md_UpdateParamsRequest = File_mint_v5_tx_proto.Messages().ByName("UpdateParamsRequest")
...
func (x *UpdateParamsRequest) slowProtoReflect() protoreflect.Message {
	mi := &file_mint_v5_tx_proto_msgTypes[0]
...
func (x *fastReflection_UpdateParamsRequest) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "mint.v5.UpdateParamsRequest.sender":
		return x.Sender != ""
	case "mint.v5.UpdateParamsRequest.params":
		return x.Params != nil
	case "mint.v5.UpdateParamsRequest.recalculate_target_emission":
		return x.RecalculateTargetEmission != false
	case "mint.v5.UpdateParamsRequest.blocks_per_month":
		return x.BlocksPerMonth != uint64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: mint.v5.UpdateParamsRequest"))
		}
		panic(fmt.Errorf("message mint.v5.UpdateParamsRequest does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_UpdateParamsRequest) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message mint.v5.UpdateParamsRequest does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_UpdateParamsRequest) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "mint.v5.UpdateParamsRequest.sender":
		panic(fmt.Errorf("field sender of message mint.v5.UpdateParamsRequest is not mutable"))
	case "mint.v5.UpdateParamsRequest.recalculate_target_emission":
		panic(fmt.Errorf("field recalculate_target_emission of message mint.v5.UpdateParamsRequest is not mutable"))
	case "mint.v5.UpdateParamsRequest.blocks_per_month":
		panic(fmt.Errorf("field blocks_per_month of message mint.v5.UpdateParamsRequest is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: mint.v5.UpdateParamsRequest"))
		}
...
func (x *fastReflection_UpdateParamsRequest) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in mint.v5.UpdateParamsRequest", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_mint_v5_tx_proto_init()
	md_UpdateParamsResponse = File_mint_v5_tx_proto.Messages().ByName("UpdateParamsResponse")
}
...
func (x *UpdateParamsResponse) slowProtoReflect() protoreflect.Message {
	mi := &file_mint_v5_tx_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_UpdateParamsResponse) Has(fd protoreflect.FieldDescriptor) bool {
	...
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: mint.v5.UpdateParamsResponse"))
		}
		panic(fmt.Errorf("message mint.v5.UpdateParamsResponse does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_UpdateParamsResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message mint.v5.UpdateParamsResponse does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_UpdateParamsResponse) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in mint.v5.UpdateParamsResponse", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_mint_v5_tx_proto_init()
	md_RecalculateTargetEmissionRequest = File_mint_v5_tx_proto.Messages().ByName("RecalculateTargetEmissionRequest")
...
func (x *RecalculateTargetEmissionRequest) slowProtoReflect() protoreflect.Message {
	mi := &file_mint_v5_tx_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_RecalculateTargetEmissionRequest) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "mint.v5.RecalculateTargetEmissionRequest.sender":
		return x.Sender != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: mint.v5.RecalculateTargetEmissionRequest"))
		}
		panic(fmt.Errorf("message mint.v5.RecalculateTargetEmissionRequest does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_RecalculateTargetEmissionRequest) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message mint.v5.RecalculateTargetEmissionRequest does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_RecalculateTargetEmissionRequest) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "mint.v5.RecalculateTargetEmissionRequest.sender":
		panic(fmt.Errorf("field sender of message mint.v5.RecalculateTargetEmissionRequest is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: mint.v5.RecalculateTargetEmissionRequest"))
		}
...
func (x *fastReflection_RecalculateTargetEmissionRequest) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in mint.v5.RecalculateTargetEmissionRequest", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_mint_v5_tx_proto_init()
	md_RecalculateTargetEmissionResponse = File_mint_v5_tx_proto.Messages().ByName("RecalculateTargetEmissionResponse")
}
...
func (x *RecalculateTargetEmissionResponse) slowProtoReflect() protoreflect.Message {
	mi := &file_mint_v5_tx_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_RecalculateTargetEmissionResponse) Has(fd protoreflect.FieldDescriptor) bool {
	...
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: mint.v5.RecalculateTargetEmissionResponse"))
		}
		panic(fmt.Errorf("message mint.v5.RecalculateTargetEmissionResponse does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_RecalculateTargetEmissionResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message mint.v5.RecalculateTargetEmissionResponse does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_RecalculateTargetEmissionResponse) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in mint.v5.RecalculateTargetEmissionResponse", d.FullName()))
	}
	panic("unreachable")
}
...
func (*UpdateParamsRequest) Descriptor() ([]byte, []int) {
	return file_mint_v5_tx_proto_rawDescGZIP(), []int{0}
}
...
func (*UpdateParamsResponse) Descriptor() ([]byte, []int) {
	return file_mint_v5_tx_proto_rawDescGZIP(), []int{1}
}
...
func (*RecalculateTargetEmissionRequest) Descriptor() ([]byte, []int) {
	return file_mint_v5_tx_proto_rawDescGZIP(), []int{2}
}
...
func (*RecalculateTargetEmissionResponse) Descriptor() ([]byte, []int) {
	return file_mint_v5_tx_proto_rawDescGZIP(), []int{3}
}

var File_mint_v5_tx_proto protoreflect.FileDescriptor

var file_mint_v5_tx_proto_rawDesc = []byte{
	0x0a, 0x10, 0x6d, 0x69, 0x6e, 0x74, 0x2f, 0x76, 0x35, 0x2f, 0x74, 0x78, 0x2e, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x12, 0x07, 0x6d, 0x69, 0x6e, 0x74, 0x2e, 0x76, 0x35, 0x1a, 0x11, 0x61, 0x6d, 0x69,
	...
	0x35, 0x2f, 0x74, 0x79, 0x70, 0x65, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x9a, 0x02,
	...
	0x67, 0x65, 0x74, 0x45, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x28, 0x0a, 0x10, 0x62,
	0x6c, 0x6f, 0x63, 0x6b, 0x73, 0x5f, 0x70, 0x65, 0x72, 0x5f, 0x6d, 0x6f, 0x6e, 0x74, 0x68, 0x18,
	0x04, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0e, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x73, 0x50, 0x65, 0x72,
	0x4d, 0x6f, 0x6e, 0x74, 0x68, 0x3a, 0x33, 0x82, 0xe7, 0xb0, 0x2a, 0x06, 0x73, 0x65, 0x6e, 0x64,
	...
	0x64, 0x61, 0x74, 0x65, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x22, 0x16, 0x0a, 0x14, 0x55, 0x70,
	0x64, 0x61, 0x74, 0x65, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0x22, 0x96, 0x01, 0x0a, 0x20, 0x52, 0x65, 0x63, 0x61, 0x6c, 0x63, 0x75, 0x6c, 0x61,
	...
	,
	...
	0x6c, 0x6f, 0x72, 0x61, 0x2d, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x2f, 0x78, 0x2f, 0x6d, 0x69, 0x6e,
	0x74, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x6d, 0x69, 0x6e, 0x74, 0x2f, 0x76, 0x35, 0x3b, 0x6d, 0x69,
	0x6e, 0x74, 0x76, 0x35, 0xa2, 0x02, 0x03, 0x4d, 0x58, 0x58, 0xaa, 0x02, 0x07, 0x4d, 0x69, 0x6e,
	0x74, 0x2e, 0x56, 0x35, 0xca, 0x02, 0x07, 0x4d, 0x69, 0x6e, 0x74, 0x5c, 0x56, 0x35, 0xe2, 0x02,
	0x13, 0x4d, 0x69, 0x6e, 0x74, 0x5c, 0x56, 0x35, 0x5c, 0x47, 0x50, 0x42, 0x4d, 0x65, 0x74, 0x61,
	0x64, 0x61, 0x74, 0x61, 0xea, 0x02, 0x08, 0x4d, 0x69, 0x6e, 0x74, 0x3a, 0x3a, 0x56, 0x35, 0x62,
	0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_mint_v5_tx_proto_rawDescOnce sync.Once
	file_mint_v5_tx_proto_rawDescData = file_mint_v5_tx_proto_rawDesc
)

func file_mint_v5_tx_proto_rawDescGZIP() []byte {
	file_mint_v5_tx_proto_rawDescOnce.Do(func() {
		file_mint_v5_tx_proto_rawDescData = protoimpl.X.CompressGZIP(file_mint_v5_tx_proto_rawDescData)
	})
	return file_mint_v5_tx_proto_rawDescData
}

var file_mint_v5_tx_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_mint_v5_tx_proto_goTypes = []interface{}{
	(*UpdateParamsRequest)(nil),               // 0: mint.v5.UpdateParamsRequest
	(*UpdateParamsResponse)(nil),              // 1: mint.v5.UpdateParamsResponse
	(*RecalculateTargetEmissionRequest)(nil),  // 2: mint.v5.RecalculateTargetEmissionRequest
	(*RecalculateTargetEmissionResponse)(nil), // 3: mint.v5.RecalculateTargetEmissionResponse
	(*Params)(nil),                            // 4: mint.v5.Params
}
var file_mint_v5_tx_proto_depIdxs = []int32{
	4, // 0: mint.v5.UpdateParamsRequest.params:type_name -> mint.v5.Params
	0, // 1: mint.v5.MsgService.UpdateParams:input_type -> mint.v5.UpdateParamsRequest
	2, // 2: mint.v5.MsgService.RecalculateTargetEmission:input_type -> mint.v5.RecalculateTargetEmissionRequest
	1, // 3: mint.v5.MsgService.UpdateParams:output_type -> mint.v5.UpdateParamsResponse
	3, // 4: mint.v5.MsgService.RecalculateTargetEmission:output_type -> mint.v5.RecalculateTargetEmissionResponse
...
func init() { file_mint_v5_tx_proto_init() }
func file_mint_v5_tx_proto_init() {
	if File_mint_v5_tx_proto != nil {
		return
	}
	file_mint_v5_types_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_mint_v5_tx_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_mint_v5_tx_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_mint_v5_tx_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_mint_v5_tx_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_mint_v5_tx_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_mint_v5_tx_proto_goTypes,
		DependencyIndexes: file_mint_v5_tx_proto_depIdxs,
		MessageInfos:      file_mint_v5_tx_proto_msgTypes,
	}.Build()
	File_mint_v5_tx_proto = out.File
	file_mint_v5_tx_proto_rawDesc = nil
	file_mint_v5_tx_proto_goTypes = nil
	file_mint_v5_tx_proto_depIdxs = nil
}
