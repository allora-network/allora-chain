...
import (
	...
	"github.com/allora-network/allora-chain/app/upgrades/v0_4_1"
...
func UpgradeChecks(m testCommon.TestConfig) {
	versionName := v0_4_1.UpgradeName
