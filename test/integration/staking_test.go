...
func StakeBobOnAliceAsReputerTopic1(m testCommon.TestConfig) {
	...
	// Have bob stake
	addDelegateStake := &emissionstypes.MsgServiceDelegateStakeRequest{
		Sender:  m.BobAddr,
		Reputer: m.AliceAddr,
		TopicId: 1,
		Amount:  cosmosMath.NewInt(stakeToAdd),
...
func UnstakeAliceAsReputerTopic1(m testCommon.TestConfig) {
	...
	// Have Alice unstake
	unstake := &emissionstypes.MsgServiceRemoveStakeRequest{
		Sender:  m.AliceAddr,
		TopicId: 1,
...
func UnstakeBobAsDelegatorOnAliceTopic1(m testCommon.TestConfig) {
	...
	// Have Bob unstake
	unstake := &emissionstypes.MsgServiceRemoveDelegateStakeRequest{
		Sender:  m.BobAddr,
		Reputer: m.AliceAddr,
		TopicId: 1,
