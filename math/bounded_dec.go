...
// Returns the maximum positive value that can be represented by a BoundedExp40Dec
func GetMaxPositiveBoundaryExp40Dec() BoundedExp40Dec {
	return BoundedExp40Dec{dec: maxBoundValue}
}

// Returns the minimum positive value that can be represented by a BoundedExp40Dec
