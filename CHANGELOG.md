...
* [#893](https://github.com/allora-network/allora-chain/pull/893) Make `c_norm` editable per topic and add migration v12

### Changed

* [#893](https://github.com/allora-network/allora-chain/pull/893) Move `c_norm` from global params to the `Topic` field
