...
const LOSSES_REQUEST_NODE_COUNT_DEFAULT = 5
const INFERENCE_REQUEST_NODE_COUNT_DEFAULT = 5
...
var LOSSES_REQUEST_TIMEOUT_COUNT = getEnvAsInt("LOSSES_REQUEST_NODE_COUNT", LOSSES_REQUEST_TIMEOUT_DEFAULT)
var INFERENCE_REQUEST_TIMEOUT_COUNT = getEnvAsInt("INFERENCE_REQUEST_TIMEOUT_COUNT", INFERENCE_REQUEST_TIMEOUT_DEFAULT)
